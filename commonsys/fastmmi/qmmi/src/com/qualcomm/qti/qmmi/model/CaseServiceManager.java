...
import com.qualcomm.qti.qmmi.framework.BaseActivity.BaseActivityHandler;
import com.qualcomm.qti.qmmi.framework.MainActivity.MainActivityHandler;
...
public class CaseServiceManager {
    ...
    private BaseActivityHandler mBaseActivityHandler = null;
    private MainActivityHandler mMainActivityHandler = null;

    private volatile static CaseServiceManager mCaseManagerService = null;

    //Messages for BaseService's Handler
    ...
    //Messages for BaseActivity's Handler
    public final static int MSG_UPDATE_CASE_RESULT_TO_UI = 0;
    public final static int MSG_UPDATE_FOREGROUND_CASE_STATE_TO_UI = 1;

    //Messages for MainActivity's Handler
    public final static int MSG_UPDATE_BACKGROUND_CASE_STATE = 0;
    public final static int MSG_DIAG_UPDATE_TESTCAST_LIST = 1;
    public final static int MSG_DIAG_START_TESTCAST = 2;
    public final static int MSG_DIAG_UPDATE_TESTCAST_RESULT = 3;
    ...
    public void setBaseActivityHandler(BaseActivityHandler handler) {
        mBaseActivityHandler = handler;
    }

    public BaseActivityHandler getBaseActivityHandler() {
        return mBaseActivityHandler;
    }

    public void sendMsgForBaseActivityHander(int what, Object obj){
        if (mBaseActivityHandler != null){
            sendMsg(mBaseActivityHandler, what, obj);
        }
    }

    public void setMainActivityHandler(MainActivityHandler handler) {
    ...
    public void sendMsgForMainActivityHander(int what, Object obj){
        if (mMainActivityHandler != null){
            sendMsg(mMainActivityHandler, what, obj);
        }
    }
    ...
    private void sendMsg(Handler handler, int what){
        sendMsg(handler, what, null);
    }

    private void sendMsg(Handler handler, Message msg){
