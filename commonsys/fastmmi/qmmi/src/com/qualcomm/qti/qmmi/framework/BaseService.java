...
public abstract class BaseService extends Service {
    ...
    public void updateView(Bundle bundle) {
        ...
        CaseServiceManager.getInstance().sendMsgForBaseActivityHander(CaseServiceManager.MSG_UPDATE_CASE_RESULT_TO_UI, intent);
    }
    ...
    public void updateResultForCase(Bundle bundle) {
        ...
        switch (testCase.getLaunchMode()){
            ...
            case TestCase.LAUNCH_MODE_FOREGROUND:
                CaseServiceManager.getInstance().sendMsgForBaseActivityHander(CaseServiceManager.MSG_UPDATE_FOREGROUND_CASE_STATE_TO_UI, intent);
                break;
        }
