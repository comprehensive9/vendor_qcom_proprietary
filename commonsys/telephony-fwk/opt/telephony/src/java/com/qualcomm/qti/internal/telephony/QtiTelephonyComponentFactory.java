...
public class QtiTelephonyComponentFactory extends TelephonyComponentFactory {
    ...
    public SubscriptionController initSubscriptionController(Context c) {
        ...
        return QtiSubscriptionController.init(c);
    }
    ...
    public SubscriptionInfoUpdater makeSubscriptionInfoUpdater(Looper looper, Context context,
        ...
        return QtiSubscriptionInfoUpdater.init(looper, context, ci);
    }
    ...
    public PhoneSwitcher makePhoneSwitcher(int maxDataAttachModemCount, Context context,
        ...
        return QtiPhoneSwitcher.make(maxDataAttachModemCount, context, looper);
    }

    @Override
    public MultiSimSettingController initMultiSimSettingController(Context c,
            SubscriptionController sc) {
        Rlog.i(LOG_TAG, "initVendorMultiSimSettingController");
        return VendorMultiSimSettingController.init(c, sc);
    }
