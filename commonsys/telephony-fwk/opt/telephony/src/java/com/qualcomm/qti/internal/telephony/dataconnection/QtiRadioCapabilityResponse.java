...
public class QtiRadioCapabilityResponse {

    private static String LOG_TAG = "QtiRadioCapabilityResponse";
    ...
    public void updateQtiRadioCapability(int raf) {
        Rlog.d(LOG_TAG, "updateQtiRadioCapability: raf:"+ raf);
        ...
        Rlog.d(LOG_TAG, "updateQtiRadioCapability:"+ mDeviceCapability);
    }

    public String getQtiRadioCapability() {
        Rlog.d(LOG_TAG, "getDeviceCapability: "+ mDeviceCapability);
