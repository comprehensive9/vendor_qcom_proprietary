...
public class MainServiceImpl {
    ...
    IHidlConnectionCallback mHidlConnectionCallback = new IHidlConnectionCallback() {
        ...
        @Override
        public void setNrConfigStatus(int slotId, Token token, Status status) {
    ...
    public Token setNrConfig(int slotId, NrConfig config, Client client) throws RemoteException {
        ...
        mHidlConnectionInterface.setNrConfig(slotId, config, token);
        return token;
    }
    ...
    public Token queryNrConfig(int slotId, Client client) throws RemoteException {
        ...
        mHidlConnectionInterface.queryNrConfig(slotId, token);
        return token;
    }
