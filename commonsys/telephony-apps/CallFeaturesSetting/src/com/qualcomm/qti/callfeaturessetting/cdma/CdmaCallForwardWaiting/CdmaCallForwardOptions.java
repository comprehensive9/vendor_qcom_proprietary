...
public class CdmaCallForwardOptions extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mSubId = getIntent().getIntExtra(SubscriptionManager.EXTRA_SUBSCRIPTION_INDEX,
    ...
    private void init() {
        ...
        for (int i = GlobalUtils.CF_REASON_UNCONDITIONAL;
                i < GlobalUtils.CF_REASON_ALL_CONDITIONAL; i++) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case GlobalUtils.CF_REASON_UNCONDITIONAL:
                mButtonCFU.onPickActivityResult(cursor.getString(0));
                break;
            case GlobalUtils.CF_REASON_BUSY:
                mButtonCFB.onPickActivityResult(cursor.getString(0));
                break;
            case GlobalUtils.CF_REASON_NO_REPLY:
                mButtonCFNRy.onPickActivityResult(cursor.getString(0));
                break;
            case GlobalUtils.CF_REASON_NOT_REACHABLE:
