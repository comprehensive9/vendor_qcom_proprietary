...
public class OptionsService extends com.android.ims.internal.uce.options.IOptionsService.Stub
{
    ...
    public OptionsService() {
        int ver = RCSService.mHidlService.getModemOptionsVersion();
    ...
    private class Version2_0 extends HalVersionWrapper {
        ...
        public void destroyServiceHandles() {
            for (Integer el : optionsHandleMap.keySet()) {
                try {
                    if(RCSService.mHidlService != null)
                      RCSService.mHidlService.destroyOptionsService(el.intValue());
                } catch (RemoteException | RuntimeException e) {
                    Log.d(logTAG,
                          "destroyServiceHandles failed with Exception:" + e);
                }
            }
            optionsHandleMap.clear();
        }
        ...
        public UceStatus removeListener(int optionsServiceHandle,
            ...
            UceStatus pStatus = null;
            try {
                if(optionsHandleMap.get(optionsServiceHandle) == null) {
    ...
    private class Version2_1 extends HalVersionWrapper {
        ...
        public void setServiceHandle (int serviceHandle) {
            ...
            try {
                localHidlOptionsService = RCSService.mHidlService.getOptionsService_2_1(serviceHandle);
            }catch(RemoteException | RuntimeException e) {
               Log.w(logTAG, "Unexpected remote exception", e);
            }
            if(localHidlOptionsService != null) {
    ...
    private class Version2_2 extends HalVersionWrapper {
        ...
        public void setServiceHandle (int serviceHandle) {
            ...
            try {
                localHidlOptionsService = RCSService.mHidlService.getOptionsService_2_2(serviceHandle);
            }catch(RemoteException | RuntimeException e) {
               Log.w(logTAG, "Unexpected remote exception", e);
            }
            if(localHidlOptionsService != null) {
    ...
    private class Version2_3 extends HalVersionWrapper {
        private Map<Integer, com.qualcomm.qti.uceservice.V2_3.IOptionsService> optionsHandleMap =
                          new HashMap<Integer, com.qualcomm.qti.uceservice.V2_3.IOptionsService>();

        public void setServiceHandle (int serviceHandle) {
            com.qualcomm.qti.uceservice.V2_3.IOptionsService localHidlOptionsService = null;
            try {
                localHidlOptionsService = RCSService.mHidlService.getOptionsService_2_3(serviceHandle);
            }catch(RemoteException | RuntimeException e) {
               Log.w(logTAG, "Unexpected remote exception", e);
            }
            if(localHidlOptionsService != null) {
        ...
        public UceStatus addListener(int optionsServiceHandle,
            ...
            try {
                pStatus = optionsHandleMap.get(optionsServiceHandle)
                    .addListener_2_3((long)optionsServiceHandle, optionsListener, clientHandle);
            }
            catch (RemoteException | RuntimeException e) {
                Log.d(logTAG, "Unexpected remote exception", e);
                throw e;
        ...
        public UceStatus responseIncomingOptions(int optionsServiceHandle,  int tId,
            ...
            try {
                ...
                hidlCapInfo = translateToHidlObj.getHidlOptCapInfo_2_3(capInfo);
                String reasonHeader = "";
                //empty string passed for reasonheader as this is no longer supported
                //in future pass string in PresenceApp->replyToOptions()
                pStatus = optionsHandleMap.get(optionsServiceHandle)
                                    .responseIncomingOptions_2_3((long)optionsServiceHandle,
                                            tId, (short)sipResponseCode, reasonPhrase,
                                            reasonHeader,
                                            hidlCapInfo, contactInBLByte);
            }
        ...
        public UceStatus setMyInfo(int optionsServiceHandle, CapInfo capInfo, int reqUserData)
            ...
            UceStatus pStatus;
            try {
                com.qualcomm.qti.uceservice.V2_3.CapabilityInfo hidlCapInfo
                    = new com.qualcomm.qti.uceservice.V2_3.CapabilityInfo();
                translateToHidlObj.getHidlCapInfo_2_3(hidlCapInfo, capInfo);
                pStatus = optionsHandleMap.get(optionsServiceHandle)
                                            .setCapabilityInfo_2_3((long)optionsServiceHandle,
                                                                hidlCapInfo,
                                                                (long)reqUserData);
            } catch (RemoteException | RuntimeException e) {
                Log.d(logTAG, "Unexpected remote exception", e);
