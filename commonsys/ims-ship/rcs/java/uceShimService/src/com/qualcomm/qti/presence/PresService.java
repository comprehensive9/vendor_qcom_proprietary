...
import com.qualcomm.qti.uceservice.V2_3.FeatureDesc;
...
import com.qualcomm.qti.uceShimService.RCSServiceStub;
...
public class PresService extends IPresenceService.Stub {
    ...
    public PresService() {
        int ver = RCSService.mHidlService.getModemPresenceVersion();
        if(ver == RCSServiceStub.HalServiceWrapper.VERSION_2_3) {
            mHalWrapper = new Version2_3();
        }
        else if(ver == RCSServiceStub.HalServiceWrapper.VERSION_2_2) {
            mHalWrapper = new Version2_2();
        } else if(ver == RCSServiceStub.HalServiceWrapper.VERSION_2_1) {
    ...
    public void destroyServiceHandles() {
        mHalWrapper.destroyServiceHandles();
    }
...
//no o/p type mentioned for reEnableService
    ...
    public StatusCode setNewFeatureTagWithVersion(int pPresServiceHdl, String pFeatureTag,
            com.android.ims.internal.uce.presence.PresServiceInfo pServiceInfo, int pUserData,
            String pVersions)
            throws RemoteException {
        ...
        FeatureDesc hidlFeatureDesc = new FeatureDesc();
        hidlFeatureDesc.featureTag = pFeatureTag;
        hidlFeatureDesc.version = pVersions;
        PresServiceInfo hidlPresSvcInfo = new PresServiceInfo();
        hidlPresSvcInfo = translateToHidlObj.getHidlPresSvcInfo(pServiceInfo);
        try {
            UceStatus pStatus = mHalWrapper.setNewFeatureTagWithVersion(pPresServiceHdl,
                     hidlFeatureDesc, hidlPresSvcInfo, pUserData);
            retStatus.setStatusCode(translateToAidlObj.getAidlStatusCode(pStatus.status));
        } catch(RemoteException | RuntimeException e) {
           Log.w(logTAG, "Unexpected remote exception", e);
           throw e;
    ...
    private abstract class HalVersionWrapper {
        ...
        public UceStatus setNewFeatureTagWithVersion(int pPresServiceHdl, FeatureDesc pFeatureTag,
            PresServiceInfo pServiceInfo, int pUserData)
            throws RemoteException {
                return null;
        }
    ...
    private class Version2_0 extends HalVersionWrapper {
        ...
        public void destroyServiceHandles() {
            for (Integer el : presHandleMap.keySet()) {
                try {
                    if(RCSService.mHidlService != null)
                      RCSService.mHidlService.destroyPresenceService( el.intValue());
                } catch (RemoteException | RuntimeException e) {
                    Log.d(logTAG,
                          "destroyServiceHandles failed with Exception:" + e);
                }
            }
            presHandleMap.clear();
        }
        ...
        public UceStatus removeListener(int pPresServiceHdl,
            ...
            UceStatus pStatus;
            try {
                if(presHandleMap.get(pPresServiceHdl) == null) {
                  pStatus = new UceStatus();
                  pStatus.status = UceStatusCode.INVALID_SERVICE_HANDLE;
                  return pStatus;
                }
    ...
    private class Version2_1 extends HalVersionWrapper {
        ...
        public void setServiceHandle (int serviceHandle) {
            ...
            try {
                localHidlPresenceService = RCSService.mHidlService.getPresenceService_2_1(serviceHandle);
            }catch(RemoteException | RuntimeException e) {
                Log.w(logTAG, "Unexpected remote exception", e);
            }
            if(localHidlPresenceService != null) {
    ...
    private class Version2_2 extends HalVersionWrapper {
        ...
        public void setServiceHandle (int serviceHandle) {
            ...
            try {
                localHidlPresenceService = RCSService.mHidlService.getPresenceService_2_2(serviceHandle);
            }catch(RemoteException | RuntimeException e) {
                Log.w(logTAG, "Unexpected remote exception", e);
            }
            if(localHidlPresenceService != null) {
    ...
    private class Version2_3 extends HalVersionWrapper {
        private Map<Integer, com.qualcomm.qti.uceservice.V2_3.IPresenceService> presHandleMap =
                            new HashMap<Integer, com.qualcomm.qti.uceservice.V2_3.IPresenceService>();

        public void setServiceHandle (int serviceHandle) {
            com.qualcomm.qti.uceservice.V2_3.IPresenceService localHidlPresenceService = null;
            try {
                localHidlPresenceService = RCSService.mHidlService.getPresenceService_2_3(serviceHandle);
            }catch(RemoteException | RuntimeException e) {
                Log.w(logTAG, "Unexpected remote exception", e);
            }
            if(localHidlPresenceService != null) {
        ...
        public UceStatus addListener(int pPresServiceHdl,
           PresListener hidlPresListener, long clientHandle)throws RemoteException {
            UceStatus pStatus = null;
               try {
                pStatus = presHandleMap.get(pPresServiceHdl)
                    .addListener_2_3((long)pPresServiceHdl,
                              hidlPresListener, clientHandle);
               } catch (RemoteException|RuntimeException e) {
                   throw e;
               }
        ...
        public UceStatus publishMyCap(int pPresServiceHdl,
            ...
            UceStatus pStatus;
            try {
                com.qualcomm.qti.uceservice.V2_3.PresenceCapabilityInfo pHidlCapInfo =
                    new com.qualcomm.qti.uceservice.V2_3.PresenceCapabilityInfo();
                pHidlCapInfo = translateToHidlObj.getHidlPresCapInfo_2_3(pMyCapInfo);

                pStatus = presHandleMap.get(pPresServiceHdl)
                    .publishCapability_2_3(pPresServiceHdl,
                                    pHidlCapInfo, pUserData);
            } catch (RemoteException | RuntimeException e) {
                throw e;
            }
        ...
        public UceStatus setNewFeatureTagWithVersion(int pPresServiceHdl, FeatureDesc hidlFeatureDesc,
            PresServiceInfo hidlPresSvcInfo, int pUserData)
                throws RemoteException {
            UceStatus pStatus;
            try {
                pStatus = presHandleMap.get(pPresServiceHdl)
                            .setNewFeatureTag_2_3((long)pPresServiceHdl, hidlFeatureDesc,
                                hidlPresSvcInfo, (long)pUserData);
            } catch (RemoteException | RuntimeException e) {
                throw e;
            }
