...
import com.qualcomm.qti.uceservice.V2_3.IPresenceListener;
...
public class PresListener extends IPresenceListener.Stub
{
    ...
    public void onSipResponseReceived(
        ...
        Log.d(logTAG,"onSipResponseReceived: HidlCmdId[" + pSipResponse.cmdId +"], AIDLCmdId[");
        ...
        Log.d(logTAG,"onSipResponseReceived: HidlCmdId[" + pSipResponse.cmdId +"], AIDLCmdId["+ sipResponse.getCmdId().getCmdId()+ "]");
        postToHandler(runnable , "onSipResponseReceived");
    }

    @Override
    public void onSipResponseReceived_2_3(
            com.qualcomm.qti.uceservice.V2_3.PresSipResponse pSipResponse) throws RemoteException {
        Log.d(logTAG,"onSipResponseReceived_2_3: HidlCmdId[" + pSipResponse.cmdId +"], AIDLCmdId[");
        com.android.ims.internal.uce.presence.PresSipResponse sipResponse = new com.android.ims.internal.uce.presence.PresSipResponse();
        translateToAidlObj = new HidlToAidlTranslator();

        sipResponse = translateToAidlObj.getAidlPresSipResponse_2_3(pSipResponse);
    ...
    @Override
    public void onCapInfoReceived_2_3(
        String pPresentityURI,
        ArrayList<com.qualcomm.qti.uceservice.V2_3.PresTupleInfo> pTupleInfoArray)
        throws RemoteException {
        PresListenerRunnable runnable = new PresListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();
        ...
        int sizeofTupleArray = pTupleInfoArray.size();
        Log.d(logTAG,"onCapInfoReceived_2_3: Tuple size[" + sizeofTupleArray + "]");
        runnable.m_pTupleInfo = new
          com.android.ims.internal.uce.presence.PresTupleInfo[sizeofTupleArray];

        runnable.m_pTupleInfo =
          translateToAidlObj.getAidlTupleInfoArray_2_3(pTupleInfoArray);
        runnable.m_pPresentityURI = pPresentityURI;
    ...
    @Override
    public void onListCapInfoReceived_2_3(
            com.qualcomm.qti.uceservice.V2_0.PresRlmiInfo pRlmiInfo,
            ArrayList<com.qualcomm.qti.uceservice.V2_3.PresResInfo> pResInfoArray)
            throws RemoteException {
        ...
        int sizeOfResInfoArray = pResInfoArray.size();
        runnable.m_pResInfo = new com.android.ims.internal.uce.presence.PresResInfo[sizeOfResInfoArray];
        runnable.m_pResInfo = translateToAidlObj.getAidlPresResInfo_2_3(pResInfoArray);
