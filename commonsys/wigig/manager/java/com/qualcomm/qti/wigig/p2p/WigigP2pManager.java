...
import com.qualcomm.qti.wigig.p2p.nsd.WifiP2pUpnpServiceInfo;
...
public class WigigP2pManager {
    ...
    Handler mHandler; // handler for posting callbacks, uses the channel looper
   ...
   public interface DnsSdTxtRecordListener {
    ...
    public static class Channel {
        Channel(Context context, Looper looper, ChannelListener l, Messenger messenger) {
        ...
        // the messenger is used to identify this instance in AIDL calls
    ...
    public Channel initialize(Context srcContext, Looper srcLooper, ChannelListener listener) {
        return initializeChannel(srcContext, srcLooper, listener, getMessenger());
    }
    ...
    private Channel initializeChannel(Context srcContext, Looper srcLooper, ChannelListener listener,
                                     Messenger messenger) {
        if (messenger == null) return null;

        Channel c = new Channel(srcContext, srcLooper, listener, messenger);
        if (c.mAsyncChannel.connectSync(srcContext, c.mHandler, messenger)
                == AsyncChannel.STATUS_SUCCESSFUL) {
            mHandler = new Handler(srcLooper);
            return c;
        } else {
            return null;
        }
    ...
    public void discoverPeers(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("discoverPeers", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.discoverPeers(binder, listenerProxy);
   ...
   /**
    ...
    public void stopPeerDiscovery(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("stopPeerDiscovery", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.stopPeerDiscovery(binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void connect(Channel c, WifiP2pConfig config, ActionListener listener) {
        ...
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("connect", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.connect(config, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void cancelConnect(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("cancelConnect", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.cancelConnect(binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void createGroup(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("createGroup", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.createGroup(binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void removeGroup(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("removeGroup", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.removeGroup(binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void listen(Channel c, boolean enable, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("listen", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.listen(enable, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void setWigigP2pChannels(Channel c, int lc, int oc, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("setWigigP2pChannels", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.setWigigP2pChannels(lc, oc, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void startWps(Channel c, WpsInfo wps, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("startWps", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.startWps(wps, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void addLocalService(Channel c, WifiP2pServiceInfo servInfo, ActionListener listener) {
        ...
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("addLocalService", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.addLocalService(c.mMessenger, servInfo, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void removeLocalService(Channel c, WifiP2pServiceInfo servInfo,
        ...
        checkServiceInfo(servInfo);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("removeLocalService", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.removeLocalService(c.mMessenger, servInfo, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void clearLocalServices(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("clearLocalServices", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.clearLocalServices(c.mMessenger, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    /**
     * Callback proxy for ServiceResponseListener objects.
     */
    private class ServiceResponseListenerProxy extends IServiceResponseListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final ServiceResponseListener mCallback;

        ServiceResponseListenerProxy(String actionTag, Looper looper, ServiceResponseListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        public void onServiceAvailable(int protocolType,
                byte[] responseData, WifiP2pDevice srcDevice) {
            Log.v(TAG, "ServiceResponseListenerProxy:" + mActionTag + ": onServiceAvailable");
            mHandler.post(() -> {
                mCallback.onServiceAvailable(protocolType, responseData, srcDevice);
            });
        }
    }
    ...
    public void setServiceResponseListener(Channel c,
        ...
        ServiceResponseListenerProxy listenerProxy = null;
        Binder binder = null;

        checkChannel(c);

        if (listener != null) {
            listenerProxy = new ServiceResponseListenerProxy("setServiceResponseListener", c.mLooper, listener);
        }
        binder = new Binder();
        try {
            mService.setServiceResponseListener(c.mMessenger, binder, listenerProxy);
        } catch (RemoteException e) {
    ...
    /**
     * Callback proxy for DnsSdServiceResponseListener objects.
     */
    private class DnsSdServiceResponseListenerProxy extends IDnsSdServiceResponseListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final DnsSdServiceResponseListener mCallback;

        DnsSdServiceResponseListenerProxy(String actionTag, Looper looper, DnsSdServiceResponseListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        public void onDnsSdServiceAvailable(String instanceName,
                String registrationType, WifiP2pDevice srcDevice) {
            Log.v(TAG, "DnsSdServiceResponseListenerProxy:" + mActionTag + ": onDnsSdServiceAvailable");
            mHandler.post(() -> {
                mCallback.onDnsSdServiceAvailable(instanceName, registrationType, srcDevice);
            });
        }
    }

    /**
     * Callback proxy for DnsSdTxtRecordListener objects.
     */
    private class DnsSdTxtRecordListenerProxy extends IDnsSdTxtRecordListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final DnsSdTxtRecordListener mCallback;

        DnsSdTxtRecordListenerProxy(String actionTag, Looper looper, DnsSdTxtRecordListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        public void onDnsSdTxtRecordAvailable(String fullDomainName,
                Map<String, String> txtRecordMap,
                WifiP2pDevice srcDevice) {
            Log.v(TAG, "DnsSdTxtRecordListenerProxy:" + mActionTag + ": onDnsSdTxtRecordAvailable");
            mHandler.post(() -> {
                mCallback.onDnsSdTxtRecordAvailable(fullDomainName, txtRecordMap, srcDevice);
            });
        }
    }
    ...
    public void setDnsSdResponseListeners(Channel c,
        ...
        DnsSdServiceResponseListenerProxy servListenerProxy = null;
        DnsSdTxtRecordListenerProxy txtListenerProxy = null;
        Binder binder = null;

        checkChannel(c);

        if (servListener != null) {
            servListenerProxy = new DnsSdServiceResponseListenerProxy("setDnsSdResponseListeners", c.mLooper, servListener);
        }
        if (txtListener != null) {
            txtListenerProxy = new DnsSdTxtRecordListenerProxy("setDnsSdResponseListeners", c.mLooper, txtListener);
        }
        binder = new Binder();
        try {
            mService.setDnsSdServiceResponseListener(c.mMessenger, binder, servListenerProxy);
            mService.setDnsSdTxtRecordListener(c.mMessenger, binder, txtListenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    /**
     * Callback proxy for UpnpServiceResponseListener objects.
     */
    private class UpnpServiceResponseListenerProxy extends IUpnpServiceResponseListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final UpnpServiceResponseListener mCallback;

        UpnpServiceResponseListenerProxy(String actionTag, Looper looper, UpnpServiceResponseListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        public void onUpnpServiceAvailable(List<String> uniqueServiceNames,
                WifiP2pDevice srcDevice){
            Log.v(TAG, "UpnpServiceResponseListenerProxy:" + mActionTag + ": onUpnpServiceAvailable");
            mHandler.post(() -> {
                mCallback.onUpnpServiceAvailable(uniqueServiceNames, srcDevice);
            });
        }
    }
    ...
    public void setUpnpServiceResponseListener(Channel c,
        ...
        UpnpServiceResponseListenerProxy listenerProxy = null;
        Binder binder = null;
        checkChannel(c);

        if (listener != null) {
            listenerProxy = new UpnpServiceResponseListenerProxy("setUpnpServiceResponseListener", c.mLooper, listener);
        }
        binder = new Binder();
        try {
            mService.setUpnpServiceResponseListener(c.mMessenger, binder, listenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void discoverServices(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("discoverServices", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.discoverServices(c.mMessenger, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void addServiceRequest(Channel c,
        ...
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("addServiceRequest", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.addServiceRequest(c.mMessenger, req, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void removeServiceRequest(Channel c, WifiP2pServiceRequest req,
        ...
        checkServiceRequest(req);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("removeServiceRequest", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.removeServiceRequest(c.mMessenger, req, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void clearServiceRequests(Channel c, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("clearServiceRequests", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.clearServiceRequests(c.mMessenger, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    /**
     * Callback proxy for PeerListListener objects.
     */
    private class PeerListListenerProxy extends IPeerListListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final PeerListListener mCallback;

        PeerListListenerProxy(String actionTag, Looper looper, PeerListListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        @Override
        public void onPeersAvailable(WifiP2pDeviceList peers) {
            Log.v(TAG, "PeerListListenerProxy:" + mActionTag + ": onPeersAvailable");
            mHandler.post(() -> {
                mCallback.onPeersAvailable(peers);
            });
        }
    }
    ...
    public void requestPeers(Channel c, PeerListListener listener) {
        PeerListListenerProxy listenerProxy = null;
        Binder binder = null;
        ...
        listenerProxy = new PeerListListenerProxy("requestPeers", c.mLooper, listener);
        binder = new Binder();

        try {
            mService.requestPeers(binder, listenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    /**
     * Callback proxy for ConnectionInfoListener objects.
     */
    private class ConnectionInfoListenerProxy extends IConnectionInfoListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final ConnectionInfoListener mCallback;

        ConnectionInfoListenerProxy(String actionTag, Looper looper, ConnectionInfoListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        @Override
        public void onConnectionInfoAvailable(WifiP2pInfo info) {
            Log.v(TAG, "ConnectionInfoListenerProxy:" + mActionTag + ": onConnectionInfoAvailable");
            mHandler.post(() -> {
                mCallback.onConnectionInfoAvailable(info);
            });
        }
    }
    ...
    public void requestConnectionInfo(Channel c, ConnectionInfoListener listener) {
        ConnectionInfoListenerProxy listenerProxy = null;
        Binder binder = null;
        ...
        listenerProxy = new ConnectionInfoListenerProxy("requestConnectionInfo", c.mLooper, listener);
        binder = new Binder();

        try {
            mService.requestConnectionInfo(binder, listenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    /**
     * Callback proxy for GroupInfoListener objects.
     */
    private class GroupInfoListenerProxy extends IGroupInfoListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final GroupInfoListener mCallback;

        GroupInfoListenerProxy(String actionTag, Looper looper, GroupInfoListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        @Override
        public void onGroupInfoAvailable(WifiP2pGroup group) {
            Log.v(TAG, "GroupInfoListenerProxy:" + mActionTag + ": onGroupInfoAvailable");
            mHandler.post(() -> {
                mCallback.onGroupInfoAvailable(group);
            });
        }
    }
    ...
    public void requestGroupInfo(Channel c, GroupInfoListener listener) {
        GroupInfoListenerProxy listenerProxy = null;
        Binder binder = null;
        ...
        listenerProxy = new GroupInfoListenerProxy("requestGroupInfo", c.mLooper, listener);
        binder = new Binder();

        try {
            mService.requestGroupInfo(binder, listenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setDeviceName(Channel c, String devName, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("setDeviceName", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.setDeviceName(devName, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void setWFDInfo(
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("setWFDInfo", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.setWFDInfo(wfdInfo, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void deletePersistentGroup(Channel c, int netId, ActionListener listener) {
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("deletePersistentGroup", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.deletePersistentGroup(netId, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    /**
     * Callback proxy for PersistentGroupInfoListener objects.
     */
    private class PersistentGroupInfoListenerProxy extends IPersistentGroupInfoListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final PersistentGroupInfoListener mCallback;

        PersistentGroupInfoListenerProxy(String actionTag, Looper looper, PersistentGroupInfoListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        @Override
        public void onPersistentGroupInfoAvailable(WifiP2pGroupList groups) {
            Log.v(TAG, "PersistentGroupInfoListenerProxy:" + mActionTag + ": onPersistentGroupInfoAvailable");
            mHandler.post(() -> {
                mCallback.onPersistentGroupInfoAvailable(groups);
            });
        }
    }
    ...
    public void requestPersistentGroupInfo(Channel c, PersistentGroupInfoListener listener) {
        PersistentGroupInfoListenerProxy listenerProxy = null;
        Binder binder = null;
        ...
        listenerProxy = new PersistentGroupInfoListenerProxy("requestPersistentGroupInfo", c.mLooper, listener);
        binder = new Binder();

        try {
            mService.requestPersistentGroupInfo(binder, listenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    /**
     * Callback proxy for HandoverMessageListener objects.
     */
    private class HandoverMessageListenerProxy extends IHandoverMessageListener.Stub {
        private final String mActionTag;
        private final Handler mHandler;
        private final HandoverMessageListener mCallback;

        HandoverMessageListenerProxy(String actionTag, Looper looper, HandoverMessageListener callback) {
            mActionTag = actionTag;
            mHandler = new Handler(looper);
            mCallback = callback;
        }
        ...
        @Override
        public void onHandoverMessageAvailable(String handoverMessage) {
            Log.v(TAG, "HandoverMessageListenerProxy:" + mActionTag + ": onHandoverMessageAvailable");
            mHandler.post(() -> {
                mCallback.onHandoverMessageAvailable(handoverMessage);
            });
        }
    }
    ...
    public void getNfcHandoverRequest(Channel c, HandoverMessageListener listener) {
        HandoverMessageListenerProxy listenerProxy = null;
        Binder binder = null;
        ...
        listenerProxy = new HandoverMessageListenerProxy("getNfcHandoverRequest", c.mLooper, listener);
        binder = new Binder();

        try {
            mService.getNfcHandoverRequest(binder, listenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void getNfcHandoverSelect(Channel c, HandoverMessageListener listener) {
        ...
        listenerProxy = new HandoverMessageListenerProxy("getNfcHandoverSelect", c.mLooper, listener);
        binder = new Binder();

        try {
            mService.getNfcHandoverSelect(binder, listenerProxy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void initiatorReportNfcHandover(Channel c, String handoverSelect,
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("initiatorReportNfcHandover", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.initiatorReportNfcHandover(handoverSelect, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
    ...
    public void responderReportNfcHandover(Channel c, String handoverRequest,
        ...
        checkChannel(c);
        if (listener != null) {
            listenerProxy = new ActionListenerProxy("responderReportNfcHandover", c.mLooper, listener);
            binder = new Binder();
        }
        try {
            mService.responderReportNfcHandover(handoverRequest, binder, listenerProxy);
        } catch (RemoteException e) {
            if (listenerProxy != null) listenerProxy.onFailure(ERROR);
        } catch (SecurityException e) {
            if (listenerProxy != null) listenerProxy.onFailure(NOT_AUTHORIZED);
