...
MM_GRAPHICS += a730_gmu.bin
MM_GRAPHICS += a730_sqe.fw
MM_GRAPHICS += a730_zap.b00
MM_GRAPHICS += a730_zap.b01
MM_GRAPHICS += a730_zap.b02
MM_GRAPHICS += a730_zap.elf
MM_GRAPHICS += a730_zap.mdt
MM_GRAPHICS += c500_gmu.bin
...
#List of targets are being restricted to deqp level version 132317953
VULKAN_DEQP_LEVEL_2019_03_01_TARGETS_LIST := msm8996

#List of targets are being restricted to deqp level version 132383489
VULKAN_DEQP_LEVEL_2020_03_01_TARGETS_LIST := msm8937 msm8937_32 msm8937_64 sdm660 sdm660_32 sdm660_64 msm8998 msm8998_32 msm8953 msm8953_64 msm8953_32 sdm710 atoll bengal bengal_32 bengal_32go holi kona lahaina lito msmnile trinket sm6150
...
ifeq ($(TARGET_PRODUCT), $(filter $(TARGET_PRODUCT), bengal_32 bengal_32go))
    PRODUCT_PROPERTY_OVERRIDES += ro.vendor.gfx.32bit.target=true
endif
...
ifeq ($(call CHECK_VERSION_GE, $(ADRENO_PLATFORM_SDK_VERSION), $(PLATFORM_SDK_RPDK)),true)
    # Targets listed in VULKAN_DEQP_LEVEL_2019_03_01_TARGETS_LIST are being restricted to deqp level version 132317953.
    #As Pixel 2 is supported with vk1.1.3 level conformance.
    ifeq ($(call is-board-platform-in-list,$(VULKAN_DEQP_LEVEL_2019_03_01_TARGETS_LIST)), true)
        PRODUCT_COPY_FILES += \
    ...
    else ifeq ($(call is-board-platform-in-list,$(VULKAN_DEQP_LEVEL_2020_03_01_TARGETS_LIST)), true)
        PRODUCT_COPY_FILES += \
            frameworks/native/data/etc/android.software.vulkan.deqp.level-2020-03-01.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.software.vulkan.deqp.level.xml
    # All new product by default falls here which uses the new XML
    else
        PRODUCT_COPY_FILES += \
...
ifeq ($(call CHECK_VERSION_GE, $(ADRENO_PLATFORM_SDK_VERSION), $(PLATFORM_SDK_SPDK)),true)
    PRODUCT_COPY_FILES += \
