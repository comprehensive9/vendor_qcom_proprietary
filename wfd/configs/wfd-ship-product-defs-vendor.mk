...
WFD_VENDOR += libwfdutils_proprietary
WFD_VENDOR += libwfddisplayconfig_proprietary
WFD_VENDOR += wfdhdcphalservice.policy
WFD_VENDOR += wifidisplayhalservice.policy
WFD_VENDOR += wfdvndservice.policy
