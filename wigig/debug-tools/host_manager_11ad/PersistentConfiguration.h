...
public:
    ...
    ConfigurationParameter<bool> FlushChunk;
    ...
    ConfigurationParameter<std::string> CompressionApp;
    ConfigurationParameter<bool> VerifyCompressionApp;
};
...
public:
    ...
    ConfigurationParameter<std::string> NormalizedTargetLocation;
    ConfigurationParameter<uint32_t> HostPmcRingDescriptorsCount;
    ConfigurationParameter<uint32_t> HostPmcRingPayloadSizeBytes;
    ConfigurationParameter<uint32_t> MaxDataFileSize;
    ConfigurationParameter<uint32_t> MaxNumOfDataFiles;
    ConfigurationParameter<bool> DumpRawDataForDebug;
};

class JtagConfigurationSection final : public ConfigurationSection
{
public:
    explicit JtagConfigurationSection(JsonTree& configTreeRoot);
    ConfigurationParameter<uint32_t> ClockFrequency;
    ConfigurationParameter<std::string> JtagDevice;
    ConfigurationParameter<bool> ContinuousPmcSupported;
};

class AccessConfigurationSection final : public ConfigurationSection
{
public:
    explicit AccessConfigurationSection(JsonTree& configTreeRoot);
    ConfigurationParameter<std::string> DefaultDumpLocation;
};
...
public:
    ...
    JtagConfigurationSection JtagConfiguration;
    AccessConfigurationSection AccessConfiguration;
