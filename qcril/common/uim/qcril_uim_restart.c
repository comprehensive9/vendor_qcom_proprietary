...
)
{
     ...
     (pin_data_ptr->data_len <= QMI_UIM_MAX_ENCRYPTED_PIN_LEN))
  {
    ...
    if(qcril_uim.card_iccid_info[slot].iccid_len > 0 &&
       qcril_uim.card_iccid_info[slot].iccid_len <= QCRIL_UIM_ICCID_LEN)
    {
      memcpy(qcril_uim.pin1_info[pin_index].iccid_data,
             qcril_uim.card_iccid_info[slot].iccid_data,
             qcril_uim.card_iccid_info[slot].iccid_len);
      qcril_uim.pin1_info[pin_index].iccid_len = qcril_uim.card_iccid_info[slot].iccid_len;
    }
#else
...
)
{
...
#ifndef QMI_RIL_UTF
  if((qcril_uim.pin1_info[0].iccid_len == qcril_uim.card_iccid_info[slot].iccid_len) &&
  ...
  else if((qcril_uim.pin1_info[1].iccid_len == qcril_uim.card_iccid_info[slot].iccid_len) &&
