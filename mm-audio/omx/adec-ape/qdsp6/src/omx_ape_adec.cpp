/*============================================================================
  ...
  Copyright (c) 2015-2019, 2022  Qualcomm Technologies, Inc. All Rights Reserved.
        ...
        OMX_BUFFERHEADERTYPE* buffer)
{
    ...
    else
    {
        ...
        inc_num_drv_in_buf();
        DEBUG_PRINT("\n i/p Buffers with APE drv = %u\n", drv_inp_buf_cnt);

        rc = aio_write(&audio_aio_buf);
        if(rc == false)
        {
            dec_num_drv_in_buf();
            DEBUG_PRINT("ETBP: nNumInputBuf %u, drv_inp_buf_cnt %d\n",
