...
#ifndef NESTEDSTATEMACHINE
#define NESTEDSTATEMACHINE
...
public:
    ...
    virtual void dump(string padding, ostream& os) const override;

protected:
    int getParentState(int stateId) const;
    bool getActive(int stateId) const;
...
template <class E>
void NestedStateMachine<E>::dump(string padding, ostream& os) const {
...
template <class E>
int NestedStateMachine<E>::getParentState(int stateId) const {
...
template <class E>
bool NestedStateMachine<E>::getActive(int stateId) const {
