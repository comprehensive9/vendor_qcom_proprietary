...
===========================================================================*/
#ifndef BASEFINITESTATEMACHINE
#define BASEFINITESTATEMACHINE
...
public:
  ...
  virtual void dump(string padding, ostream& os) const;

protected:
  shared_ptr<IState<E>> getStateById(int stateId) const;
...
template<class E>
int BaseFiniteStateMachine<E>::getCurrentState() const {
  return currentState;
}
...
template<class E>
shared_ptr<IState<E>> BaseFiniteStateMachine<E>::getStateById(int stateId) const {
...
template<class E>
void BaseFiniteStateMachine<E>::dump(string padding, ostream& os) const {
  auto currState = getStateById(currentState);
  os << padding << "state=" <<
