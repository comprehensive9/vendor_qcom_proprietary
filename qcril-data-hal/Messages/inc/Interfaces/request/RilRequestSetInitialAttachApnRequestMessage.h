...
class RilRequestSetInitialAttachApnRequestMessage : public SolicitedMessage<generic_callback_payload>,
                              public add_message_id<RilRequestSetInitialAttachApnRequestMessage>
{
public:
...
public:
 static constexpr const char *MESSAGE_NAME = "RilRequestSetInitialAttachApnRequestMessage";
 RilRequestSetInitialAttachApnRequestMessage() = delete;
  ~RilRequestSetInitialAttachApnRequestMessage();

  inline RilRequestSetInitialAttachApnRequestMessage(const ril_request_type &request):
