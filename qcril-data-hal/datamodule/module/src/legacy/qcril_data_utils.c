...
/*===========================================================================
    ...
    Copyright (c) 2011-2016, 2018, 2020-2022 Qualcomm Technologies, Inc.
    All Rights Reserved.
...
)
{
  ...
  do
  {
    ...
    active_call_table = (RIL_Data_Call_Response_v11 *)malloc(
                         active_call_tbl_size * call_tbl_entry_size);

#elif (QCRIL_RIL_VERSION >= 10)

    active_call_table = (RIL_Data_Call_Response_v9 *)malloc(
                         active_call_tbl_size * call_tbl_entry_size);


#else

    active_call_table = (RIL_Data_Call_Response_v6 *)malloc(
                         active_call_tbl_size * call_tbl_entry_size);
...
#else
    active_call_table = (RIL_Data_Call_Response *)malloc(
                         active_call_tbl_size * call_tbl_entry_size);
#endif /* (QCRIL_RIL_VERSION >= 6) */
...
)
{
  ...
  for (i = 0; i < num_addr_info; ++i)
  {
    ...
    {
      QCRIL_LOG_ERROR("qcril_data_util_dsi_addr_to_str: primary address is invalid [%d]",
                      i);
    }
    ...
    {
      QCRIL_LOG_ERROR("qcril_data_util_dsi_addr_to_str: secondary address is invalid [%d]",
                      i);
    }
  }
