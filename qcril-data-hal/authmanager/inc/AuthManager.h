...
class AuthManager {
 public:
  ...
  int updateModemWithCarrierImsiKeyCache();
  ...
  bool setCarrierInfoImsiEncryption(const ImsiEncryptionInfo_t *imsiEncryptionInfo);
 ...
 private:
  ...
  bool updateCarrierImsiKeyCache(const ImsiEncryptionInfo_t *imsiEncryptionInfo);
