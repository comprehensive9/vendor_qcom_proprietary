...
Return<StatusCode> DataConnectionServiceImpl::getBearerAllocation(
    ...
    Log::getInstance().d("DataConnectionServiceImpl::getBearerAllocation()" + std::to_string(cookie));
...
Return<StatusCode> DataConnectionServiceImpl::getAllBearerAllocations(
    ...
    uint64_t cookie = registerResponseCb(cb);
    Log::getInstance().d("DataConnectionServiceImpl::getAllBearerAllocations()" + std::to_string(cookie));
...
void DataConnectionServiceImpl::sendBearerAllocationResult(
    ...
    registeredResponsesMutex.unlock();
    Log::getInstance().d("DataConnectionServiceImpl::sendBearerAllocationResult()" + std::to_string(cookie));
    if (cb == nullptr) {
