...
Copyright (c) 2012-2015,2019-2020,2022 Qualcomm Technologies, Inc.  All Rights Reserved.
...
static struct setting_info tm_cfgs_sdxnightjar[] =
{
	{
		.desc = "VDD_RSTR_MONITOR-AOSS",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
			.sensor = "aoss-0-usr",
			.sampling_period_ms = 1000,
...
static struct setting_info tm_cfgs_lagoon[] =
{
	{
		.desc = "Q6-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_scuba_qrd[] =
{
	...
	{
		.desc = "S3_MONITOR_LEVEL1",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
			.sensor = "VIRTUAL-S3-LEVEL1",
			.sampling_period_ms = 1000,
			.num_thresholds = 1,
			._n_thresholds = 1,
			._n_to_clear = 1,
	...
	{
		.desc = "S3_MONITOR_LEVEL2",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
			.sensor = "VIRTUAL-S3-LEVEL2",
			.sampling_period_ms = 1000,
			.num_thresholds = 1,
			._n_thresholds = 1,
			._n_to_clear = 1,
...
static struct setting_info tm_cfgs_shima[] =
{
	{
		.desc = "NSPSS0-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
			.sensor = "nspss-0-usr",
			.sampling_period_ms = 1000,
...
static struct setting_info tm_cfgs_shima_qrd[] =
{
	{
		.desc = "NSPSS0-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_lahaina[] =
{
	{
...
static struct setting_info tm_cfgs_yupik[] =
{
	{
		.desc = "NSPSS0-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_yupik_qrd[] =
{
	{
		.desc = "NSPSS0-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_sa410m[] =
{
	{
...
static struct setting_info tm_cfgs_sdxprairie[] =
{
	{
	...
	{
		.desc = "VDD_RSTR_MONITOR5",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
			.sensor = "mdm-core-2-usr",
			.sampling_period_ms = 1000,
			.num_thresholds = 1,
			.descending_thresh = 1,
			._n_thresholds = 1,
...
static struct setting_info tm_cfgs_sdxpoorwills[] =
{
	{
		.desc = "VDD_RSTR_MONITOR1",
		.algo_type = MONITOR_ALGO_TYPE,
...
void thermal_monitor_init_data(struct thermal_setting_t *setting)
{
	...
	switch (therm_get_msm_id()) {
		...
		case THERM_LAGOON:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_lagoon;
				arr_size = ARRAY_SIZE(tm_cfgs_lagoon);
				break;
			default:
		...
		case THERM_KHAJE:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_khaje;
				arr_size = ARRAY_SIZE(tm_cfgs_khaje);
				break;
			default:
				cfg = tm_cfgs_khaje_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_khaje_qrd);
				break;
			}
			break;
		case THERM_SCUBA:
			...
			break;
		case THERM_SDXNIGHTJAR:
			cfg = tm_cfgs_sdxnightjar;
			arr_size = ARRAY_SIZE(tm_cfgs_sdxnightjar);
			break;
#ifdef ENABLE_BW_SENSOR
		case THERM_QM_215:
			cfg = tm_cfgs_qm215;
		...
		case THERM_HOLI:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_holi;
				arr_size = ARRAY_SIZE(tm_cfgs_holi);
				break;
			default:
				cfg = tm_cfgs_holi_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_holi_qrd);
				break;
			}
			break;
		case THERM_SHIMA:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_shima;
				arr_size = ARRAY_SIZE(tm_cfgs_shima);
				break;
			default:
				cfg = tm_cfgs_shima_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_shima_qrd);
				break;
			}
			break;
		case THERM_LAHAINA:
			cfg = tm_cfgs_lahaina;
			arr_size = ARRAY_SIZE(tm_cfgs_lahaina);
			break;
		case THERM_YUPIK:
			switch (therm_get_hw_platform()) {
			case THERM_PLATFORM_MTP:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_yupik;
				arr_size = ARRAY_SIZE(tm_cfgs_yupik);
				break;
			default:
				cfg = tm_cfgs_yupik_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_yupik_qrd);
				break;
			}
			break;
		case THERM_MONACO:
			...
			case THERM_PLATFORM_ATP:
				break;
			default:
				cfg = tm_cfgs_monaco_wdp;
				arr_size = ARRAY_SIZE(tm_cfgs_monaco_wdp);
				break;
			}
			break;
		case THERM_SA410M:
			cfg = tm_cfgs_sa410m;
			arr_size = ARRAY_SIZE(tm_cfgs_sa410m);
			break;
		case THERM_SDXPRAIRIE:
			cfg = tm_cfgs_sdxprairie;
			arr_size = ARRAY_SIZE(tm_cfgs_sdxprairie);
			break;
		case THERM_SDXPOORWILLS:
			cfg = tm_cfgs_sdxpoorwills;
			arr_size = ARRAY_SIZE(tm_cfgs_sdxpoorwills);
			break;
		default:
