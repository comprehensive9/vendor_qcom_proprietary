...
#else
static inline enum thermal_algo_ret_t thermal_algo_start(
	const struct thermal_algo_info* algo_info,
	const struct thermal_setting_t* setting)
{
...
static inline enum thermal_algo_ret_t thermal_algo_framework_init(void)
{
	return THERMAL_ALGO_SUCCESS;
}

static inline enum thermal_algo_ret_t thermal_algo_framework_cleanup(void)
{
	return THERMAL_ALGO_SUCCESS;
}
#endif /* ENABLE_ALGO_FRAMEWORK */
