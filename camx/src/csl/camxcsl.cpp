...
CAMX_STATIC_ASSERT(static_cast<INT>(ChiCameraTitanSocSM7250P)       == static_cast<INT>(CSLCameraTitanSocSM7250P));
...
CAMX_STATIC_ASSERT(static_cast<INT>(ChiCameraTitanSocQCS8250)      == static_cast<INT>(CSLCameraTitanSocQCS8250));
