    ...
    const StatsInitializeData* pInitializeData)
{
    ...
    if (CamxResultSuccess == result)
    {
        ...
        if (NULL != pInitializeData->initializecallback.pASDCallback)
        {
            ...
            if (NULL != m_pfnCreate)
            {
                result = (*m_pfnCreate)(&createParamList, &m_pASDAlgorithm);
            }
        }
    ...
    if (CamxResultSuccess == result && NULL != m_pASDAlgorithm)
    {
...
CamxResult CASDStatsProcessor::SetOverrideAlgoSetting()
{
    ...
    if (NULL != m_pASDAlgorithm)
    {
        result = m_pASDAlgorithm->ASDSetParam(m_pASDAlgorithm, &setParams);
    }
    return result;
}
    ...
    const StatsProcessRequestData* pStatsProcessRequestDataInfo)
{
    ...
    else
    {
        ...
        if (CamxResultSuccess == result)
        {
            if (NULL != m_pASDAlgorithm)
            {
                result = m_pASDAlgorithm->ASDProcess(m_pASDAlgorithm, &input, &output);
            }
        }
        if (CamxResultSuccess != result)
        {
...
CASDStatsProcessor::~CASDStatsProcessor()
{
    ...
    if (NULL != m_pASDAlgorithm)
    {
        m_pASDAlgorithm->ASDDestroy(m_pASDAlgorithm);
        m_pASDAlgorithm = NULL;
    ...
    ASDAlgoOutputList* pOutput)
{
    ...
    if (NULL != m_pASDAlgorithm)
    {
        result = m_pASDAlgorithm->ASDGetParam(m_pASDAlgorithm, &getParam);
    }
