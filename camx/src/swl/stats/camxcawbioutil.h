...
public:
    ...
    /// SetAppSyncModeInfo
    ///
    /// @brief  Set app peer info read from application
    ///
    /// @param  syncModeInfo                    App sync mode info
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID SetAppSyncModeInfo(
...
private:
    ...
    struct AWBAlgorithmInputs
    {
        ...
        AppSyncModeInfo             appSyncModeInfo;    ///< Holds sync mode info for independent camera sync
    };
    ...
    struct AWBAlgorithmOutputs
    {
        ...
        UINT32                              peerInfoSize;                           ///< Holds AWB peer info size
    };
