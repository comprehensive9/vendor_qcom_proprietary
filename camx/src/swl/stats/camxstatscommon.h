...
/// @brief Update below whenever there is change in peer info structure definition
static const UINT32 AECPeerInfoSize         = 120;  ///< Size of AEC peer info
static const UINT32 AWBPeerInfoSize         = 228;  ///< Size of AWB peer info
