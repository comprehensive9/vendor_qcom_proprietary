...
struct SensorParam
{
    ...
    BOOL                    currentStrobeOff;
    UINT64                  currentStrobeWidthNs;
    BOOL                    previousStrobeOff;
    UINT64                  previousStrobeWidthNs;
};
...
public:
    ...
    /// ReleaseCacheLock
    ///
    /// @brief  Release the device cache lock
    ///
    /// @param  cameraId Physical camera ID
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE VOID ReleaseCacheLock(
        UINT32 cameraId) const
    {
        if ((cameraId < MaxNumImageSensors) && (NULL != m_pCacheLock[cameraId]))
        {
            m_pCacheLock[cameraId]->Unlock();
        }
    }
    ...
    /// AcquireCacheLock
    ///
    /// @brief  Acquire the device cache lock
    ///
    /// @param  cameraId Physical camera ID
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE BOOL AcquireCacheLock(
        UINT32 cameraId) const
    {
        if ((cameraId < MaxNumImageSensors) && (NULL != m_pCacheLock[cameraId]))
        {
            m_pCacheLock[cameraId]->Lock();
            return true;
        }
        return false;
    }
...
private:
    ...
    Mutex*                            m_pCacheLock[MaxNumImageSensors];       ///< mutex lock for the class
...
private:
    ...
    /// LogStaticData
    ///
    /// @brief  Helper function to log sensor node related static data
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID LogStaticData();
    ...
    CmdBufferManager*            m_pReadPacketManager;               ///< Read Packet buffer manager
    CmdBufferManager*            m_pReadCmdBufferManager;            ///< Read Cmd buffer manager
    ...
    VOID*                        m_pStrobeInfo;                      ///< Pointer to strobe info
    ...
    BOOL                         m_isFPSMatchEnabled;                ///< Flag to indicate if FPS match enabled
