...
private:
    ...
    // ValidateZoomWindow
    ///
    /// @brief  Validate zoom window after removing margin and additional margins
    ///
    /// @param  pCropInfo           Pointer to crop rect
    /// @param  pAdjCropInfo        Pointer to adjusted crop rect
    /// @param  fullWidth           Full width
    /// @param  fullHeight          Full height
    /// @param  adjFullWidth        Adjusted full width
    /// @param  adjFullHeight       Adjusted full height
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID ValidateZoomWindow(
