    ...
    StabilizationConfig* pStabilizationConfig)
{
    ...
    pStabilizationConfig->boundaryCaseFactor = pFDConfig->stabilization.boundaryCaseFactor;
    ...
    pStabilizationConfig->attributeConfigs[ObjectPositionIndex].maxUnstableStateCount                        =
        pFDConfig->stabilization.position.maxUnstableStateCount;
    ...
    pStabilizationConfig->attributeConfigs[ObjectPositionIndex].movingMaxDelayCount                          =
        pFDConfig->stabilization.position.movingMaxDelayCount;
    pStabilizationConfig->attributeConfigs[ObjectPositionIndex].movingMaxHoldCount                           =
        pFDConfig->stabilization.position.movingMaxHoldCount;
    pStabilizationConfig->attributeConfigs[ObjectPositionIndex].defaultMotionDetector.movingLinkFactor       =
        pFDConfig->stabilization.position.defaultMotionDetector.movingLinkFactor;
    pStabilizationConfig->attributeConfigs[ObjectPositionIndex].defaultMotionDetector.movingThreshold        =
        pFDConfig->stabilization.position.defaultMotionDetector.movingThreshold;
    pStabilizationConfig->attributeConfigs[ObjectPositionIndex].defaultMotionDetector.movingScalerAtBoundary =
        pFDConfig->stabilization.position.defaultMotionDetector.movingScalerAtBoundary;
    ...
    pStabilizationConfig->attributeConfigs[ObjectSizeIndex].maxUnstableStateCount                =
        pFDConfig->stabilization.size.maxUnstableStateCount;
    ...
    pStabilizationConfig->attributeConfigs[ObjectSizeIndex].movingMaxDelayCount                  =
        pFDConfig->stabilization.size.movingMaxDelayCount;
    pStabilizationConfig->attributeConfigs[ObjectSizeIndex].movingMaxHoldCount                   =
        pFDConfig->stabilization.size.movingMaxHoldCount;
    pStabilizationConfig->attributeConfigs[ObjectSizeIndex].sizeMotionDetector.cutOffThreshold   =
        pFDConfig->stabilization.size.sizeMotionDetector.cutOffThreshold;
    ...
    pStabilizationConfig->attributeConfigs[ObjectSizeIndex].averageFilter.preFilterHistoryLength =
        pFDConfig->stabilization.size.averageFilter.preFilterHistoryLength;

    CAMX_LOG_VERBOSE(CamxLogGroupFD, "Stabilization Filter Param: historyDepth = %d, boundaryCaseFactor = %f",
                     pStabilizationConfig->historyDepth,
                     pStabilizationConfig->boundaryCaseFactor);

    CAMX_LOG_VERBOSE(CamxLogGroupFD, "Stabilization Filter Param: position (%d %d %d %d %d %d %d %d %d %d %d %f %d %d %d %d)",
                     pStabilizationConfig->attributeConfigs[ObjectPositionIndex].enable,
                     pStabilizationConfig->attributeConfigs[ObjectPositionIndex].mode,
                     pStabilizationConfig->attributeConfigs[ObjectPositionIndex].minStableState,
                     pStabilizationConfig->attributeConfigs[ObjectPositionIndex].stableThreshold,
    ...
    CAMX_LOG_VERBOSE(CamxLogGroupFD, "Stabilization Filter Param: size (%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d)",
                     pStabilizationConfig->attributeConfigs[ObjectSizeIndex].enable,
                     pStabilizationConfig->attributeConfigs[ObjectSizeIndex].mode,
                     pStabilizationConfig->attributeConfigs[ObjectSizeIndex].minStableState,
                     pStabilizationConfig->attributeConfigs[ObjectSizeIndex].stableThreshold,
