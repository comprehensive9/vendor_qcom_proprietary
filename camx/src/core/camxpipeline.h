...
public:
    ...
    /// ResetFlushInfo
    ///
    /// @brief  Reset flush type used
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE VOID ResetFlushInfo()
    {
        // we are resetting flush state of the pipeline. But no resetting the lastFlushed requestID
        // requestIdOffsetFromLastflush remains in tact.
        m_flushInfo.flushType          = CSLNoFlush;

        CAMX_LOG_CONFIG(CamxLogGroupCore, "Pipeline:%s Resetting flush state",
                      GetPipelineName());
    }
