...
private:
    ...
    ///
    /// @brief  Syncs the process capture request by setting AE lock range
    ///
    /// @param  pCaptureRequests   The metadata and input/output buffers to use for the capture request.
    ...
    /// GetMultiCameraSync
    ///
    /// @brief  This will get the Sync Flag for capture request
    ///
    /// @param  pCaptureRequest    The metadata and input/output buffers to use for the capture request.
    /// @param  pEnable            Pointer to the Sync flag
    ///
    /// @return CamxResultSuccess if successful
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult GetMultiCameraSync(
