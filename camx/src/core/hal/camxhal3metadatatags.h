...
/// @brief ISPPartialMWBMode
enum ISPPartialMWBMode
{
    MWBDisable = 0,    ///< Manual White Balance Mode Disabled
    MWBCCT,            ///< Manual White Balance Mode with CCT input and gains calculated by algo
    MWBGains,          ///< Manual White Balance Mode with Gains input and cct calculated by algo
    MWBCCM,            ///< Manual White Balance Mode with CC matrix input
};
