...
/// @brief structure for strobe control info.
struct StrobeControl
{
    UINT    strobeOff;        ///< Strobe off or on status, when off other values are ignored
    UINT64  strobeRampTime;   ///< Strobe ramp time required for reaching full intensity
    UINT64  strobeWidth;      ///< Strobe start delay after start of exposure
};
