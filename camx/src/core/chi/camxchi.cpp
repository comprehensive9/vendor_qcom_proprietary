...
#define REGISTER_BIT_TOKEN(inToken, data)                                        \
    ...
    REGISTER_TOKEN(ChxSettingsToken::MultiCameraFrameSyncMask,          pStaticSettings->multiCameraFrameSyncMask);
    REGISTER_TOKEN(ChxSettingsToken::MultiCameraFPSMatchMask,           pStaticSettings->multiCameraFPSMatchMask);
...
#define ADD_BIT_SETTING(inToken, data)                                                \
    ...
    ADD_SETTING(ChxSettingsToken::MultiCameraFrameSyncMask, pStaticSettings->multiCameraFrameSyncMask);
    ADD_SETTING(ChxSettingsToken::MultiCameraFPSMatchMask, pStaticSettings->multiCameraFPSMatchMask);
...
static ChiCameraFamilySoc GetSocId()
{
    switch(HwEnvironment::GetInstance()->GetSocId())
    {
        ...
        case CSLCameraTitanSocQCS8250:
            return ChiCameraTitanSocQCS8250;
        ...
        case CSLCameraTitanSocSM7250P:
            return ChiCameraTitanSocSM7250P;
