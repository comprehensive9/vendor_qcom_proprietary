    ...
    ISPInputData* pInputData)
{
    ...
    UINT32 offsetX;
    UINT32 offsetY;
    UINT32 fullResolutionWidth;
    UINT32 fullResolutionHeight;
    ...
    else
    {
            ...
            (NULL != pInputData->pHALTagsData))
        {
            ...
            fullResolutionWidth  = pInputData->sensorData.fullResolutionWidth;
            fullResolutionHeight = pInputData->sensorData.fullResolutionHeight;

            if ((TRUE == pInputData->HVXData.DSEnabled) && (BEFOREWB != pInputData->HVXData.HVXtapPoint))
            {
            ...
            if ((TRUE                                           == m_moduleEnable)                     &&
                ((m_pState->dependence40Data.imageWidth         != width)                              ||
                 ...
                 (m_pState->dependenceData.fullResWidth         != fullResolutionWidth)                ||
                 (m_pState->dependenceData.fullResHeight        != fullResolutionHeight)               ||
                 (TRUE                                          == pInputData->forceTriggerUpdate)))
            {
                m_pState->dependence40Data.fullResWidth   = fullResolutionWidth;
                m_pState->dependence40Data.fullResHeight  = fullResolutionHeight;
                m_pState->dependence40Data.offsetX        = offsetX;
                m_pState->dependence40Data.offsetY        = offsetY;
                m_pState->dependence40Data.imageWidth     = width;
                m_pState->dependence40Data.imageHeight    = height;
                ...
                CAMX_LOG_VERBOSE(CamxLogGroupISP,
                                 "offsetX %d offsetY %d width %d height %d fullRes %d x %d scale %d ",
                                 m_pState->dependenceData.offsetX,
                                 m_pState->dependenceData.offsetY,
                                 m_pState->dependenceData.imageWidth,
                                 m_pState->dependenceData.imageHeight,
                                 m_pState->dependence40Data.fullResWidth,
                                 m_pState->dependence40Data.fullResHeight,
                                 m_pState->dependence40Data.scalingFactor);
