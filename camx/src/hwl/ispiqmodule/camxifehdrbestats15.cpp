    ...
    ISPInputData* pInputData)
{
    ...
    BOOL   isAdjusted = FALSE;
     ...
     UINT32 inputWidth = pInputData->pStripeConfig->CAMIFCrop.lastPixel  -
                        pInputData->pStripeConfig->CAMIFCrop.firstPixel + 1;
    UINT32 inputHeight = pInputData->pStripeConfig->CAMIFCrop.lastLine -
    ...
    {
        if(m_hwCapability.regionMinWidth * m_HDRBEConfig.horizontalNum > inputWidth)
        {
          m_HDRBEConfig.horizontalNum = inputWidth / m_hwCapability.regionMinWidth;
        }
        ...
        if(m_hwCapability.regionMinHeight * m_HDRBEConfig.verticalNum > inputHeight)
        {
          m_HDRBEConfig.verticalNum = inputHeight / m_hwCapability.regionMinHeight;
        }
    ...
    {
        if(m_hwCapability.regionMaxWidth * m_HDRBEConfig.horizontalNum > inputWidth)
        {
          m_HDRBEConfig.horizontalNum = inputWidth / m_hwCapability.regionMaxWidth;
        }
        m_HDRBEConfig.ROI.width =
        ...
        if(m_hwCapability.regionMaxHeight * m_HDRBEConfig.verticalNum > inputHeight)
        {
          m_HDRBEConfig.verticalNum = inputHeight / m_hwCapability.regionMaxHeight;
        }
        m_HDRBEConfig.ROI.height =
            (m_HDRBEConfig.ROI.height > (m_hwCapability.regionMaxHeight * m_HDRBEConfig.verticalNum)) ?
