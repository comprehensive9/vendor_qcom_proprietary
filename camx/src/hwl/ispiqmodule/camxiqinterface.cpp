        ...
        if (TRUE == commonIQResult)
        {
            ...
            else if (PipelineType::BPS == pOutput->type)
            {
                ...
                if (TRUE == commonIQResult)
                {
                    ...
                    // pInput->alscEnable bit is controlled by Chromatix enable bit.
                    // When AWB BG Stats is NULL then pInput->alscEnable bit is set to FALSE
                    if ((TRUE == s_prevALSCTableValid[cameraID][sensorAR]) &&
                        (TRUE == pInput->alscEnable))
                    {
                    ...
                    else // This is the case when AWBBG Stats is NULL, Disable ALSC_enbale bit
                    {
