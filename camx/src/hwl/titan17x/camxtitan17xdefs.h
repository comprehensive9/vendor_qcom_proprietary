...
/// @brief IFE OFF-CENTERD Zoom margin
static const UINT32 ISPOffCenteredZoomPixelMargin     = 2;
static const UINT32 ISPOffCenteredZoomQCFAPixelMargin = 4;
...
static const FLOAT     IPE17xRealtimeClockEfficiencyNoOverhead      = 1.00F;  ///< Titan580 RT efficiency without Overhead
static const FLOAT     IPE17xNonRealtimeClockEfficiencyNoOverhead   = 1.00F;  ///< Titan580 NRT efficiency without Overhead
...
static const FLOAT     IPE480RealtimeClockEfficiencyNoOverhead      = 4.00F;  ///< Titan480 RT efficiency without Overhead
static const FLOAT     IPE480NonRealtimeClockEfficiencyNoOverhead   = 1.00F;  ///< Titan480 NRT efficiency without Overhead
static const FLOAT     IPE580RealtimeClockEfficiency                = 3.28F;  ///< IPE Titan580 RT efficiency for one IPE Core
static const FLOAT     IPE580NonRealtimeClockEfficiency             = 0.68F;  ///< IPE Titan580 NRT efficiency for one IPE Core
