...
static VendorTagData g_VendorTagSectionSensorModeTable[] =
{
    ...
    { "SensorModeDimension",        VendorTagType::Byte,  sizeof(ChiDimension) },
    { "SensorModeCrop",             VendorTagType::Byte,  sizeof(ChiRectEXT) },
    { "SensorModeBinning",          VendorTagType::Byte,  sizeof(UINT32) * 2 },
    { "SensorModeLineTimeNs",       VendorTagType::Int32, 1 },
    { "SensorModeADCReadoutTimeNs", VendorTagType::Int32, 1 }
};
...
/// org.quic.camera.strobeControl section
static VendorTagData g_VendorTagSectionStrobeControl[] =
{
    { "strobeControl", VendorTagType::Byte, sizeof(StrobeControl) }
};
...
static VendorTagData g_VendorTagSectionSessionParameters[] =
{
    ...
    { "numPCRsBeforeStreamOn",          VendorTagType::Byte,                                   1 },
    { "HDRVideoMode",                   VendorTagType::Int32,                                  1 },
    { "numRawBatchedFramesTag",         VendorTagType::Int32,                                  1 }
};
...
/// org.codeaurora.qcamera3.multicamsync section
static VendorTagData g_VendorTagSectionMultiCamSync[] =
{
    { "appSyncMode", VendorTagType::Byte, sizeof(BOOL) },
    { "isMaster",    VendorTagType::Byte,  sizeof(BOOL) }
};

/// org.codeaurora.qcamera3.multicamsyncdata section
static VendorTagData g_VendorTagSectionMultiCamSyncData[] =
{
    { "AECPeerInfoSize", VendorTagType::Int32, 1 },
    { "AECPeerInfo",     VendorTagType::Byte,  AECPeerInfoSize },
    { "AWBPeerInfoSize", VendorTagType::Int32, 1 },
    { "AWBPeerInfo",     VendorTagType::Byte,  AWBPeerInfoSize }
};
...
static VendorTagSectionData g_HwVendorTagSections[] =
{
    ...
    {
        "org.quic.camera.strobeControl", 0,
        CAMX_ARRAY_SIZE(g_VendorTagSectionStrobeControl), g_VendorTagSectionStrobeControl,
        TagSectionVisibility::TagSectionVisibleToAll
    },
    ...
    {
        "org.codeaurora.qcamera3.multicamsync", 0,
        CAMX_ARRAY_SIZE(g_VendorTagSectionMultiCamSync), g_VendorTagSectionMultiCamSync,
        TagSectionVisibility::TagSectionVisibleToAll
    },

    {
        "org.codeaurora.qcamera3.multicamsyncdata", 0,
        CAMX_ARRAY_SIZE(g_VendorTagSectionMultiCamSyncData), g_VendorTagSectionMultiCamSyncData,
        TagSectionVisibility::TagSectionVisibleToAll
    },
};
    ...
    PlatformStaticCaps* pCaps)
{
    ...
    if (CamxResultSuccess == result)
    {
        if ((CSLCameraTitanSocSDM670  == CSLPlatform.socId) ||
            ...
            (CSLCameraTitanSocSM7250P  == CSLPlatform.socId) ||
...
CamxResult Titan17xContext::InitializeSOCDependentParams()
{
    ...
    if ((CSLCameraTitanSocSDM670  == socID) ||
        ...
        (CSLCameraTitanSocSM7250P == socID) ||
        (CSLCameraTitanSocQSM7250 == socID))
    {
        UBWCPlaneConfig.highestValueBit = NonNaplaiUBWCHighestBankValue;
        if ((CSLCameraTitanSocSM7250  == socID) || (CSLCameraTitanSocQSM7250 == socID) || (CSLCameraTitanSocSM7250P == socID))
        {
