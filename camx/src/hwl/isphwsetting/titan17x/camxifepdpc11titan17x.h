...
struct IFEPDPC11RegCmd
{
    ...
    IFE_IFE_0_VFE_PDAF_T2_BP_OFFSET   offsetT2BPRegister;       ///< Bad Pixtel Threshold Offset Register. Offset: 0xcbc
    IFE_IFE_0_VFE_PDAF_BP_TH          setBPTHregister;          ///< Bad Pixtel Threshold Register. Offset: 0xcc0
