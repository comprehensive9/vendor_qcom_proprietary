...
struct IPECapabilityInfo
{
    ...
    FLOAT            realtimeClockEfficiencyNoOverhead;           ///< realtime clock Efficiency no overhead
    FLOAT            nonrealtimeClockEfficiencyNoOverhead;        ///< non real time clock Efficiency no overhead
    FLOAT            realtimeClockEfficiencyOverhead;             ///< realtime clock Efficiency overhead
    FLOAT            nonrealtimeClockEfficiencyOverhead;          ///< non real time clock Efficiency Overhead
    BOOL             LDCSupport;                                  ///< LDC supported version
