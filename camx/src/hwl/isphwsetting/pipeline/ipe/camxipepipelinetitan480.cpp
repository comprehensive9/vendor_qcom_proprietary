    ...
    VOID* pCapabilityInfo)
{
    ...
    if (NULL != pIPECapabilityInfo)
    {
        ...
        pIPECapabilityInfo->realtimeClockEfficiencyNoOverhead    = IPE480RealtimeClockEfficiencyNoOverhead;
        pIPECapabilityInfo->nonrealtimeClockEfficiencyNoOverhead = IPE480NonRealtimeClockEfficiencyNoOverhead;
        pIPECapabilityInfo->realtimeClockEfficiencyOverhead      = IPE480RealtimeClockEfficiency;
        pIPECapabilityInfo->nonrealtimeClockEfficiencyOverhead   = IPE480NonRealtimeClockEfficiency;
