    ...
    VOID* pCapabilityInfo)
{
    ...
    if (NULL != pIPECapabilityInfo)
    {
        ...
        pIPECapabilityInfo->realtimeClockEfficiencyNoOverhead    = IPE17xRealtimeClockEfficiencyNoOverhead;
        pIPECapabilityInfo->nonrealtimeClockEfficiencyNoOverhead = IPE17xNonRealtimeClockEfficiencyNoOverhead;
        pIPECapabilityInfo->realtimeClockEfficiencyOverhead      = IPE17xClockEfficiency;
        pIPECapabilityInfo->nonrealtimeClockEfficiencyOverhead   = IPE17xClockEfficiency;
