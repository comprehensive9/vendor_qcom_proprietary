    ...
    ISPInputData* pModuleInput)
{
    ...
    CAMX_LOG_VERBOSE(CamxLogGroupBPS, "BPS:%d partialMwbMode %d", InstanceID(), pModuleInput->pHALTagsData->partialMwbMode);
...
VOID BPSNode::DumpConfigIOData()
{
    ...
    CAMX_LOG_CONFIG(CamxLogGroupBPS, "BPS:%d Config IO Data Dump:", InstanceID());
    for (UINT i = 0; i < BPS_IO_IMAGES_MAX; i++)
    {
        CAMX_LOG_CONFIG(CamxLogGroupBPS, "BPS:%d image %d format=%d, width=%d, height=%d",
                       InstanceID(), i,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSNode::DumpDebugInternalNodeInfo
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID BPSNode::DumpDebugInternalNodeInfo(
    UINT64  requestId,
    BOOL    isPerFrameDump)
{
