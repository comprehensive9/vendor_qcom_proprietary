...
#define SP_APP_LOAD_FLAG_SOC_SM8350     0x00100000

#define WAIT_FOR_NVM_READY_TIMEOUT_SEC  300
...
typedef enum _spss_soc_t {
    ...
    SOC_SM8350  = SP_APP_LOAD_FLAG_SOC_SM8350,
} spss_soc_t;
...
static spss_soc_t   g_soc_type = SOC_SM8350;
...
static inline bool is_uefi()
{
    return (g_soc_type == SOC_SM8250) ||(g_soc_type == SOC_SM8350);
}
...
int main(void)
{
    ...
    //For SM8250/SM8350, SP is started already in UEFI stage. In that case, pass true
    ...
    ret = spcom_restart_sp_subsystem(is_uefi(), is_fw_update);
