...
static const uint32_t TEE_EX_PARAM_TYPE_NONE = UINT32_C(0);

static const uint32_t TEE_EX_PARAM_TYPE_MEMREF_NULL = UINT32_C(1);

static const uint32_t TEE_EX_PARAM_TYPE_MEMREF_DUP = UINT32_C(2);

static const uint32_t TEE_EX_PARAM_TYPE_MEMREF_FORCE_RW = UINT32_C(3);
