...
static const keymaster_tag_t KM_TAG_USE_SECURE_PROCESSOR =
        static_cast<keymaster_tag_t>(KM_BOOL | 15000);
static const keymaster_tag_t KM_TAG_SOTER_IS_FROM_SOTER_TEMP =
        static_cast<keymaster_tag_t>(KM_BOOL | 11000);
...
static const keymaster_tag_t KM_TAG_SOTER_UID_TEMP = static_cast<keymaster_tag_t>(KM_UINT | 11007);
...
static const keymaster_purpose_t KM_PURPOSE_WRAP = static_cast<keymaster_purpose_t>(5);

static const keymaster_algorithm_t KM_ALGORITHM_TripleDES = static_cast<keymaster_algorithm_t>(33);

// New KM4 tags
static const keymaster_tag_t KM_HARDWARE_TYPE = static_cast<keymaster_tag_t>(KM_ENUM | 304);
...
static const keymaster_tag_t KM_TAG_VENDOR_PATCHLEVEL = static_cast<keymaster_tag_t>(KM_UINT | 718);
static const keymaster_tag_t KM_BOOT_PATCHLEVEL = static_cast<keymaster_tag_t>(KM_UINT | 719);
static const keymaster_tag_t KM_TAG_FBE_ICE = static_cast<keymaster_tag_t>(KM_BOOL | 16201);
static const keymaster_tag_t KM_TAG_KEY_TYPE = static_cast<keymaster_tag_t>(KM_UINT | 16202);

// New KM41 tags
static const keymaster_tag_t KM_STORAGE_KEY = static_cast<keymaster_tag_t>(KM_BOOL | 722);
 ...
 */
template <keymaster_tag_type_t tag_type>
struct TagValueType {};
template <>
struct TagValueType<KM_ULONG> {
    typedef uint64_t value_type;
};
template <>
struct TagValueType<KM_ULONG_REP> {
    typedef uint64_t value_type;
};
template <>
struct TagValueType<KM_DATE> {
    typedef uint64_t value_type;
};
template <>
struct TagValueType<KM_UINT> {
    typedef uint32_t value_type;
};
template <>
struct TagValueType<KM_UINT_REP> {
    typedef uint32_t value_type;
};
template <>
struct TagValueType<KM_INVALID> {
    typedef Void value_type;
};
template <>
struct TagValueType<KM_BOOL> {
    typedef bool value_type;
};
template <>
struct TagValueType<KM_BYTES> {
    typedef keymaster_blob_t value_type;
};
template <>
struct TagValueType<KM_BIGNUM> {
    typedef keymaster_blob_t value_type;
};
 ...
 */
template <keymaster_tag_type_t tag_type, keymaster_tag_t tag>
class TypedTag {
  public:
