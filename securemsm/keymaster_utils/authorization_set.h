...
class AuthorizationSetBuilder {
  public:
    ...
    AuthorizationSetBuilder& IncludeUniqueId() { return Authorization(TAG_INCLUDE_UNIQUE_ID); }
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::RsaEncryptionKey(
