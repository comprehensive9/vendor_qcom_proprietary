...
#define TUI_CMD_SEND_PING 0xCAFE
#define TUI_CMD_RECV_PING 17
#define TUI_CMD_SEND_MSG 18

#define TUI_LOCK_STR "eidtuiapp"
                                           ...
                                           TUIDisplayBuffer *pBuf) const
{
    ...
    */
    ...
    TUILOGE("%s: size  (%d, %d)", __func__, pDispBuf->handle.size,
            pBuf->buffHandle.size);
