...
/*
 * Object_ERROR_AUTH indicates that the message cannot be authenticated.
 */
#define Object_ERROR_AUTH        -100

/*
 * Object_ERROR_REPLAY indicates that the messae has been replayed.
 */
#define Object_ERROR_REPLAY      -101

/*
 * Object_ERROR_MAXREPLAY indicates the replay counter cannot be
 * incremented.
 */
#define Object_ERROR_MAXREPLAY   -102

/*
 * Object_ERROR_TIMEOUT indicates that the invocation timed out before target
