...
#define LOG_TAG "QPAY:vendor.qti.secure_element@1.2-service"
...
int main() {
    ALOGE("vendor::qti::secure_element V1.2 service for QPAY starts");
    ...
    LOG_ALWAYS_FATAL_IF(status != OK, "Error while registering secure_element 1.2 service for QPAY: %d", status);
