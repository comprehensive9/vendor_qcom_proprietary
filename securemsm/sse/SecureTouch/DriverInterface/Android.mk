...
SECUREMSM_PATH      := $(QC_PROP_ROOT)/securemsm
...
else ifeq ($(call is-board-platform-in-list,sdm660 sdmshrike msmnile $(MSMSTEPPE) sdm710 sdm845 kona lito bengal atoll $(TRINKET) holi),true)
