...
Copyright (c) 2012-2022 Qualcomm Technologies, Inc.  All Rights
...
#endif  //!OE
#if !defined(OE) || defined(ENABLE_LV_SECURITY)
	{
...
#endif
#endif  //!defined(OE) || defined(ENABLE_LV_SECURITY)
...
#if (!defined ENABLE_LV_SECURITY) && (!defined ENABLE_UC_SECURITY)
