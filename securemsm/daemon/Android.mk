...
ifeq ($(ENABLE_QB_HANDLER), true)
LOCAL_SHARED_LIBRARIES += libQBTA_handler
QSEECOM_CFLAGS += -DENABLE_QBHANDLER
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../securemsm-noship/QuickBoot_handler
endif
