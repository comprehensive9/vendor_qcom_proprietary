...
enum class ChxSettingsToken
{
    ...
    MultiCameraFrameSyncMask,
    MultiCameraFPSMatchMask,
...
typedef enum ChiStreamFormat
{
    ...
    ChiStreamFormatUBWCNV124R    = 0x7FA30C07,   ///< UBWCNV12-4R
    ...
    ChiStreamFormatRaw8          = 0x00000123,   ///< 8BPP: Each pixel occupies one bytes, starting at LSB.
...
typedef enum ChiDataSpace
{
    ...
    DataspaceTransferHLG        = 8 << DataspaceTransferShift,  ///< HLG
    ...
    DataspaceStandardBT2020_PQ  = (DataspaceStandardBT2020 |    ///< BT.2020-PQ
                                   ...
                                   DataspaceRangeFull),
    DataspaceStandardBT2020_HLG = (DataspaceStandardBT2020 |    ///< BT.2020-HLG
                                   DataspaceTransferHLG |
                                   DataspaceRangeFull),
} CHIDATASPACE;
