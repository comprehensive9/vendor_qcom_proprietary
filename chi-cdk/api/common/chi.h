...
static const UINT32 MaxMetadataPerRequest           = 2;   ///< Maximum number of metadata buffers that can be sent
                                                           ///  per request
static const UINT32 MaxConfigSettings               = 128;  ///< Maximum number of configuration settings
...
typedef enum StreamConfigMode
{
    ...
    StreamConfigModeQTIMinLatencyYUV        = 0xF100,   ///< Operation mode for yuv direct output from IFE usecase.
...
typedef enum
{
    ...
    CHISocIdSM7250P  = 476,   ///< SM7250P SOC Id
    CHISocIdQCS8250  = 481,   ///< QCS8250 SOC Id
} CHISocId;
...
typedef enum MultiCameraSyncType
{
    MultiCameraSyncDisabled   = 0,                ///< disable sync for all usecase
    MultiCameraSyncRTB        = 1,                ///< enable sync for RTB
    MultiCameraSyncSAT        = 2,                ///< enable sync for SAT
    MultiCameraSyncVR         = 4,                ///< enable sync for VR
} MULTICAMERASYNCTYPE;
...
typedef enum
{
    ...
    ChiCameraTitanSocSM7250P      = 476,   ///< SM7250P SOC Id
    ChiCameraTitanSocQCS8250      = 481,   ///< QCS8250 SOC Id
} ChiCameraFamilySoc;
