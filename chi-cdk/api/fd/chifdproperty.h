...
struct FDDefaultMotionDetector
{
...
struct FDStabilizationAttributeConfig
{
    ...
    UINT32                  movingMaxHoldCount;     ///< Maximum of holdCount to determine if attribute stops moving in
                                                    ///< Stabilizing state
    FDDefaultMotionDetector defaultMotionDetector;  ///< motion detector by default
    FDSizeMotionDetector    sizeMotionDetector;     ///< motion detector for size attribute
    union
    {
...
struct FDStabilizationConfig
{
    ...
    FLOAT                           boundaryCaseFactor;    ///< Percentage factor of face ROI size to decide
                                                           ///< if object is at frame boundary
    FDStabilizationAttributeConfig  position;              ///< Position attibute configurations
    FDStabilizationAttributeConfig  size;                  ///< Size attibute configurations
};
