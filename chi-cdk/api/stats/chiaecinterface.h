...
/// @brief Identifies the type of query to AEC algorithm
    ...
    AECAlgoGetParamPeerInfoSize,                    ///< Size of Multi Camera Peer Information
                                                    ///  Input payload: NULL
                                                    ///  Output payload: UINT32
...
#define AEC_GET_ENUM_LIST(ADD_ENTRY)                        \
    ...
    ADD_ENTRY(AECAlgoGetParamPeerInfoSize)                  \
...
typedef enum
{
    ...
    AECAlgoGetParamOutputPeerInfoSize,                  ///< AEC peer info size
                                                        ///  Payload:UINT32
