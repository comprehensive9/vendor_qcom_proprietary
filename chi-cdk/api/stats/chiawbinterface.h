...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Defines the metadata inputs from HAL, needed to be used by AWB
/// following metadata from HAL will be defined
///   appSyncMode,           BOOL
///   appSyncModeMaster,     BOOL
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef struct
{
    BOOL appSyncMode;       ///< app 2A sync enable flag
    BOOL appSyncModeMaster; ///< flag to set master/slave role
}AppSyncModeInfo;
...
typedef enum
{
    ...
    AWBGetParamTypeBGConfig,                                    ///< Get AWB stats config
                                                                ///  Payload: StatsBayerGridBayerExposureConfig
    AWBGetParamTypePeerInfoSize,                                ///< Get AWB peer info size
...
#define AWB_GET_ENUM_LIST(ADD_ENTRY)                     \
    ...
    ADD_ENTRY(AWBGetParamTypePeerInfoSize)               \
...
typedef enum
{
    ...
    AWBGetParamOutputTypeBGConfig,                                  ///< Get AWB stats config
                                                                    ///  Payload: StatsBayerGridBayerExposureConfig
    AWBGetParamOutputTypePeerInfoSize,                              ///< AWB peer info size
