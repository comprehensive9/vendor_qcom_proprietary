...
typedef struct SensorStrobeInfo
{
    UINT    strobeOff;                     ///< Strobe off or on status, when off other values are ignored
    UINT64  strobeRampTimeNs;              ///< Strobe ramp time required for reaching full intensity
    UINT64  strobeWidthNs;                 ///< Strobe on duration after reaching full intensity
} SensorStrobeInfo;
...
typedef struct SensorExposureRegInfo
{
    ...
    UINT32                      strobeStartAddr;            ///< Register address to program strobe start time
    UINT32                      strobeWidthAddr;            ///< Register address to program strobe active time
