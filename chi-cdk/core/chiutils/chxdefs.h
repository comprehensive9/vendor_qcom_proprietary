...
enum class VendorTag
{
    ...
    NumPCRsBeforeStreamOn,          ///< number of Early PCR before stream on
    HDRVideoModeSession,            ///< HDRVideoMode enablement
    NumRawBatchedFramesTag,         ///< Number of Raw Batched frames
