...
private:
    ...
    CDKResult GenerateRealtimeRequest(
        ...
        BOOL*                      pRecoveryTriggered);         ///< Recovery Triggered flag
    ...
    Mutex*                      m_pExecutionDoneMutex;                         ///< Mutex for Synchronizing Flush/Destroy and
                                                                               ///< Execution Thread
    ...
    BOOL                    m_kernelFrameSyncEnable;                 ///< This tells whether frame sync enabled or not
    BOOL                    m_sensorFPSMatchEnable;                  ///< This tells whether FPS match enabled or not
