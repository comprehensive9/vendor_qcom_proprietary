...
typedef struct MulticamReqSettings {
    ...
    BOOL                    sensorFPSMatchEnable;                    ///< FPS match enable
} MulticamReqSettings;
...
public:
    ...
    static UINT32               m_vendorTagFrameSyncInfo;         ///< Vendor tag for frame sync info
    static UINT32               m_vendorTagFPSMatchInfo;          ///< Vendor tag for FPS match info
