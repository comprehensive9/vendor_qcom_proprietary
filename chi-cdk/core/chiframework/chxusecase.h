...
protected:
    ...
    UINT32                   m_numPCRsBeforeStreamOn;                               ///< Number of PCReqs before StreamOn
...
private:
    ...
    CDKResult ReplaceRequestMetadata(
        const VOID* pMetadata, UINT32 cameraId);                            ///< Request parameters

    /// Restore the original metadata that was passed in
    VOID RestoreRequestMetadata(
        camera3_capture_request_t* pRequest, UINT32 cameraId);              ///< Request parameters
