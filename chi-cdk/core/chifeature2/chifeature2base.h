...
// NOWHINE FILE CP011: 'Using' for type definition
...
/// @brief Feature request objest set
using ChiFeature2FROSet = std::unordered_set<const ChiFeature2RequestObject*>;
...
private:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// TriggerHardReleaseFeature
    ///
    /// @brief  Triggers the hard release of ports and TBMs by marking ports are output notified
    ///
    /// @param  pRequestObject  Feature request object.
    /// @param  requestId       requestId on which to operate
    ///
    /// @return CDKResultSuccess if successful or CDK error values in case of error.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult TriggerHardReleaseFeature(
        ChiFeature2RequestObject* pRequestObject,
        UINT8                     requestId);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// ProcessInputResource
    ///
    /// @brief  Process input resource command
    ///
    /// @param  pRequestObject  Feature request object instance.
    /// @param  requestId       requestId on which to operate
    ///
    /// @return CDKResultSuccess if successful
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult ProcessInputResource(
        ChiFeature2RequestObject* pRequestObject,
        UINT8                     requestId);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// RecycleTargetBuffers
    ///
    /// @brief  Recycle the target buffers when there is QCFA and Raw Callback request.
    ///
    /// @param  pRequestObject  Feature request object containing the configuration information for request submission.
    /// @param  requestId       The FRO batch requestId
    ///
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// AddFeatureRequestObj
    ///
    /// @brief  Insert Feature Request Object to Active map
    ///
    /// @param  pRequestObject  Feature request Object
    ///
    /// @return CDKResultSuccess if successful or CDK error values in case of error
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult AddFeatureRequestObj(
         const ChiFeature2RequestObject* pRequestObject)
    {
        CDKResult result = CDKResultSuccess;
        ...
        if (NULL != pRequestObject)
        {
            ...
            m_activeFeatureRequestObjs.insert(pRequestObject);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// RemoveFeatureRequestObj
    ///
    /// @brief  erase Feature Request Object from Active map
    ///
    /// @param  pRequestObject  Feature request Object
    ///
    /// @return CDKResultSuccess if successful or CDK error values in case of error
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult RemoveFeatureRequestObj(
        const ChiFeature2RequestObject* pRequestObject)
    {
        CDKResult result = CDKResultSuccess;
        ...
        {
            m_activeFROMapLock.lock();
            m_activeFeatureRequestObjs.erase(pRequestObject);
            m_activeFROMapLock.unlock();
        }
        return result;
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// IsFeatureRequestObjActive
    ///
    /// @brief  Function to find FRO object in active map.
    ///         Const function as this can called from const function or using const base object.
    ///
    /// @param  pRequestObject  Feature request Object
    ///
    /// @return TRUE if available false other wise.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    BOOL IsFeatureRequestObjActive(
        const ChiFeature2RequestObject* pRequestObject) const
    {
        BOOL isActive = FALSE;
        ...
        {
            m_activeFROMapLock.lock();
            isActive = (m_activeFeatureRequestObjs.find(pRequestObject) != m_activeFeatureRequestObjs.end()) ? TRUE : FALSE;
            m_activeFROMapLock.unlock();
        }
        return isActive;
    }
    ...
    Mutex*                              m_pActivationMutex;             ///< Activation mutex

    Semaphore*                          m_pExecuteProcessSem;           ///< Semaphore for max executeProcess threads
    Condition*                          m_pExecuteThreadDone;           ///< ExecuteThread done condition
    Mutex*                              m_pExecuteThreadDoneMutex;      ///< ExecuteThread done Mutex
    UINT32                              m_pMaxHalReqCount;              ///< Handle for max HAL requests Needed
    volatile UINT32                     m_isFlushInProgress;            ///< Is flush is in progress
    ChiFeature2FROSet                   m_activeFeatureRequestObjs; ///< Active feature request object reference for feature.
    // NOWHINE CP036b: Allowing mutable as this mutex is needed in const functions.
    mutable std::mutex                  m_activeFROMapLock;         ///< Lock active feature request object map
};
