    ...
    ) const
{
    ...
    {
        CHX_LOG_ERROR("m_pBatchOutputRequestInfo %s, Request index:%d is more than supported:%d",
            (NULL != m_pBatchOutputRequestInfo) ? "Not Null" : "NULL",
            requestIndex,
            m_numRequests);
    }
    return state;
    ...
    UINT8                       requestIndex)
{
    ...
    if (requestIndex < m_numRequests)
    {
        ...
        {
            CHX_LOG_WARN("Batch output request info is Null");
        }
    }
    else
    {
