#ifndef JSONPARSER_FIFO_MAP_HPP
#define JSONPARSER_FIFO_MAP_HPP
...
inline void swap(jsonparser::fifo_map<Key, T, Compare, Allocator>& m1,
                 jsonparser::fifo_map<Key, T, Compare, Allocator>& m2)
{
    m1.swap(m2);
}
}
