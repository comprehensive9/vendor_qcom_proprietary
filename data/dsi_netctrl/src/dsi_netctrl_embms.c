...
/*===========================================================================
  ...
  Copyright (c) 2013-2016, 2020-2021 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
)
{
  ...
  do
  {
    ...
    memset(&st_hndl->priv.embms_tmgi_list_info.embms_tmgi_params.content_desc_info,
           0,
           sizeof(st_hndl->priv.embms_tmgi_list_info.embms_tmgi_params.content_desc_info));
    ...
    if (st_hndl->priv.embms_tmgi_list_info.embms_tmgi_params.content_desc_info.content_desc_ptr)
    {
      free(st_hndl->priv.embms_tmgi_list_info.embms_tmgi_params.content_desc_info.content_desc_ptr);
      st_hndl->priv.embms_tmgi_list_info.embms_tmgi_params.content_desc_info.content_desc_ptr = NULL;
    }
  } while(0);
