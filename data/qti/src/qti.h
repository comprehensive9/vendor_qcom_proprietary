...
/******************************************************************************
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2012-2016, 2020-2021 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#define QTI_SOCINFO_SOC_ID_FILE_PATH     "/sys/devices/soc0/soc_id"
#define QTI_ESOCINFO_ESOC_NAME_FILE_PATH "/sys/bus/esoc/devices/esoc0/esoc_name"
#define QTI_CARRERA_FUSION_VAL           "SDX50M"
#define QTI_NAPALI_CHIRON_FUSION_VAL     "SDXPOORWILLS"
#define QTI_QTANG_SOC_ID                 "494"
#define QTI_SOC_INFO_MAX_LEN             10
...
typedef struct{
  ...
  boolean                  is_LA_LE_fusion_target;
}qti_rmnet_param;
...
=========================================================================*/
int qti_rmnet_process_ph_reset(void);
...
=========================================================================*/
int qti_rmnet_ph_get_ep_info(void);
...
int qti_rmnet_dpm_port_open(void);
...
int qti_rmnet_dpm_port_close(void);
...
int qti_rmnet_modem_init_interface(void);
...
=========================================================================*/
int qti_rmnet_dfs_release(void);
...
=========================================================================*/
int qti_rmnet_dpm_release(void);
...
=========================================================================*/
void qti_rmnet_modem_not_in_service(void);
...
==========================================================================*/
void qti_rmnet_modem_in_service(void);
...
==========================================================================*/
void qti_rmnet_process_modem_in_service(void);
...
int qti_rmnet_modem_reset(void);
