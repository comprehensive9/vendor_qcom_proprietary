...
=========================================================================*/
static int qti_update_modem_iface_name(void)
{
...
/*-------------------------------------------------------------------------*/
  ...
  if(is_fusion_supported && qti_update_modem_iface_name() == QTI_FAILURE)
  {
  ...
  LOG_MSG_INFO1("Open modem interface to send QMI messages", 0, 0, 0);
...
/*-----------------------------------------------------------------------*/
  ...
  if (is_ep_trans_enabled || is_fusion_supported)
  {
...
DESCRIPTION
  - obtains EP ID to be translated only in Fusion cases
...
void qti_rmnet_process_modem_in_service()
{
  ...
  LOG_MSG_INFO1("Started processing modem in service ind", 0, 0, 0);
