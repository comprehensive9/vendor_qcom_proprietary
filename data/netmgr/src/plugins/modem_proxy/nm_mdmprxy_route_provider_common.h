...
typedef struct nm_mdmprxy_global_cfg
{
  ...
  boolean is_rule_installed_wlan;
} nm_mdmprxy_cfg_t;
...
#define NM_MDMPRXY_GET_ROUTING_RULES_INSTALLED_FOR_WLAN(link)                   \
 nm_mdmprxy_global_link_status[link].is_rule_installed_wlan

#define NM_MDMPRXY_SET_ROUTING_RULES_INSTALLED_FOR_WLAN(link, status)     \
 (nm_mdmprxy_global_link_status[link].is_rule_installed_wlan = status)
