...
static void nm_mdmprxy_legacy_mark_prov_change_socket_state_dummy(int);
...
nm_mdmprxy_mark_prov_t nm_mdmprxy_legacy_mark_provider =
{
  ...
  .change_socket_state   = nm_mdmprxy_legacy_mark_prov_change_socket_state_dummy
};
...
/*===========================================================================
  FUNCTION nm_mdmprxy_legacy_mark_prov_change_socket_state_dummy
===========================================================================*/
/*!
@brief
...
*/
/*=========================================================================*/
static void nm_mdmprxy_legacy_mark_prov_change_socket_state_dummy(int socket_state)
{
  NM_MDMPRXY_VAR_UNUSED(socket_state);
}
