...
#endif
  else if (DS_TARGET_SOC_ID_LAGOON == ds_get_soc_id())
  {
    /* Changing the ul ag time only for bitra target */
    netmgr_main_cfg.data_format.ul_agg_time = 1000000;
    netmgr_main_cfg.data_format.ul_agg_features = 1;
  }
}
