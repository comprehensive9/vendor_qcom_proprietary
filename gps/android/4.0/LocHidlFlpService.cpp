...
#define EDGNSS_IS_SUPPORTED                       (1U<<8)
...
Return<bool> LocHidlFlpService::init_4_0(const sp<ILocHidlFlpServiceCallbackV4_0>& callback) {
    static uint64_t deathCount = 0;
    FROM_HIDL_CLIENT();
