...
Return<::android::sp<ILocHidlGnssConfigService>> LocHidlGnss::getExtensionLocHidlGnssConfigService_4_0() {
    FROM_HIDL_CLIENT();
    if (mGnssConfigService_4_0 == nullptr) {
        mGnssConfigService_4_0 = new LocHidlGnssConfigService();
    }
    return mGnssConfigService_4_0;
}

Return<::android::sp<ILocHidlFlpService>> LocHidlGnss::getExtensionLocHidlFlpService_4_0() {
    FROM_HIDL_CLIENT();
    if (mFlpService_4_0 == nullptr) {
        mFlpService_4_0 = new LocHidlFlpService();
    }
    return mFlpService_4_0;
}
