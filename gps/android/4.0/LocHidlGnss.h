 ...
 */
#ifndef VENDOR_QTI_GNSS_V4_0_LOCHIDLGNSS_H
#define VENDOR_QTI_GNSS_V4_0_LOCHIDLGNSS_H
...
struct LocHidlGnss : public ILocHidlGnss {
    ...
    // Methods from ::vendor::qti::gnss::V4_0::ILocHidlGnss follow.
    Return<::android::sp<ILocHidlGnssConfigService>> getExtensionLocHidlGnssConfigService_4_0() override;
    Return<::android::sp<ILocHidlFlpService>> getExtensionLocHidlFlpService_4_0() override;
...
private:
    ...
    sp<V4_0::ILocHidlGnssConfigService> mGnssConfigService_4_0 = nullptr;
    sp<V4_0::ILocHidlFlpService> mFlpService_4_0 = nullptr;
};
...
#endif  // VENDOR_QTI_GNSS_V4_0_LOCHIDLGNSS_H
