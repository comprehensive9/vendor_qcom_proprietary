 ...
 */
#ifndef VENDOR_QTI_GNSS_V4_0_LOCHIDLFLPSERVICE_H
#define VENDOR_QTI_GNSS_V4_0_LOCHIDLFLPSERVICE_H
...
#include <vendor/qti/gnss/4.0/ILocHidlFlpService.h>
...
struct LocHidlFlpService : public ILocHidlFlpService {
    ...
    Return<bool> init_4_0(const sp<ILocHidlFlpServiceCallbackV4_0>& callback) override;
...
#endif  // VENDOR_QTI_GNSS_V4_0_LOCHIDLFLPSERVICE_H
