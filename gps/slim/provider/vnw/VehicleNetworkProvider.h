  ...
  public MultiplexingProvider
{
  ...
  friend class VehicleNetworkDefaultSteeringWheelMP;
  ...
  friend class VehicleNetworkCONF1SteeringWheelMP;
  ...
  /*! Instance of steering wheel service configuration */
  VehicleNetworkMessageProcessor* m_pzSteeringWheelProc;
