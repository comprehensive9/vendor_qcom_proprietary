...
const slim_ServiceProviderInterfaceStructType ProviderBase::c_zVtblC =
{
  ...
  0 /* No support for tilt service data*/,
 ...
 * -------------------------------------------------------------------------*/
static unordered_map<slim_ServiceProviderInterfaceType*, ProviderBase*> sInstanceMap;
/*----------------------------------------------------------------------------
...
{
  if (0 == pzProvider && sInstanceMap.find(pzProvider) != sInstanceMap.end())
  {
    return nullptr;
  }
  return sInstanceMap[pzProvider];
}
