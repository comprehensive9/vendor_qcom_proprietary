...
class SLIM_CLIENT_LOCAL ClientPrivate
{
  ...
  ClientPrivate(Client *pzClient = nullptr);
};
...
{
   size_t offset = 0;
   SLIM_QS_P2M_OFFSET(ClientPrivate, m_pzCallbackVt, offset);
   return reinterpret_cast<ClientPrivate*>(slim_QSMember2Container((void*)p_Iface, offset));
}
