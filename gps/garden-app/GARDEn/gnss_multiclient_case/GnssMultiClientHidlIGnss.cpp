...
using BlacklistedSourceV2_1 = android::hardware::gnss::V2_1::IGnssConfiguration::
    BlacklistedSource;
...
GARDEN_RESULT GnssMultiClientHidlIGnss::menuTest()
{
    ...
    while(!exit_loop) {
        PRINTLN("\n\n"
                "1: Create HIDL client for IGnss 2.1 \n"
                ...
                "2011: IAGnss2.0 -> setCallback_2_0 \n"
                "2012: IAGnss2.0 -> dataConnOpen_2_0 \n"
                "2013: IAGnss2.0 -> setServer_2_0 \n"
                "2014: IAGnss2.0 -> dataConnClosed_2_0 \n"
                "2101: IGnss 2.1 -> Open Measurement Corrections Interface \n"
                "2102: IGnss 2.1 -> start with measurement corrections \n"
                "2103: IGnss 2.1 -> Open Antenna Info Interface \n"
                "2104: IGnss 2.1 -> Close Antenna Info Interface \n"
                "2105: IGnss 2.1 -> setCallback_2_1 \n"
                "2106: IGnssMeasurement 2.1 -> setCallback_2_1 \n"
                "2107: IGnssMeasurement 2.1 -> close \n"
                "2108: IGnssConfiguration 2.1 -> setBlacklist_2_1 \n"
        ...
        case 2014:
            ...
            break;
        case 2101:
            gardenResult = IGnss_2_1_setMeasurementCorrectionsCallback();
            break;
        case 2102:
            ...
            break;
        case 2103:
            gardenResult = IGnss_2_1_setAntennaInfoCallback();
            break;
        case 2104:
            gardenResult = IGnss_2_1_setAntennaInfoClose();
            break;
        case 2105:
            gardenResult = IGnss_setCallback_2_1();
            break;
        case 2106:
            gardenResult = GnssMeasurement_2_1_setCallback_2_1();
            break;
        case 2107:
            gardenResult = IGnssMeasurement_2_1_close();
            break;
        case 2108:
            gardenResult = IGnssConfiguration_2_1_setBlacklist_2_1();
            break;
        case 99:
            continue;
        case 0:
            ...
            if (gnssConfig.isOk()) {
                ...
                if (gnssMeasurement.isOk()) {
                    ...
                    if (gnssConfig_2_0.isOk()) {
                        ...
                        // Get 2.1 Extensions
                        auto gnssConfig_2_1 = mGnssIface->getExtensionGnssConfiguration_2_1();
                        if (gnssConfig_2_1.isOk()) {
                            mGnssConfig_2_1 = gnssConfig_2_1;

                            auto measurementCorrections_1_1 =
                                    mGnssIface->getExtensionMeasurementCorrections_1_1();
                            if (measurementCorrections_1_1.isOk()) {
                                PRINTLN("getExtensionMeasurementCorrections_1_1() success.");
                                mMeasurementCorrections_1_1 = measurementCorrections_1_1;

                                gardenResult = GARDEN_RESULT_PASSED;
                            } else {
                                PRINTERROR("getExtensionMeasurementCorrections_1_1() failed.");
                            }

                            auto antennaInfo =
                                    mGnssIface->getExtensionGnssAntennaInfo();
                            if (antennaInfo.isOk()) {
                                PRINTLN("getExtensionGnssAntennaInfo() success.");
                                mGnssAntennaInfo = antennaInfo;

                                mGnssAntennaInfo->close();

                                gardenResult = GARDEN_RESULT_PASSED;
                            } else {
                                PRINTERROR("getExtensionGnssAntennaInfo() failed.");
                            }

                            auto gnssMeasurement21 = mGnssIface->getExtensionGnssMeasurement_2_1();
                            if (gnssMeasurement21.isOk()) {
                                PRINTLN("mGnssIface->getExtensionGnssMeasurement_2_1() success.");
                                mGnssMeasurementIface_2_1 = gnssMeasurement21;
                            } else {
                                PRINTERROR("mGnssIface->getExtensionGnssMeasurement_2_1() failed.");
                            }

                        } else {
                            PRINTERROR("mGnssIface->getExtensionGnssConfiguration_2_1() failed.");
                        }
                    } else {
...
GARDEN_RESULT GnssMultiClientHidlIGnss::IGnssConfiguration_2_1_setBlacklist_2_1()
{
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;

    if (mGnssIface != nullptr) {
        if (mGnssConfig_2_1 != nullptr) {

            std::vector<BlacklistedSourceV2_1> tempVector;
            ...
            hidl_vec<BlacklistedSourceV2_1> blacklist(tempVector);
            PRINTLN("blacklist vector size %d", (int)blacklist.size());

            auto result = mGnssConfig_2_1->setBlacklist_2_1(blacklist);

            if (result.isOk() && result) {

                PRINTLN("mGnssConfig_2_1->setBlacklist_2_1 success.");
                gardenResult = GARDEN_RESULT_PASSED;

            } else {
                PRINTERROR("mGnssConfig_2_1->setBlacklist_2_1 failed.");
            }
        } else {
            PRINTERROR("mGnssConfig_2_1 null");
        }
    } else {
        PRINTERROR("HIDL client not created.");
    }
...
GARDEN_RESULT GnssMultiClientHidlIGnss::GnssMeasurementCorrections_setCorrections_1_1(const GnssLocation& location)
{
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;
    ::android::hardware::gnss::measurement_corrections::V1_1
            ::MeasurementCorrections measCorrections = { 0 };

    measCorrections.v1_0.latitudeDegrees = location.v1_0.latitudeDegrees;
    measCorrections.v1_0.longitudeDegrees = location.v1_0.longitudeDegrees;
    measCorrections.v1_0.altitudeMeters = location.v1_0.altitudeMeters;
    measCorrections.v1_0.horizontalPositionUncertaintyMeters =
            location.v1_0.horizontalAccuracyMeters;
    measCorrections.v1_0.verticalPositionUncertaintyMeters = location.v1_0.verticalAccuracyMeters;

    measCorrections.v1_0.toaGpsNanosecondsOfWeek =
            ((location.v1_0.timestamp/1000 - 315964800) % 604800)  * 1000000000;
    PRINTLN("measCorrections.v1_0.toaGpsNanosecondsOfWeek = %" PRIu64,
            measCorrections.v1_0.toaGpsNanosecondsOfWeek);

    measCorrections.v1_0.satCorrections.resize(40);
    for (int i = 0; i < 40; i++) {
        ::android::hardware::gnss::measurement_corrections::
                V1_0::SingleSatCorrection singleSatCorr = { 0 };

        singleSatCorr.singleSatCorrectionFlags =
            ::android::hardware::gnss::measurement_corrections::
                    V1_0::GnssSingleSatCorrectionFlags::HAS_SAT_IS_LOS_PROBABILITY |
            ::android::hardware::gnss::measurement_corrections::
                    V1_0::GnssSingleSatCorrectionFlags::HAS_EXCESS_PATH_LENGTH |
            ::android::hardware::gnss::measurement_corrections::
                    V1_0::GnssSingleSatCorrectionFlags::HAS_EXCESS_PATH_LENGTH_UNC |
            ::android::hardware::gnss::measurement_corrections::
                    V1_0::GnssSingleSatCorrectionFlags::HAS_REFLECTING_PLANE;
        singleSatCorr.constellation =
                (::android::hardware::gnss::V1_0::GnssConstellationType)GnssConstellationType::GPS;
        singleSatCorr.svid = i;
        singleSatCorr.carrierFrequencyHz = 1500 + i;
        singleSatCorr.probSatIsLos = 100 + i;
        singleSatCorr.excessPathLengthMeters = 200 + i;
        singleSatCorr.excessPathLengthUncertaintyMeters = 300 + i;
        singleSatCorr.reflectingPlane.latitudeDegrees = 400 + i;
        singleSatCorr.reflectingPlane.longitudeDegrees = 500 + i;
        singleSatCorr.reflectingPlane.altitudeMeters = 600 + i;
        singleSatCorr.reflectingPlane.azimuthDegrees = 700 + i;
        measCorrections.v1_0.satCorrections[i] = singleSatCorr;
    }
    measCorrections.hasEnvironmentBearing = true;
    measCorrections.environmentBearingDegrees = 11;
    measCorrections.environmentBearingUncertaintyDegrees = 22;

    if (mGnssIface != nullptr) {
        if (mGnssConfig_2_1 != nullptr) {

            auto result = mMeasurementCorrections_1_1->setCorrections_1_1(measCorrections);

            if (result.isOk() &&
                true == result) {

                PRINTLN("mMeasurementCorrections_1_1->setCorrections_1_1 success.");
                gardenResult = GARDEN_RESULT_PASSED;

            } else {
                PRINTERROR("mMeasurementCorrections_1_1->setCorrections_1_1 failed.");
            }
        } else {
            PRINTERROR("mGnssConfig_2_1 null");
        }
...
GARDEN_RESULT GnssMultiClientHidlIGnss::IGnss_2_1_setAntennaInfoCallback()
{
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;
    ...
    if (mGnssIface != nullptr) {
        if (mGnssConfig_2_1 != nullptr) {
            ...
            auto result = mGnssAntennaInfo->setCallback(mHidlIGnssCb);

            if (result.isOk() &&
                IGnssAntennaInfo::GnssAntennaInfoStatus::SUCCESS == result) {
...
GARDEN_RESULT GnssMultiClientHidlIGnss::IGnss_2_1_setMeasurementCorrectionsCallback()
{
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;
    ...
    if (mGnssIface != nullptr) {
        if (mGnssConfig_2_1 != nullptr) {
            ...
            auto result = mMeasurementCorrections_1_1->setCallback(mHidlIGnssCb);

            if (result.isOk() &&
                true == result) {

                PRINTLN("mMeasurementCorrections_1_1->setCallback success.");
                gardenResult = GARDEN_RESULT_PASSED;

            } else {
                PRINTERROR("mMeasurementCorrections_1_1->setCallback failed.");
            }
        } else {
            PRINTERROR("mGnssConfig_2_1 null");
        }
...
GARDEN_RESULT GnssMultiClientHidlIGnss::IGnss_2_1_setAntennaInfoClose()
{
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;
...
GARDEN_RESULT GnssMultiClientHidlIGnss::GnssMeasurement_2_1_setCallback_2_1() {
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;

    if (mGnssIface != nullptr) {
        if (mGnssMeasurementIface_2_1 != nullptr) {

            bool enableFullTracking = getUserInputYesNo("Enable Full Tracking (y/n): ");
            auto result = mGnssMeasurementIface_2_1->setCallback_2_1(mHidlIGnssCb,
                    enableFullTracking);

            if (result.isOk() &&
                IGnssMeasurement_V1_0::GnssMeasurementStatus::SUCCESS == result) {

                PRINTLN("mGnssMeasurementIface_2_1->setCallback_2_1 success.");
                gardenResult = GARDEN_RESULT_PASSED;

            } else {
                PRINTERROR("mGnssMeasurementIface_2_1->setCallback_2_1 failed.");
            }
        } else {
            PRINTERROR("mGnssMeasurementIface_2_1 null");
        }
    } else {
        PRINTERROR("HIDL client not created.");
    }
...
GARDEN_RESULT GnssMultiClientHidlIGnss::IGnss_setCallback_2_1()
{
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;

    if (mGnssIface != nullptr) {
        auto result = mGnssIface->setCallback_2_1(mHidlIGnssCb);
        if (!result.isOk()) {
            PRINTERROR("mGnssIface->setCallback_2_1 failed.");
        } else {
            PRINTLN("mGnssIface->setCallback_2_1 success.");
            gardenResult = GARDEN_RESULT_PASSED;
        }
    }
    else {
...
GARDEN_RESULT GnssMultiClientHidlIGnss::IGnssMeasurement_2_1_close()
{
    GARDEN_RESULT gardenResult = GARDEN_RESULT_FAILED;
    ...
    if (mGnssIface != nullptr) {
        if (mGnssMeasurementIface_2_1 != nullptr) {
            ...
            auto result = mGnssMeasurementIface_2_1->close();

            if (result.isOk()) {

                PRINTLN("mGnssMeasurementIface_2_1->close success.");
                gardenResult = GARDEN_RESULT_PASSED;

            } else {
                PRINTERROR("mGnssMeasurementIface_2_1->close failed.");
            }
        } else {
            PRINTERROR("mGnssMeasurementIface_2_1 null");
        }
