...
public:
    ...
    /**
     * @brief Propagate opt-in status
     * @details Propagate opt-in status
     *
     * @param status Opt-in accepted status
     * @return Zero for sucess and non zero for failure
     */
    virtual uint32_t propagateOptInStatus(bool userPref, responseCallback* callback = nullptr) = 0;
