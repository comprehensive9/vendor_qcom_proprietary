...
#define LOG_CLIENT_LOCATION_DIAG_MSG_VERSION        (6)
#define LOG_CLIENT_SV_REPORT_DIAG_MSG_VERSION       (3)
#define LOG_CLIENT_NMEA_REPORT_DIAG_MSG_VERSION     (2)
#define LOG_CLIENT_MEASUREMENTS_DIAG_MSG_VERSION    (2)
...
typedef enum {
    ...
    CLIENT_DIAG_GNSS_MEASUREMENTS_DATA_FULL_ISB_BIT = (1 << 18),
    CLIENT_DIAG_GNSS_MEASUREMENTS_DATA_FULL_ISB_UNCERTAINTY_BIT = (1 << 19),
    CLIENT_DIAG_GNSS_MEASUREMENTS_DATA_CYCLE_SLIP_COUNT_BIT = (1 << 20),
...
protected:
    ...
    void populateClientDiagLocation(clientDiagGnssLocationStructType* diagGnssLocPtr,
            const GnssLocation& gnssLocation, const LocationCapabilitiesMask& capMask);
...
public:
    GnssLocationReport(const GnssLocation& gnssLocation,
            const LocationCapabilitiesMask& capsMask): mGnssLocation(gnssLocation),
            mCapMask(capsMask),
            LocLoggerBase(),
            LocationClientApiDiag() {}
    const GnssLocation& mGnssLocation;
    const LocationCapabilitiesMask& mCapMask;
