...
public:
    ...
    /* enable/disable synchronous request enable param can accept true/false */
    void enable_sync_request(bool enable) { _is_sync_request_enabled = enable; }

    /* enable/disable sample_period support for on-change sensors */
    void enable_on_change_sp(bool enable) { _is_on_change_sp_enabled = enable; }
    ...
    void register_event_callback(sensor_event_cb_func cb) { _event_cb = cb; }
...
protected:
    ...
    bool _is_sync_request_enabled;

    /* this flag is to support sample_period support for on_change sensors */
    bool _is_on_change_sp_enabled;
private:
