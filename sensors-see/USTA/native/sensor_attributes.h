...
char const sns_std_sensor_attrid_drc_max_sampling_rate[]    ="SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_SAMPLE_RATE";

// OPTIONAL
// float
// direct channel supported max report rate in Hz
char const sns_std_sensor_attrid_drc_max_report_rate[]    ="SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_REPORT_RATE";
...
public :
  ...
  /*
   * Returns max supported sample rate in DRC path.
   *
   *  It is mapped to SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_SAMPLE_RATE
   *
   **/
  float get_drc_max_sample_rate();

  /*
   * Returns max supported report rate in DRC path..
   *
   *  It is mapped to SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_REPORT_RATE
   *
   **/
  float get_drc_max_report_rate();
