...
usta_rc sensor_attribute::store(string& payload)
{
      ...
      attributeIndex++)
  {
    ...
    if(fd1 == NULL)
    {
      ERROR_LOG(log_instance, "fd1 is NULL - attr_id");
      continue;
    }
    int32  attrib_id =
    ...
    if(fd1 == NULL)
    {
      ERROR_LOG(log_instance, "fd1 is NULL - value");
      continue;
    }
...
float sensor_attribute::get_drc_max_sample_rate()
{
  ...
  if(ed == NULL)
  {
    ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate FindEnumTypeByName is failed");
    return max_sample_rate;
  }

  const EnumValueDescriptor *evd =ed->FindValueByName(sns_std_sensor_attrid_drc_max_sampling_rate);
  if(evd == NULL)
  {
    ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate FindValueByName is failed");
    return max_sample_rate;
  }
      ...
      attributeIndex++)
  {
        ...
        attribute_list.attributes[attributeIndex].attribute_id)
    {
      ...
      if(value_message_descriptor == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate value_message_descriptor is NULL");
        return max_sample_rate;
      }
      ...
      if(prototype == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate prototype is NULL");
        return max_sample_rate;
      }
      ...
      if(msg == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate msg is NULL");
        return max_sample_rate;
      }
      ...
      if(reflection == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate reflection is NULL");
        return max_sample_rate;
      }
      ...
      if(message_descriptor == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate message_descriptor is NULL");
        return max_sample_rate;
      }
      ...
      if(fd == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate fd is NULL");
        return max_sample_rate;
      }
      ...
      if(data_value_message == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_sample_rate data_value_message is NULL");
        return max_sample_rate;
      }
      ...
      // since there is only one field
      float received_max_sr = data_value_message->GetReflection()->
          GetFloat(*data_value_message, fields[0]);

      max_sample_rate = received_max_sr ;
...
float sensor_attribute::get_drc_max_report_rate()
{
  float max_report_rate = 0.0f;

  const EnumDescriptor* ed=
      pool.FindEnumTypeByName("sns_std_sensor_attr_id");
  if(ed == NULL)
  {
    ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate FindEnumTypeByName is failed");
    return max_report_rate;
  }

  const EnumValueDescriptor *evd =ed->FindValueByName(sns_std_sensor_attrid_drc_max_report_rate);
  if(evd == NULL)
  {
    ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate FindValueByName is failed");
    return max_report_rate;
  }
      ...
      attributeIndex++)
  {
        ...
        attribute_list.attributes[attributeIndex].attribute_id)
    {
      ...
      if(value_message_descriptor == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate value_message_descriptor is NULL");
        return max_report_rate;
      }
      ...
      if(prototype == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate prototype is NULL");
        return max_report_rate;
      }
      ...
      if(msg == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate msg is NULL");
        return max_report_rate;
      }
      ...
      if(reflection == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate reflection is NULL");
        return max_report_rate;
      }
      ...
      if(message_descriptor == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate message_descriptor is NULL");
        return max_report_rate;
      }
      ...
      if(fd == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate fd is NULL");
        return max_report_rate;
      }
      ...
      if(data_value_message == NULL)
      {
        ERROR_LOG(log_instance, "sensor_attribute::get_drc_max_report_rate data_value_message is NULL");
        return max_report_rate;
      }
      ...
      // since there is only one field
      float received_max_report_rate = data_value_message->GetReflection()->
          GetFloat(*data_value_message, fields[0]);

      max_report_rate = received_max_report_rate ;
