...
public:
  ...
  void get_payload_string(send_req_msg_info sensor_payload_field, string &encoded_data);

  bool is_direct_channel_supported_sensor();
#endif
  void get_direct_channel_attributes_info(direct_channel_attributes_info &attributes_info);
private:
  /*
