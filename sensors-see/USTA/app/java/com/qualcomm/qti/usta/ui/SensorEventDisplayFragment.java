...
public class SensorEventDisplayFragment extends Fragment implements Runnable {
  ...
  public static boolean isThreadDestroyed = false;
  public static boolean isFirstTimeThreadCreation = true;
  ...
  private static SensorEventDisplayFragment SensorEventDisplayFragmentInstance;
  ...
  public static void startThread() {
    ...
    samplesThread.start();
    isFirstTimeThreadCreation = false;
    isThreadDestroyed = false;
  }

  public static void destroyThread() {
    isThreadRunning = false;
    while(true) {
      if(isThreadDestroyed == true) {
        break;
      } else {
        SensorContextJNI.disableStreamingStatusNativeWrapper(SensorRequestFragment.previousSpinnerPosition);
        try {
          Thread.sleep(10);
  ...
  public static SensorEventDisplayFragment CreateDisplaySamplesInstance() {
    SensorEventDisplayFragmentInstance = new SensorEventDisplayFragment();
