...
public class OnDeviceLoggingTab extends Fragment {
  ...
  private Button enableHLOSPacketsButton;
  private TextView odlStatus;
  private TextView timerStatus;
  private View odlTabView;
  private final String mnt_per_file = "/data/vendor/sensors/file1";
  private boolean isHLOSPacketsEnabled = true;
    ...
    startButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        try {
          ...
          if(isHLOSPacketsEnabled){
            dataOutStream.writeBytes("enable_HLOS_packets\n");
          }else{
            dataOutStream.writeBytes("disabl_HLOS_packets\n");
          }
          dataOutStream.close();
          startButton.setEnabled(false);
          enableHLOSPacketsButton.setEnabled(false);
        ...
        try {
          ...
          new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
              ...
              odlStatus.setText("");
              startButton.setEnabled(true);
              enableHLOSPacketsButton.setEnabled(true);
            }
          }.start();
        } catch (IOException ioe) {
          ioe.printStackTrace();
  ...
  private void setUpEnableHLOSPacketsButton(){
    enableHLOSPacketsButton = (Button) odlTabView.findViewById(R.id.hlos_packets);
    enableHLOSPacketsButton.setEnabled(true);
    enableHLOSPacketsButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
      String HLOS_packets = enableHLOSPacketsButton.getText().toString();
      if(HLOS_packets.equalsIgnoreCase("Disable_HLOS_Packets")){
          isHLOSPacketsEnabled = false;
          enableHLOSPacketsButton.setText("Enable_HLOS_packets");
      }else if(HLOS_packets.equalsIgnoreCase("Enable_HLOS_packets")){
          isHLOSPacketsEnabled = true;
          enableHLOSPacketsButton.setText("Disable_HLOS_Packets");
      }
    }
    });
  }
