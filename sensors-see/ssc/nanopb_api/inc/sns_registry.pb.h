...
/* Generated by nanopb-0.3.6 at Tue Apr 14 12:34:14 2020. */
...
#define _sns_registry_msgid_MAX SNS_REGISTRY_MSGID_SNS_REGISTRY_WRITE_EVENT
#define _sns_registry_msgid_ARRAYSIZE ((sns_registry_msgid)(SNS_REGISTRY_MSGID_SNS_REGISTRY_WRITE_EVENT+1))
...
#define sns_registry_msgid_SNS_REGISTRY_MSGID_SNS_REGISTRY_WRITE_EVENT SNS_REGISTRY_MSGID_SNS_REGISTRY_WRITE_EVENT

typedef enum _sns_registry_write_status {
    SNS_REGISTRY_WRITE_STATUS_SUCCESS = 0,
    SNS_REGISTRY_WRITE_STATUS_ERROR_OTHER = 1
} sns_registry_write_status;
#define _sns_registry_write_status_MIN SNS_REGISTRY_WRITE_STATUS_SUCCESS
#define _sns_registry_write_status_MAX SNS_REGISTRY_WRITE_STATUS_ERROR_OTHER
#define _sns_registry_write_status_ARRAYSIZE ((sns_registry_write_status)(SNS_REGISTRY_WRITE_STATUS_ERROR_OTHER+1))
#define sns_registry_write_status_SNS_REGISTRY_WRITE_STATUS_SUCCESS SNS_REGISTRY_WRITE_STATUS_SUCCESS
#define sns_registry_write_status_SNS_REGISTRY_WRITE_STATUS_ERROR_OTHER SNS_REGISTRY_WRITE_STATUS_ERROR_OTHER
...
typedef struct _sns_registry_write_event {
    sns_registry_write_status status;
/* @@protoc_insertion_point(struct:sns_registry_write_event) */
} sns_registry_write_event;
...
#define sns_registry_write_event_init_default    {(sns_registry_write_status)0}
...
#define sns_registry_write_event_init_zero       {(sns_registry_write_status)0}
...
#define sns_registry_write_event_status_tag      1
...
extern const pb_field_t sns_registry_write_event_fields[2];
...
#define sns_registry_write_event_size            2
