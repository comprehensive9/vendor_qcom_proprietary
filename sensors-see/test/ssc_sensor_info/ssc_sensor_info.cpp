...
sensor_attributes() {
    ...
    _attr_id_to_name[SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_SAMPLE_RATE] = "DIRECT_CHANNEL_MAX_SAMPLE_RATE";
    _attr_id_to_name[SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_REPORT_RATE] = "DIRECT_CHANNEL_MAX_REPORT_RATE";
    ...
    _display_order.push_back( SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_SAMPLE_RATE);
    _display_order.push_back( SNS_STD_SENSOR_ATTRID_DIRECT_CHANNEL_MAX_REPORT_RATE);
}
...
int main(int argc, char* argv[])
{
    ...
    string version = "ssc_sensor_info v1.8";
    cout << version << endl;
