...
Copyright (c) 1991-2022 Qualcomm Technologies, Inc.
All Rights Reserved.
...
#define LOG_DATA_PROTOCOL_LOGGING_PDPL_CONFIG_C               ((0xD33) + LOG_1X_BASE_C)
#define LOG_MS_TIMEINFO_C                                     ((0xD35) + LOG_1X_BASE_C)
#define LOG_PS_LOG_PKT_CMAPI_TYPE                             ((0xD36) + LOG_1X_BASE_C)
#define LOG_SEC_TLS_KEY_SECRETS_INFO_C                        ((0xD37)+  LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_PLIMITS_INFO_C                     ((0xD38) + LOG_1X_BASE_C)
#define LOG_COMMON_PERF_HEAP_USAGE_TYPE_C                     ((0xD39) + LOG_1X_BASE_C)
#define LOG_SEC_TLS_CERT_INFO_C                               ((0xD3C) + LOG_1X_BASE_C)
#define LOG_IPA_DATAPATH_MEM_TRACKER_C                        ((0xD3D) + LOG_1X_BASE_C)
...
#define LOG_ETH_IFACE_INFO_LOG_C                              ((0xD44) + LOG_1X_BASE_C)
#define LOG_ETH_IFACE_LINK_PARAM_C                            ((0xD45) + LOG_1X_BASE_C)
#define LOG_ETH_IFACE_DEBUG_STATS_C                           ((0xD46) + LOG_1X_BASE_C)
#define LOG_IPA_DPED_C                                        ((0xD47) + LOG_1X_BASE_C)
...
#define LOG_PM_QBG_CONTEXT_DUMP_C                             ((0xD54) + LOG_1X_BASE_C)
#define LOG_DATALNX_LD_STATS_C                                ((0xD55) + LOG_1X_BASE_C)
#define LOG_IMS_KPI_ANALYSIS_C                                ((0xD56) + LOG_1X_BASE_C)
#define LOG_IPA_PER_STAT_C                                    ((0xD57) + LOG_1X_BASE_C)
#define LOG_IMS_IMM_PDN_CONFIG_INFO_C                         ((0xD58) + LOG_1X_BASE_C)
#define LOG_IMS_IMM_RAT_EVALUATION_C                          ((0XD59) + LOG_1X_BASE_C)
#define LOG_IMS_IMM_PDN_RAT_C                                 ((0xD5B) + LOG_1X_BASE_C)
#define LOG_IMS_IMM_DPL_HO_ENGINE_C                           ((0xD5C) + LOG_1X_BASE_C)
#define LOG_IMS_IMM_PDN_CALL_C                                ((0XD5D) + LOG_1X_BASE_C)
#define LOG_GNSS_TUNNEL_STATUS_C                              ((0xD5E) + LOG_1X_BASE_C)
#define LOG_IMS_IMM_PDN_ACTION_C                              ((0xD5F) + LOG_1X_BASE_C)
#define LOG_LTE_RF_TUNE_C                                     ((0xD62) + LOG_1X_BASE_C)
#define LOG_QSH_EVENT_LF_C                                    ((0xD64) + LOG_1X_BASE_C)
#define LOG_QSH_EVENT_HF_C                                    ((0xD65) + LOG_1X_BASE_C)
#define LOG_MM_RAT_CHANGE_C                                   ((0xD66) + LOG_1X_BASE_C)
#define LOG_GPR_ADSP_APPS_C                                   ((0xD67) + LOG_1X_BASE_C)
#define LOG_GPR_ADSP_USERPD_APPS_C                            ((0xD68) + LOG_1X_BASE_C)
#define LOG_QLINK_EVENTS_C                                    ((0xD6B) + LOG_1X_BASE_C)
#define LOG_GPR_ADSP_MODEM_C                                  ((0xD6D) + LOG_1X_BASE_C)
#define LOG_GPR_ADSP_USERPD_MODEM_C                           ((0xD6E) + LOG_1X_BASE_C)
#define LOG_GPR_MODEM_C                                       ((0xD6F) + LOG_1X_BASE_C)
#define LOG_GPR_MODEM_USERPD_C                                ((0xD70) + LOG_1X_BASE_C)
#define LOG_GPR_SLPI_C                                        ((0xD71) + LOG_1X_BASE_C)
#define LOG_GPR_SLPI_USERPD_C                                 ((0xD72) + LOG_1X_BASE_C)
#define LOG_GPR_CDSP_C                                        ((0xD73) + LOG_1X_BASE_C)
#define LOG_GPR_CDSP_USERPD_C                                 ((0xD74) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_CLIENT_API_RESPONSE_C                ((0xD75) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_CLIENT_API_EVENT_C                   ((0xD76) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_CLIENT_API_REQUEST_C                 ((0xD77) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_SENSOR_API_REQUEST_C                 ((0xD78) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_SENSOR_API_EVENT_C                   ((0xD79) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_SENSOR_API_STATE_EXT_C               ((0xD7A) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_SENSOR_API_STATE_INT_C               ((0xD7E) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_HW_INTERRUPT_C                       ((0xD7F) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_INSTANCE_MAP_C                       ((0xD80) + LOG_1X_BASE_C)
#define LOG_WEAR_AON_SNS_MEMORY_UTILIZATION_C                 ((0xD81) + LOG_1X_BASE_C)
#define LOG_ROHC_ALLOC_C                                      ((0xD83) + LOG_1X_BASE_C)
#define LOG_ROHC_IOCTL_C                                      ((0xD84) + LOG_1X_BASE_C)
#define LOG_ROHC_FREE_C                                       ((0xD85) + LOG_1X_BASE_C)
#define LOG_QLINK_QSLEEP_LANE_CONTROL_C                       ((0xD86) + LOG_1X_BASE_C)
#define LOG_DS_TRM_MGR_INFO_C                                 ((0xD8A) + LOG_1X_BASE_C)
#define LOG_IPA_LOW_LAT_STATS_C                               ((0xD8D) + LOG_1X_BASE_C)
#define LOG_RF_LTE_TIMELINE_C                                 ((0xD8E) + LOG_1X_BASE_C)
#define LOG_CNE_WIFI_STATS_C                                  ((0xD8F) + LOG_1X_BASE_C)
#define LOG_CAFI_PERIPHERAL_INFO_C                            ((0xD92) + LOG_1X_BASE_C)
...
#define LOG_DS_DDS_SWITCH_RECOMM_LOG_INFO_C                   ((0xDAC) + LOG_1X_BASE_C)
#define LOG_MCS_BPE_C                                         ((0xDAE) + LOG_1X_BASE_C)
#define LOG_DS_ATP_LOG_APP_TRAFFIC_C                          ((0xDAF) + LOG_1X_BASE_C)
#define LOG_PRODUCER_DATA_PROTOCOL_LOGGING_C                  ((0xDB2) + LOG_1X_BASE_C)
/* The last defined DMSS log code */
#define LOG_1X_LAST_C                                        ((0xDB2) + LOG_1X_BASE_C)
