...
Copyright (c) 2007-2015, 2017-2020, 2022 Qualcomm Technologies, Inc.
All Rights Reserved.
...
#define DIAG_IOCTL_QUERY_REG_TABLE	75
#define DIAG_IOCTL_QUERY_DEBUG_ALL	76
#define DIAG_IOCTL_UPDATE_DYN_DBG_MASK	77
