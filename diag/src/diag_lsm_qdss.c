...
static int check_for_qdss_cmd_for_peripheral(uint16 cmd_code);
...
static int diag_set_diag_transport(int peripheral_type, int peripheral, uint8 stm_cmd)
{
	...
	*(int*)ptr = USER_SPACE_RAW_DATA_TYPE;
	...
	case DIAG_SENSORS_PROC :
		req->processor_mask = DIAG_STM_SENSORS;
		break;
	case DIAG_CDSP_PROC :
...
static int check_for_qdss_cmd(uint8* src_ptr)
{
		 ...
		 *(src_ptr + 1) == DIAG_SUBSYS_CMD_F && *(src_ptr + 2) == DIAG_SUBSYS_QDSS)))
	{
		...
		case DIAG_HW_ACCEL_CMD:
			break;
		default:
			return check_for_qdss_cmd_for_peripheral(cmd_code);
		}
		return TRUE;
	}
	else
...
static int check_for_qdss_cmd_for_peripheral(uint16 cmd_code){
	...
	switch(cmd_code){
	case DIAG_QDSS_PROCESSOR_MODEM | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_MODEM | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_WCNSS | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_WCNSS | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_LPASS | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_LPASS | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_SENSOR | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_SENSOR | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_CDSP | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_CDSP | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_NPU | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_NPU | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_GPDSP0 | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_GPDSP0 | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_GPDSP1 | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_GPDSP1 | DIAG_QDSS_FILTER_ENTITY:
		break;
	case DIAG_QDSS_PROCESSOR_NSP1 | DIAG_QDSS_FILTER_SWTRACE:
		break;
	case DIAG_QDSS_PROCESSOR_NSP1 | DIAG_QDSS_FILTER_ENTITY:
		break;
	default:
		return FALSE;
	}
