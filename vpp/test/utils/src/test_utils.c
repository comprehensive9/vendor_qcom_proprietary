 ...
 ***********************************************************************/
#define ERR_TS (-1)
uint32_t ts_mgr_init(struct ts_mgr *pTsMgr, uint32_t u32Freq, uint32_t u32Cnt)
{
    int rc;
    int32_t s32;
    ...
    pTsMgr->u32Freq = u32Freq;
    pTsMgr->u32OuttoInRatio = 1;
    pTsMgr->u64TsStep = 1000000 / pTsMgr->u32Freq;
