...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2010-2014, 2016 - 2017, 2019, 2021 Qualcomm Technologies, Inc.
  All rights reserved.
...
/* This file was generated with Tool version 6.14.7
   It was generated on: Thu Feb 11 2021 (Spin 0)
...
static const uint8_t pbm_emergency_list_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pbm_emergency_list_ind_msg_v01, elenl_emer_nums) - QMI_IDL_OFFSET16RELATIVE(pbm_emergency_list_ind_msg_v01, elenl_emer_nums_valid)),
  0x18,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pbm_emergency_list_ind_msg_v01, serving_mcc_emer_nums) - QMI_IDL_OFFSET16RELATIVE(pbm_emergency_list_ind_msg_v01, serving_mcc_emer_nums_valid)),
  0x19,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(pbm_emergency_list_ind_msg_v01, serving_mcc_emer_nums),
  QMI_PBM_MAX_NUM_SLOT_V01,
  QMI_IDL_OFFSET16RELATIVE(pbm_emergency_list_ind_msg_v01, serving_mcc_emer_nums) - QMI_IDL_OFFSET16RELATIVE(pbm_emergency_list_ind_msg_v01, serving_mcc_emer_nums_len),
  QMI_IDL_TYPE88(0, 41)
};
...
static const uint8_t pbm_get_emergency_list_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pbm_get_emergency_list_resp_msg_v01, elenl_emer_nums) - QMI_IDL_OFFSET16RELATIVE(pbm_get_emergency_list_resp_msg_v01, elenl_emer_nums_valid)),
  0x19,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pbm_get_emergency_list_resp_msg_v01, serving_mcc_emer_nums) - QMI_IDL_OFFSET16RELATIVE(pbm_get_emergency_list_resp_msg_v01, serving_mcc_emer_nums_valid)),
  0x1A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(pbm_get_emergency_list_resp_msg_v01, serving_mcc_emer_nums),
  QMI_PBM_MAX_NUM_SLOT_V01,
  QMI_IDL_OFFSET16RELATIVE(pbm_get_emergency_list_resp_msg_v01, serving_mcc_emer_nums) - QMI_IDL_OFFSET16RELATIVE(pbm_get_emergency_list_resp_msg_v01, serving_mcc_emer_nums_len),
  QMI_IDL_TYPE88(0, 41)
};
...
static const qmi_idl_service_message_table_entry pbm_service_command_messages_v01[] = {
  ...
  {QMI_PBM_READ_RECORDS_REQ_V01, QMI_IDL_TYPE16(0, 6), 10},
  {QMI_PBM_WRITE_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 9), 1224},
  {QMI_PBM_DELETE_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 11), 8},
  {QMI_PBM_DELETE_ALL_PB_RECORDS_REQ_V01, QMI_IDL_TYPE16(0, 13), 6},
  {QMI_PBM_SEARCH_RECORDS_REQ_V01, QMI_IDL_TYPE16(0, 15), 295},
  {QMI_PBM_GET_EMERGENCY_LIST_REQ_V01, QMI_IDL_TYPE16(0, 22), 0},
  {QMI_PBM_GET_ALL_GROUPS_REQ_V01, QMI_IDL_TYPE16(0, 24), 0},
  {QMI_PBM_SET_GROUP_INFO_REQ_V01, QMI_IDL_TYPE16(0, 26), 248},
  {QMI_PBM_GET_PB_STATE_REQ_V01, QMI_IDL_TYPE16(0, 28), 6},
  {QMI_PBM_READ_ALL_HIDDEN_RECORDS_REQ_V01, QMI_IDL_TYPE16(0, 30), 4},
  {QMI_PBM_GET_NEXT_EMPTY_RECORD_ID_REQ_V01, QMI_IDL_TYPE16(0, 33), 8},
  {QMI_PBM_GET_NEXT_NON_EMPTY_RECORD_ID_REQ_V01, QMI_IDL_TYPE16(0, 35), 8},
  {QMI_PBM_GET_ALL_AAS_REQ_V01, QMI_IDL_TYPE16(0, 37), 0},
  {QMI_PBM_SET_AAS_REQ_V01, QMI_IDL_TYPE16(0, 39), 248},
  {QMI_PBM_BIND_SUBSCRIPTION_REQ_V01, QMI_IDL_TYPE16(0, 43), 4},
  {QMI_PBM_GET_SUBSCRIPTION_BINDING_REQ_V01, QMI_IDL_TYPE16(0, 45), 0},
  {QMI_PBM_READ_PBSET_CAPS_REQ_V01, QMI_IDL_TYPE16(0, 47), 14},
  {QMI_PBM_READ_RECORDS_EXT_REQ_V01, QMI_IDL_TYPE16(0, 50), 10},
  {QMI_PBM_WRITE_RECORD_EXT_REQ_V01, QMI_IDL_TYPE16(0, 53), 2306},
  {QMI_PBM_SEARCH_RECORDS_EXT_REQ_V01, QMI_IDL_TYPE16(0, 55), 564},
  {QMI_PBM_READ_ALL_HIDDEN_RECORDS_EXT_REQ_V01, QMI_IDL_TYPE16(0, 57), 4},
...
static const qmi_idl_service_message_table_entry pbm_service_response_messages_v01[] = {
  ...
  {QMI_PBM_READ_RECORDS_RESP_V01, QMI_IDL_TYPE16(0, 7), 12},
  {QMI_PBM_WRITE_RECORD_RESP_V01, QMI_IDL_TYPE16(0, 10), 12},
  {QMI_PBM_DELETE_RECORD_RESP_V01, QMI_IDL_TYPE16(0, 12), 12},
  {QMI_PBM_DELETE_ALL_PB_RECORDS_RESP_V01, QMI_IDL_TYPE16(0, 14), 7},
  {QMI_PBM_SEARCH_RECORDS_RESP_V01, QMI_IDL_TYPE16(0, 16), 2012},
  {QMI_PBM_GET_EMERGENCY_LIST_RESP_V01, QMI_IDL_TYPE16(0, 23), 23528},
  {QMI_PBM_GET_ALL_GROUPS_RESP_V01, QMI_IDL_TYPE16(0, 25), 58343},
  {QMI_PBM_SET_GROUP_INFO_RESP_V01, QMI_IDL_TYPE16(0, 27), 12},
  {QMI_PBM_GET_PB_STATE_RESP_V01, QMI_IDL_TYPE16(0, 29), 14},
  {QMI_PBM_READ_ALL_HIDDEN_RECORDS_RESP_V01, QMI_IDL_TYPE16(0, 31), 12},
  {QMI_PBM_GET_NEXT_EMPTY_RECORD_ID_RESP_V01, QMI_IDL_TYPE16(0, 34), 12},
  {QMI_PBM_GET_NEXT_NON_EMPTY_RECORD_ID_RESP_V01, QMI_IDL_TYPE16(0, 36), 12},
  {QMI_PBM_GET_ALL_AAS_RESP_V01, QMI_IDL_TYPE16(0, 38), 58343},
  {QMI_PBM_SET_AAS_RESP_V01, QMI_IDL_TYPE16(0, 40), 12},
  {QMI_PBM_BIND_SUBSCRIPTION_RESP_V01, QMI_IDL_TYPE16(0, 44), 7},
  {QMI_PBM_GET_SUBSCRIPTION_BINDING_RESP_V01, QMI_IDL_TYPE16(0, 46), 11},
  {QMI_PBM_READ_PBSET_CAPS_RESP_V01, QMI_IDL_TYPE16(0, 48), 12},
  {QMI_PBM_READ_RECORDS_EXT_RESP_V01, QMI_IDL_TYPE16(0, 51), 12},
  {QMI_PBM_WRITE_RECORD_EXT_RESP_V01, QMI_IDL_TYPE16(0, 54), 12},
  {QMI_PBM_SEARCH_RECORDS_EXT_RESP_V01, QMI_IDL_TYPE16(0, 56), 2012},
  {QMI_PBM_READ_ALL_HIDDEN_RECORDS_EXT_RESP_V01, QMI_IDL_TYPE16(0, 58), 12},
...
static const qmi_idl_service_message_table_entry pbm_service_indication_messages_v01[] = {
  {QMI_PBM_RECORD_READ_IND_V01, QMI_IDL_TYPE16(0, 8), 12159},
  {QMI_PBM_RECORD_UPDATE_IND_V01, QMI_IDL_TYPE16(0, 17), 9},
  {QMI_PBM_REFRESH_IND_V01, QMI_IDL_TYPE16(0, 18), 7},
  {QMI_PBM_PB_READY_IND_V01, QMI_IDL_TYPE16(0, 19), 6},
  {QMI_PBM_EMERGENCY_LIST_IND_V01, QMI_IDL_TYPE16(0, 20), 23521},
  {QMI_PBM_ALL_PB_INIT_DONE_IND_V01, QMI_IDL_TYPE16(0, 21), 22},
  {QMI_PBM_HIDDEN_RECORD_STATUS_IND_V01, QMI_IDL_TYPE16(0, 32), 5},
  {QMI_PBM_AAS_UPDATE_IND_V01, QMI_IDL_TYPE16(0, 41), 762},
  {QMI_PBM_GAS_UPDATE_IND_V01, QMI_IDL_TYPE16(0, 42), 762},
  {QMI_PBM_PBSET_CAP_READ_IND_V01, QMI_IDL_TYPE16(0, 49), 2835},
  {QMI_PBM_RECORD_READ_EXT_IND_V01, QMI_IDL_TYPE16(0, 52), 22919},
