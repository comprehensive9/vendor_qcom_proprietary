...
enum vx_df_image_e {
     ...
     * The range of data is not specified.
     */
    VX_DF_IMAGE_F32  = VX_DF_IMAGE('F','0','3','2'),
    /*! \brief A single plane of unsigned 64-bit data.
     * The range of data is not specified.
     */
...
typedef union _vx_pixel_value_t {
    ...
    vx_int8 S8; /*!< \brief <tt>\ref VX_DF_IMAGE_S8</tt> */
    ...
    vx_float32 F32; /*!< \brief <tt>\ref VX_DF_IMAGE_F32</tt> */
    vx_uint64 U64; /*!< \brief <tt>\ref VX_DF_IMAGE_U64</tt> */
