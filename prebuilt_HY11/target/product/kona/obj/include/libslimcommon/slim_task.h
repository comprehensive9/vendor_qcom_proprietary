...
*/
/* $Header: //components/rel/gnss8.mpss/10.1/gnss/slim/common/core/inc/slim_task.h#1 $ */
...
typedef enum
{
  ...
  M_IPC_SLIM_TO_TASK_ENABLE_TILT_REQ_0,
  ...
  M_IPC_SLIM_TO_TASK_GET_SERVICE_STATUS_REQ_0,
...
typedef enum
{
  ...
  IPC_SLIM_TO_TASK_ENABLE_TILT_REQ  = M_IPC_SLIM_TO_TASK_ENABLE_TILT_REQ_0,
  /**< IPC id for enabling Tilt reporting request */
  ...
  IPC_SLIM_TO_TASK_GET_SERVICE_STATUS_REQ   = M_IPC_SLIM_TO_TASK_GET_SERVICE_STATUS_REQ_0,
