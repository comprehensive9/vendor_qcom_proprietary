...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/10.1/gnss/slim/common/core/inc/slim_utils.h#1 $ */
...
typedef struct {
  slim_ClientTxnDataStructType z_TxnData;       /*!< Transaction data */
} slim_GetServiceStatusTxnStructType;
...
/*! Struct for SLIM enable magnetic field data transaction */
typedef struct slim_EnableTiltTxnStructType
{
  slim_ClientTxnDataStructType z_TxnData;               /*!< Transaction data */
  slimEnableTiltRequestStructT z_Request;               /*!< Tilt configuration */
} slim_EnableTiltTxnStructType;
