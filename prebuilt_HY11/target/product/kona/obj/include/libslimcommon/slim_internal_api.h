...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/10.1/gnss/slim/common/core/inc/slim_internal_api.h#1 $ */
...
SLIM error code.
*/
slimErrorEnumT slim_InternalGetServiceStatus
(
   slimClientContextT *pz_Context
);
...
/**
@brief Enabling or disabling of Tilt data streaming.
...
@sa slim_EnableMagneticFieldData
*/
slimErrorEnumT slim_InternalEnableTilt
(
  slimClientContextT *pz_Context,
