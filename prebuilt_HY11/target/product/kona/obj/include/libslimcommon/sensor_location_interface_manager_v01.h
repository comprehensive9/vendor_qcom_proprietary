...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/5.0/slim/api/sensor_location_interface_manager_v01.h#5 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SLIM_V01_IDL_MINOR_VERS 0x05
...
#define QMI_SLIM_FLAGS_MASK_SENSOR_BUFFER_DATA_V01 ((qmiSlimFlagsMaskT_v01)0x0000000000000004ull) /**<  Bit mask to represent sensor data as buffer data  */
 ...
 */
 ...
 SLIM flags. Values: \n
      ...
      - QMI_SLIM_FLAGS_MASK_TIME_UNC_HIGH (0x0000000000000002) --  Timestamp uncertainty is high, and must not be trusted; occurs
       if there is too much noise in the timesync measurements,
       or if timesync has not yet converged to a low-uncertainty estimate
      - QMI_SLIM_FLAGS_MASK_SENSOR_BUFFER_DATA (0x0000000000000004) --  Bit mask to represent sensor data as buffer data
 */
