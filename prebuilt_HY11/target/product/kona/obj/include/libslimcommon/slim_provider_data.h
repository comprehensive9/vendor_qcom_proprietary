...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/10.1/gnss/slim/common/core/inc/slim_provider_data.h#1 $ */
...
/*!
@brief Initiates Tilt data request.

Service provider interface function (#slim_ServiceProviderInterfaceStructType).

Function initiates Tilt service request to provider. If request is
accepted for processing, #eSLIM_SUCCESS shall be returned.
...
@sa slim_CoreDispatchData
*/
typedef slimErrorEnumT slim_ServiceProvider_EnableTiltFnT
(
  slim_ServiceProviderInterfaceType *pz_Interface,
...
typedef struct slim_ServiceProviderInterfaceStruct
{
  ...
  slim_ServiceProvider_EnableTiltFnT *
    fn_EnableTiltRequest;
  /**< Enable request for Tilt data. */
