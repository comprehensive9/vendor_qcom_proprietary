/*
 * Copyright (c) 2004-2015, 2020 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
#define AEE_EINVHANDLE           (AEE_EOFFSET + 0x02C)  ///< Invalid handle
...
#define AEE_ENONIONOUTARGS	     (AEE_EOFFSET + 0x180)   /// AsyncRPC Non-ion output argument
#define AEE_EINVALIDDESC	     (AEE_EOFFSET + 0x181)   /// AsyncRPC Invalid descriptor
