...
public:
  ...
  /*----------------------------------------------------------------------------
   * FUNCTION      createMwqemAgent
   *
   * DESCRIPTION   Method to initialize required MWQEM classes.
   *
   * DEPENDENCIES  Logging
   *
   * RETURN VALUE  None
   ...
   * SIDE EFFECTS  None
   *--------------------------------------------------------------------------*/
  virtual bool createMwqemAgent(CneCom &com, CneTimer &timer, LocalLogBuffer * const logBuf);

  /*----------------------------------------------------------------------------
   * FUNCTION      destroyMwqemAgent
   *
   * DESCRIPTION   Method to destroy the MwqemAgent.
   *
   * DEPENDENCIES  Logging
   *
   * RETURN VALUE  None
   ...
   * SIDE EFFECTS  None
   *--------------------------------------------------------------------------*/
  virtual bool destroyMwqemAgent();

  /*----------------------------------------------------------------------------
   * FUNCTION      startLinkQualityEstimator
   *
   * DESCRIPTION   Method to start the MwqemAgent.
   *
   * DEPENDENCIES  Logging
   *
   * RETURN VALUE  None
  ...
  virtual void startLinkQualityEstimator(CneWlanResourceType &primaryNetwork,
                                              MwqemRatInfoType &secondaryNetwork);

  /*----------------------------------------------------------------------------
   * FUNCTION      stopLinkQualityEstimator
   *
   * DESCRIPTION   Method to stop the MwqemAgent.
   *
   * DEPENDENCIES  Logging
   *
   * RETURN VALUE  None
  ...
  /*----------------------------------------------------------------------------
   * FUNCTION      updateMwqemLinkProperties
   *
   * DESCRIPTION   Method to update the LPs and iface names for MWQEM
   *
   * DEPENDENCIES  Logging
   *
   * RETURN VALUE  None
   ...
   * SIDE EFFECTS  None
   *--------------------------------------------------------------------------*/
  virtual void updateMwqemLinkProperties(CneWlanResourceType &primaryNetwork,
                                              MwqemRatInfoType &secondaryNetwork);
