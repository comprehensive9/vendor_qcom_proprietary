...
/*----------------------------------------------------------------------------
 * FUNCTION     updateLqsInterfaceInfo
 *
 * DESCRIPTION  update LQS iface information by dispatching
                SRM_LQS_EVENT event
 *
 ...
 * SIDE EFFECTS
 *--------------------------------------------------------------------------*/
  void updateLqsInterfaceInfo(CneLqsInterfaceInfo &mCneLqsInterfaceInfo);

/*----------------------------------------------------------------------------
 * FUNCTION     updateLqaRatioInfo
 *
 * DESCRIPTION  update LQA ratio information by dispatching
                SRM_LQA_EVENT event
 *
 * DEPENDENCIES EventDispatcher
 *
 ...
 * SIDE EFFECTS
 *--------------------------------------------------------------------------*/
  void updateLqaRatioInfo(CneLqaRatioInfo &mCneLqaRatioInfo);
  ...
  private:
    ...
    void setWifiIfaceDefName(const char* v4IfaceName, const char* v6IfaceName);
    bool dhcpRenewState;
    bool bWqe;
    std::string wifiIfaceDefName;
