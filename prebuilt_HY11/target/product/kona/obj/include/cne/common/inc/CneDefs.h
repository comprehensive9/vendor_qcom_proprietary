...
enum CommandId {
  ...
  /*MWQEM Adapter command Ids*/
  MWQEM_ADAPTER_REQUEST_INIT = 2001,
  MWQEM_ADAPTER_REQUEST_UPDATE_RAT_INFO = 2002,
  /*MWQEM command Ids*/
  MWQEM_REQUEST_INIT = 3001,
  MWQEM_LQS_UPDATE_UID_CHAIN = 3002,
  MWQEM_LQA_UPDATE_UID_CHAIN = 3003,
  MWQEM_LQS_LQA_DELETE_UID_CHAIN = 3004
};
...
enum MessageId {
  ...
  /*MWQEM Adapter Callback messages*/
  REGISTER_FOR_OEM_NETWORK = 2001,

  /*MWQEM IPTABLE cmds */
  MWQEM_IPTABLE_INIT = 3001,
  MWQEM_IPTABLE_DEINIT = 3002,
  MWQEM_IPTABLE_CREATE_FW_MARK_CHAIN = 3003,
  MWQEM_IPTABLE_REMOVE_FW_MARK_CHAIN = 3004,
  MWQEM_IPTABLE_LQS_CREATE_UID_CHAIN = 3005,
  MWQEM_IPTABLE_LQS_REMOVE_UID_CHAIN = 3006,
  MWQEM_IPTABLE_LQA_CREATE_UID_CHAIN = 3007,
  MWQEM_IPTABLE_LQA_REMOVE_UID_CHAIN = 3008,
  MWQEM_IPTABLE_LQA_CREATE_RATIO_CHAIN = 3009,
  MWQEM_IPTABLE_LQA_REMOVE_RATIO_CHAIN = 3010,
  MWQEM_IPTABLE_LQA_INITIALIZE_CHAIN = 3011,
  MWQEM_IPTABLE_LQS_SET_IFACE = 3012
};
...
#define CNE_FEATURE_WQE_LQS_TIMER_PROP "persist.vendor.cne.lqstimer"
...
typedef struct  _MwqemRatInfo{
    ...
    _MwqemRatInfo(): type(-1), status(-1), netHdl(0),
    ...
    //Copy constructor
    _MwqemRatInfo(const struct _MwqemRatInfo &src):
...
typedef union {
  const MwqemRatInfoType* pMwqemRatInfo;
  const MwqemUidListType* pMwqemUidList;
  void* genPtr;
}MwqemSvcEventData_u;

typedef struct MwqemSvcEventInfo_s
{
  CneEvent cmd;
  MwqemSvcEventData_u evtData;
  unsigned int dataLen;
  MwqemSvcEventInfo_s() {
      cmd = COMMAND_UNKNOWN;
      evtData.genPtr = nullptr;
...
typedef enum {
  MWQEM_SERVER_EVENT_MIN = 0,
  MWQEM_ADAPTER_EVENT,
  MWQEM_SERVER_EVENT_MAX
} MwqemSvcEventType;


typedef struct {

   char name[MWQEM_MAX_STRING];
   char fwmark[MWQEM_MAX_STRING];
   char routeTable[MWQEM_MAX_STRING];
