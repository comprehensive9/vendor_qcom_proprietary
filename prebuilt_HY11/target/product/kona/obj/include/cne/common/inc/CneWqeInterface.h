...
#define MWQEM_PROFILE   "profileMwqem"
...
class CneWqeInterface
{
  public:
    ...
    virtual bool createMwqemAgent(CneCom &com, CneTimer &timer, LocalLogBuffer * const logBuf)=0;
    virtual bool destroyMwqemAgent()=0;

    virtual void startLinkQualityEstimator(CneWlanResourceType &primaryNetwork, MwqemRatInfoType &secondaryNetwork)=0;
    virtual void stopLinkQualityEstimator()=0;

    virtual void updateMwqemLinkProperties(CneWlanResourceType &primaryNetwork, MwqemRatInfoType &secondaryNetwork)=0;
};
#endif
