...
/*=============================================================================
               Copyright (c) 2013-2014, 2020 Qualcomm Technologies, Inc.
               All Rights Reserved.
...
#define MSG_SSID_QCNEA_WQE_LQE               10380
...
#define CNE_MSG_SUBTYPE_QCNEA_WQE_LQE       MSG_SSID_QCNEA_WQE_LQE       // Link Quality Estimator
  ...
  protected:
    ...
    const char * subtypeToStr( const int ssid ){
      switch( ssid ){
        ...
        case CNE_MSG_SUBTYPE_QCNEA_WQE_LQE:        return "WQE:LQE";
