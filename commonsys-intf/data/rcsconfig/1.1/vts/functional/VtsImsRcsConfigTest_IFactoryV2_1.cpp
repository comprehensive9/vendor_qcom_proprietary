...
public:
  ...
  mRcsConfigListener = new mockRcsConfigListener();
    if(factory != nullptr)
    {
      factory->createRcsConfig_1_1(atoi(g_configValues[slot_id_key].c_str()), mRcsConfigListener,
    ...
    {
      factory_2_0->createRcsConfig(atoi(g_configValues[slot_id_key].c_str()), mRcsConfigListener,
