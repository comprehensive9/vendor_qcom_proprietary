...
#include <vendor/qti/ims/rcsconfig/2.0/IRcsConfig.h>
...
using ::vendor::qti::ims::rcsconfig::V2_0::IRcsConfig;
using ::vendor::qti::ims::rcsconfig::V2_0::IRcsConfigListener;
...
public:
  virtual void SetUp() override
  {
    ...
    if(factory != nullptr)
    {
      factory->createRcsConfig(atoi(g_configValues[slot_id_key].c_str()),
              mRcsConfigListener,
...
TEST_F(RcsConfigTestBase, GetUceStatusTest) {
