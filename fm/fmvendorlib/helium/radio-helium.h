...
typedef void (*enable_slimbus_cb) (int status);
typedef void (*enable_softmute_cb) (int status);
...
typedef struct {
    ...
    enable_slimbus_cb enable_slimbus_cb;
    enable_softmute_cb enable_softmute_cb;
} fm_hal_callbacks_t;
