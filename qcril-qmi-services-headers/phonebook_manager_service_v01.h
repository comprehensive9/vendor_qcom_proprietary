...
#define PBM_V01_IDL_MINOR_VERS 0x15
...
typedef struct {
  ...
  /**<   Bitmask of the events to be registered: \n
      ...
      - PBM_REG_EMERGENCY_NUMBER_LIST_EVENTS (0x04) --  Emergency number list
     events
      - PBM_REG_HIDDEN_RECORD_STATUS_EVENTS (0x08) --  Hidden Record Status
     events
      - PBM_REG_AAS_UPDATE_EVENTS (0x10) --  Additional number alpha string
     update events
      - PBM_REG_GAS_UPDATE_EVENTS (0x20) --  Grouping information alpha string
     update events
 */
...
typedef struct {
  ...
  /* Optional */
  /*  Serving MCC Based Emergency Numbers for Each Slot */
  uint8_t serving_mcc_emer_nums_valid;  /**< Must be set to true if serving_mcc_emer_nums is being passed */
  uint32_t serving_mcc_emer_nums_len;  /**< Must be set to # of elements in serving_mcc_emer_nums */
...
/** @addtogroup pbm_qmi_messages
    @{
  */
/** Request Message; Configures the phonebook caching status of the QMI_PBM service. */
typedef struct {
...
/** @addtogroup pbm_qmi_messages
    @{
  */
/** Response Message; Configures the phonebook caching status of the QMI_PBM service. */
typedef struct {
...
/** @addtogroup pbm_qmi_messages
    @{
  */
/** Request Message; Gets the Phonebook Feature Status configuration. */
typedef struct {
...
/** @addtogroup pbm_qmi_messages
    @{
  */
/** Response Message; Gets the Phonebook Feature Status configuration. */
typedef struct {
