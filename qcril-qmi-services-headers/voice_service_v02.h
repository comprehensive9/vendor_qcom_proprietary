...
#define VOICE_V02_IDL_MINOR_VERS 0x81
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x007E
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /**<   Indicates whether to transmit MSD on Call Connect; it is a boolean value.
  */
  ...
  */
  ...
  /* Optional */
  /*  Inter-UE Transfer Call Pulled from User Phone to Car Modem */
  uint8_t iut_call_pull_valid;  /**< Must be set to true if iut_call_pull is being passed */
  uint8_t iut_call_pull;
  /**<   Indicates whether the call is an Inter-UE transfer call pull.
        If this TLV is set as TRUE, the TLV calling_number is
        Session Transfer Number in ASCII format.
  */

  /* Optional */
  /*  Session Transfer Number for Inter-UE Transfer Call Pull Request (Deprecated; use calling_number for IUT call pull STN) */
  ...
  /**<   Session transfer number for IUT call pull.
  */
...
typedef enum {
  ...
  VOICE_CALL_CRS_TYPE_VIDEO_V02 = 4, /**<   Video */
...
typedef enum {
  ...
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_CALL_REJ_Q850_V02 = 1, /**<  Call being rejected with Q850 failure cause \n  */
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_CALL_WAITING_V02 = 2, /**<  Call being put to wait \n  */
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_CALL_FORWARDING_V02 = 3, /**<  Call being forwarded \n  */
...
typedef struct {
  ...
  */
  ...
  /**<   Type of Customized Ringing Signal
   */
...
typedef struct {
  ...
  */
  ...
  /**<   Reason for Prog Info Notification
  */

  char notif_text[QMI_VOICE_PROG_INFO_NOTIF_TEXT_MAX_LEN_V02];
  /**<   Detailed Progress Info to display to user.
       The notification text will be in ASCII format
  */
...
data. */
  ...
  */
  ...
  /**<   \n Notifies UI whether to display incoming call.
           UI should display the incoming call in the absence of TLV
  */
  ...
  /**<   \n Type of call when dialed [or] received by the modem.
           In absence of this TLV, AP should refer to call_type field of the call_info TLV
  */
  ...
  /**<   \n Type of Customized Ringing Signal.
           Absence of TLV signifies -
           [1]No CRS info received from Network
           [2] CRS info couldnt be retrieved due to Network Failure
               (Bearer Activation failure, Bearer Activation time out etc.)
  */
  ...
  /**<   \n Notification of Progress Info of call
           Absence of TLV signifies -
           [1]No Progress Info of Call
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Domain preference over which the USSD is to be originated. Values: \n
...
typedef enum {
  ...
  VOIP_SUPS_TYPE_EXPLICIT_CALL_TRANSFER_IUT_V02 = 0x10, /**<  Transfer the call to a new UE for Inter-UE transfer  */
...
typedef struct {
  ...
  /**<   Supplementary service type during the call. Values: \n
      ...
      - VOIP_SUPS_TYPE_EXPLICIT_CALL_TRANSFER_IUT (0x10) --  Transfer the call to a new UE for Inter-UE transfer
 */
 ...
 */
  ...
  /* Optional */
  /*  Session Transfer Number for Inter-UE Transfer Call Push Request (Deprecated; use iut_stn_number for IUT call push STN) */
  uint8_t iut_stn_valid;  /**< Must be set to true if iut_stn is being passed */
  uint32_t iut_stn_len;  /**< Must be set to # of elements in iut_stn */
  uint8_t iut_stn[QMI_VOICE_IUT_STN_MAX_LEN_V02];
  ...
  */
  ...
  /* Optional */
  /*  Inter-UE Transfer Call Push Session Transfer Number */
  ...
  /**<   Session transfer number in ASCII format for IUT call push.
  */
...
typedef enum {
  ...
  VOICE_ECALL_TIMER_STATUS_RESUMED_V02 = 0x05, /**<  eCall timer status resumed  */
...
typedef struct {
  ...
  /**<   eCall HLAP t2 timer status. Values: \n
      ...
      - VOICE_ECALL_TIMER_STATUS_RESUMED (0x05) --  eCall timer status resumed
 */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Indicates Inter-UE transfer call push is delayed. */
typedef struct {
