...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/qos/api/quality_of_service_v01.h#11 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define QOS_V01_IDL_MINOR_VERS 0x14
...
#define QMI_QOS_MAX_QOS_FILTERS_EX_V01 8
#define QMI_QOS_MAX_QOS_IDS_V01 64
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Report Global QOS Flows Extended */
  uint8_t report_global_qos_flows_ex_valid;  /**< Must be set to true if report_global_qos_flows_ex is being passed */
  uint8_t report_global_qos_flows_ex;
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report global QOS flows
  */
...
typedef struct {
  ...
  uint32_t tx_id;
  /**<   Transaction Id for the Indication.
  */
  ...
  */
  ...
  uint8_t tx_qos_filters_valid;  /**< Must be set to true if tx_qos_filters is being passed */
  uint32_t tx_qos_filters_len;  /**< Must be set to # of elements in tx_qos_filters */
  qos_filter_rule_resp_ind_type_v01 tx_qos_filters[QMI_QOS_MAX_QOS_FILTERS_EX_V01];
  /**<   \vspace{4pt} \n Filters that apply to a granted Tx QoS flow. */
  ...
  uint8_t rx_qos_filters_valid;  /**< Must be set to true if rx_qos_filters is being passed */
  uint32_t rx_qos_filters_len;  /**< Must be set to # of elements in rx_qos_filters */
  qos_filter_rule_resp_ind_type_v01 rx_qos_filters[QMI_QOS_MAX_QOS_FILTERS_EX_V01];
  /**<  \vspace{4pt} \n Filters that apply to a granted Rx QoS flow. */
 ...
 */
  ...
  */
  ...
  /**<   \vspace{4pt} \n List of filter IDs that have match-all capability.
  */
}qos_global_qos_flow_ex_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Identifier for the QoS flow/instance that has been negotiated and that 
        is being queried.
        To request for QoS information for all QoS IDs of the bound MUX ID then
        this TLV should be omitted from the request.*/
}qos_get_qos_info_ex_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t tx_id;
}qos_get_qos_info_ex_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Retrieves list of QOS IDS for the MUX ID to which the control point 
           is bound to. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}qos_get_qos_ids_req_msg_v01;
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Retrieves list of QOS IDS for the MUX ID to which the control point 
           is bound to. */
typedef struct {
  ...
  /* Optional */
  /*  QoS Identifier List */
  uint8_t qos_ids_list_valid;  /**< Must be set to true if qos_ids_list is being passed */
  uint32_t qos_ids_list_len;  /**< Must be set to # of elements in qos_ids_list */
  uint32_t qos_ids_list[QMI_QOS_MAX_QOS_IDS_V01];
}qos_get_qos_ids_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Binds a control point to the specified preferences. */
typedef struct {

  /* Optional */
  /*  Subscription */
  uint8_t subscription_valid;  /**< Must be set to true if subscription is being passed */
  qos_bind_subscription_enum_v01 subscription;
  /**<   Subscription to which control point bind. Values: \n
      - QOS_PRIMARY_SUBS (0x0001) --  Primary \n 
      - QOS_SECONDARY_SUBS (0x0002) --  Secondary \n 
      - QOS_TERTIARY_SUBS (0x0003) --  Tertiary  
 */
  ...
  */
  ...
  uint8_t mux_id;
  /**<   The Mux ID of the logical data channel to which
       the control point binds (default value is 0). 
  */
}qos_bind_client_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Binds a control point to the specified preferences. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}qos_bind_client_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Gets the control point's binding information. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}qos_get_client_binding_req_msg_v01;
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Gets the control point's binding information. */
typedef struct {
  ...
  qos_bind_subscription_enum_v01 bound_subs;
 ...
 */
  ...
  /**<   \vspace{4pt} \n The peripheral endpoint (physical data channel) to 
  ...
  */
  ...
  /**<   The mux ID of the logical data channel to which
       the client is bound. 
  */
}qos_get_client_binding_resp_msg_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */ 
//#define REMOVE_QMI_QOS_BIND_CLIENT_V01
...
//#define REMOVE_QMI_QOS_GET_CLIENT_BINDING_V01
...
//#define REMOVE_QMI_QOS_GET_QOS_IDS_V01
//#define REMOVE_QMI_QOS_GET_QOS_INFO_V01
//#define REMOVE_QMI_QOS_GET_QOS_INFO_EX_V01
//#define REMOVE_QMI_QOS_GET_QOS_NETWORK_STATUS_V01
//#define REMOVE_QMI_QOS_GET_QOS_STATUS_V01
//#define REMOVE_QMI_QOS_GLOBAL_QOS_FLOW_EX_IND_V01
...
#define QMI_QOS_GLOBAL_QOS_FLOW_EX_IND_V01 0x0034
#define QMI_QOS_GET_QOS_INFO_EX_REQ_V01 0x0035
#define QMI_QOS_GET_QOS_INFO_EX_RESP_V01 0x0035
#define QMI_QOS_GET_QOS_IDS_REQ_V01 0x0036
#define QMI_QOS_GET_QOS_IDS_RESP_V01 0x0036
#define QMI_QOS_BIND_CLIENT_REQ_V01 0x0037
#define QMI_QOS_BIND_CLIENT_RESP_V01 0x0037
#define QMI_QOS_GET_CLIENT_BINDING_REQ_V01 0x0038
#define QMI_QOS_GET_CLIENT_BINDING_RESP_V01 0x0038
