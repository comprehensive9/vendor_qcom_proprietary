...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/qos/src/quality_of_service_v01.c#11 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Wed Feb 24 2021 (Spin 1)
...
static const uint8_t qos_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, suppress_network_status_ind) - QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, suppress_network_status_ind_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, suppress_network_status_ind),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, report_global_qos_flows_ex) - QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, report_global_qos_flows_ex_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, report_global_qos_flows_ex)
};
...
static const uint8_t qos_global_qos_flow_ex_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, tx_id),

  0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, is_last_segment),

  0x03,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, qos_flow_state),
  QMI_IDL_TYPE88(0, 24),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_flow_granted) - QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_flow_granted_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_flow_granted),
  QMI_IDL_TYPE88(0, 23),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_flow_granted) - QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_flow_granted_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_flow_granted),
  QMI_IDL_TYPE88(0, 23),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_filters) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_filters_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_filters),
  QMI_QOS_MAX_QOS_FILTERS_EX_V01,
  QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_filters) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_qos_filters_len),
  QMI_IDL_TYPE88(0, 19),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_filters) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_filters_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_filters),
  QMI_QOS_MAX_QOS_FILTERS_EX_V01,
  QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_filters) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_qos_filters_len),
  QMI_IDL_TYPE88(0, 19),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, flow_type) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, flow_type_valid)),
  0x14,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, flow_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, bearer_id) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, bearer_id_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, bearer_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_5g_qci) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_5g_qci_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, tx_5g_qci),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_5g_qci) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_5g_qci_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, rx_5g_qci),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_averaging_window) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_averaging_window_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, tx_averaging_window),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_averaging_window) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, rx_averaging_window_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, rx_averaging_window),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_filter_match_all) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_filter_match_all_valid)),
  0x1A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, tx_filter_match_all),
  QMI_QOS_MAX_QOS_FILTERS_V01,
  QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_filter_match_all) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_filter_match_all_len),
  QMI_IDL_TYPE88(0, 25)
};

static const uint8_t qos_get_qos_info_ex_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_qos_info_ex_req_msg_v01, qos_id) - QMI_IDL_OFFSET8(qos_get_qos_info_ex_req_msg_v01, qos_id_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qos_get_qos_info_ex_req_msg_v01, qos_id)
};

static const uint8_t qos_get_qos_info_ex_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_get_qos_info_ex_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_qos_info_ex_resp_msg_v01, tx_id) - QMI_IDL_OFFSET8(qos_get_qos_info_ex_resp_msg_v01, tx_id_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qos_get_qos_info_ex_resp_msg_v01, tx_id)
};

/*
 * qos_get_qos_ids_req_msg is empty
 * static const uint8_t qos_get_qos_ids_req_msg_data_v01[] = {
 * };
 */

static const uint8_t qos_get_qos_ids_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, qos_ids_list) - QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, qos_ids_list_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, qos_ids_list),
  QMI_QOS_MAX_QOS_IDS_V01,
  QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, qos_ids_list) - QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, qos_ids_list_len)
};

static const uint8_t qos_bind_client_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, subscription) - QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, subscription_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, subscription),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, ip_preference) - QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, ip_preference_valid)),
  0x11,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, ip_preference),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, ep_id) - QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, ep_id_valid)),
  0x12,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, ep_id),
  QMI_IDL_TYPE88(2, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, mux_id) - QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, mux_id_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qos_bind_client_req_msg_v01, mux_id)
};

static const uint8_t qos_bind_client_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_bind_client_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * qos_get_client_binding_req_msg is empty
 * static const uint8_t qos_get_client_binding_req_msg_data_v01[] = {
 * };
 */

static const uint8_t qos_get_client_binding_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_subs) - QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_subs_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_subs),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, ip_preference) - QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, ip_preference_valid)),
  0x11,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, ip_preference),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_ep_id) - QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_ep_id_valid)),
  0x12,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_ep_id),
  QMI_IDL_TYPE88(2, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_mux_id) - QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_mux_id_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qos_get_client_binding_resp_msg_v01, bound_mux_id)
};
...
static const qmi_idl_message_table_entry qos_message_table_v01[] = {
  ...
  {sizeof(qos_global_qos_flow_ex_ind_msg_v01), qos_global_qos_flow_ex_ind_msg_data_v01},
  {sizeof(qos_get_qos_info_ex_req_msg_v01), qos_get_qos_info_ex_req_msg_data_v01},
  {sizeof(qos_get_qos_info_ex_resp_msg_v01), qos_get_qos_info_ex_resp_msg_data_v01},
  {sizeof(qos_get_qos_ids_req_msg_v01), 0},
  {sizeof(qos_get_qos_ids_resp_msg_v01), qos_get_qos_ids_resp_msg_data_v01},
  {sizeof(qos_bind_client_req_msg_v01), qos_bind_client_req_msg_data_v01},
  {sizeof(qos_bind_client_resp_msg_v01), qos_bind_client_resp_msg_data_v01},
  {sizeof(qos_get_client_binding_req_msg_v01), 0},
  {sizeof(qos_get_client_binding_resp_msg_v01), qos_get_client_binding_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry qos_service_command_messages_v01[] = {
  ...
  {QMI_QOS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 38), 16},
  ...
  {QMI_QOS_GET_QOS_INFO_EX_REQ_V01, QMI_IDL_TYPE16(0, 48), 7},
  {QMI_QOS_GET_QOS_IDS_REQ_V01, QMI_IDL_TYPE16(0, 50), 0},
  {QMI_QOS_BIND_CLIENT_REQ_V01, QMI_IDL_TYPE16(0, 52), 26},
  {QMI_QOS_GET_CLIENT_BINDING_REQ_V01, QMI_IDL_TYPE16(0, 54), 0},
...
static const qmi_idl_service_message_table_entry qos_service_response_messages_v01[] = {
  ...
  {QMI_QOS_GET_QOS_INFO_EX_RESP_V01, QMI_IDL_TYPE16(0, 49), 14},
  {QMI_QOS_GET_QOS_IDS_RESP_V01, QMI_IDL_TYPE16(0, 51), 267},
  {QMI_QOS_BIND_CLIENT_RESP_V01, QMI_IDL_TYPE16(0, 53), 7},
  {QMI_QOS_GET_CLIENT_BINDING_RESP_V01, QMI_IDL_TYPE16(0, 55), 33},
...
static const qmi_idl_service_message_table_entry qos_service_indication_messages_v01[] = {
  ...
  {QMI_QOS_GLOBAL_QOS_FLOW_EX_IND_V01, QMI_IDL_TYPE16(0, 47), 2646}
};
