...
#define DFS_V01_IDL_MINOR_VERS 0x0C
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DFS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DFS_V01_MAX_MESSAGE_ID 0x003C
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Filter Rules.
   */
}dfs_add_filters_per_mux_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_enums
  ...
  */
typedef enum {
  DFS_FILTER_STATUS_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DFS_FILTER_STATUS_NONE_V01 = 0x00, /**<  Filter status none \n  */
  DFS_FILTER_STATUS_INVALID_V01 = 0x01, /**<  Filter status invalid \n  */
  DFS_FILTER_STATUS_VALID_V01 = 0x02, /**<  Filter status valid \n  */
  DFS_FILTER_STATUS_ACTIVE_V01 = 0x03, /**<  Filter status is active \n  */
  DFS_FILTER_STATUS_INACTIVE_V01 = 0x04, /**<  Filter status is inactive \n  */
  DFS_FILTER_STATUS_DELETED_V01 = 0x05, /**<  Filter status is deleted \n  */
  DFS_FILTER_STATUS_MAX_V01 = 0xFF, /**<  Filter status max \n  */
  DFS_FILTER_STATUS_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dfs_filter_status_enum_v01;
/**
    @}
  */
...
/** @addtogroup dfs_qmi_enums
  ...
  */
typedef enum {
  DFS_FILTER_STATUS_CAUSE_CODE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DFS_FILTER_CAUSE_CODE_NONE_V01 = 0x00, /**<  Cause code  none \n  */
  DFS_FILTER_CAUSE_CODE_HARDWARE_ERROR_V01 = 0x01, /**<   Hardware error \n  */
  DFS_FILTER_CAUSE_CODE_MAX_V01 = 0xFF, /**<  Cause code max \n  */
  DFS_FILTER_STATUS_CAUSE_CODE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dfs_filter_status_cause_code_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  dfs_filter_status_enum_v01 status;
  /**<   Filter status \n
      - DFS_FILTER_STATUS_NONE (0x00) --  Filter status none \n
      - DFS_FILTER_STATUS_INVALID (0x01) --  Filter status invalid \n
      - DFS_FILTER_STATUS_VALID (0x02) --  Filter status valid \n
      - DFS_FILTER_STATUS_ACTIVE (0x03) --  Filter status is active \n
      - DFS_FILTER_STATUS_INACTIVE (0x04) --  Filter status is inactive \n
      - DFS_FILTER_STATUS_DELETED (0x05) --  Filter status is deleted \n
      - DFS_FILTER_STATUS_MAX (0xFF) --  Filter status max \n
 */

  dfs_filter_status_cause_code_enum_v01 cause_code;
  /**<   Filter status \n
      - DFS_FILTER_CAUSE_CODE_NONE (0x00) --  Cause code  none \n
      - DFS_FILTER_CAUSE_CODE_HARDWARE_ERROR (0x01) --   Hardware error \n
      - DFS_FILTER_CAUSE_CODE_MAX (0xFF) --  Cause code max \n
 */
}dfs_filter_status_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Filter Status: \n
      ...
      - DFS_FILTER_STATUS_MAX (0xFF) --  Filter status max \n
 */
}dfs_filters_per_mux_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Maximum Coalescing Filters */
  uint8_t max_coalescing_filters_valid;  /**< Must be set to true if max_coalescing_filters is being passed */
  dfs_filter_capability_type_v01 max_coalescing_filters;
  /**<    \n( Maximum number of filters that can be added on modem for coalescing
            across all MUX IDs, in total, and per filter add requests.)
  */
 ...
 */
  ...
  /* Optional */
  /*  Coalescing Filter Update  */
  uint8_t report_coalescing_filter_update_valid;  /**< Must be set to true if report_coalescing_filter_update is being passed */
  uint8_t report_coalescing_filter_update;
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report coalescing filter update
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Removes all coalescing filters associated with previously added
           handles. */
typedef struct {
  ...
  /*  Peripheral Endpoint ID */
  data_ep_id_type_v01 ep_id;
  /**<   \n Remove all filets associated with endpoint (physical data channel) ) */

  /* Optional */
  /*  Mux ID */
  uint8_t mux_id_valid;  /**< Must be set to true if mux_id is being passed */
  uint8_t mux_id;
  /**<   Remove all filters associated with this mux id. */
  ...
  uint32_t filter_handles_len;  /**< Must be set to # of elements in filter_handles */
  uint32_t filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles for the filter rules to be removed */
}dfs_remove_coalescing_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Removes all coalescing filters associated with previously added
           handles. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}dfs_remove_coalescing_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Adds a list of coalescing filters. */
typedef struct {
  ...
  /*  Filter Rules */
  uint32_t filter_rules_len;  /**< Must be set to # of elements in filter_rules */
  dfs_add_filters_per_mux_info_type_v01 filter_rules[QMI_DFS_MAX_FILTERS_V01];
}dfs_add_coalescing_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Adds a list of coalescing filters. */
typedef struct {
  ...
  uint8_t filter_handles_valid;  /**< Must be set to true if filter_handles is being passed */
  uint32_t filter_handles_len;  /**< Must be set to # of elements in filter_handles */
  dfs_filter_status_info_type_v01 filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles that uniquely identifies added filter rules. \n
       This TLV contain filter add status and corresponding handles
   */
}dfs_add_coalescing_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Indication Message; Notifies the status of the coalescing filters on the modem */
typedef struct {

  /* Optional */
  /*  Filter Status */
  uint8_t filter_status_valid;  /**< Must be set to true if filter_status is being passed */
  uint32_t filter_status_len;  /**< Must be set to # of elements in filter_status */
  dfs_filter_status_info_type_v01 filter_status[QMI_DFS_MAX_FILTERS_V01];
}dfs_coalescing_filters_update_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Query all coalescing filters associated with an end point. */
typedef struct {
  ...
  data_ep_id_type_v01 ep_id;
  /**<   \n(The peripheral endpoint (physical data channel) ) */
}dfs_query_coalescing_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Query all coalescing filters associated with an end point. */
typedef struct {
  ...
  uint8_t filter_rules_valid;  /**< Must be set to true if filter_rules is being passed */
  uint32_t filter_rules_len;  /**< Must be set to # of elements in filter_rules */
  dfs_filters_per_mux_info_type_v01 filter_rules[QMI_DFS_MAX_FILTERS_V01];
}dfs_query_coalescing_filters_resp_msg_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */
//#define REMOVE_QMI_DFS_ADD_COALESCING_FILTERS_V01
...
//#define REMOVE_QMI_DFS_COALESCING_FILTERS_UPDATE_IND_V01
...
//#define REMOVE_QMI_DFS_QUERY_COALESCING_FILTERS_V01
...
//#define REMOVE_QMI_DFS_REMOVE_COALESCING_FILTERS_V01
...
#define QMI_DFS_REMOVE_COALESCING_FILTERS_REQ_V01 0x0039
#define QMI_DFS_REMOVE_COALESCING_FILTERS_RESP_V01 0x0039
#define QMI_DFS_ADD_COALESCING_FILTERS_REQ_V01 0x003A
#define QMI_DFS_ADD_COALESCING_FILTERS_RESP_V01 0x003A
#define QMI_DFS_COALESCING_FILTERS_UPDATE_IND_V01 0x003B
#define QMI_DFS_QUERY_COALESCING_FILTERS_REQ_V01 0x003C
#define QMI_DFS_QUERY_COALESCING_FILTERS_RESP_V01 0x003C
/**
    @}
  */
