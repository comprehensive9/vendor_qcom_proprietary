...
/* This file was generated with Tool version 6.14.7
   It was generated on: Mon Apr 27 2020 (Spin 0)
...
static const uint8_t dfs_add_filters_per_mux_info_type_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dfs_add_filters_per_mux_info_type_v01, mux_id),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_add_filters_per_mux_info_type_v01, filter_rules),
  QMI_IDL_TYPE88(0, 12),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t dfs_filter_status_info_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dfs_filter_status_info_type_v01, filter_handle),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dfs_filter_status_info_type_v01, status),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dfs_filter_status_info_type_v01, cause_code),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t dfs_filters_per_mux_info_type_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dfs_filters_per_mux_info_type_v01, mux_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dfs_filters_per_mux_info_type_v01, filter_handle),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_filters_per_mux_info_type_v01, filter_rules),
  QMI_IDL_TYPE88(0, 12),
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dfs_filters_per_mux_info_type_v01, status),
...
static const uint8_t dfs_get_filter_capability_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_get_filter_capability_resp_msg_v01, max_low_latency_filters) - QMI_IDL_OFFSET8(dfs_get_filter_capability_resp_msg_v01, max_low_latency_filters_valid)),
  0x13,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_get_filter_capability_resp_msg_v01, max_low_latency_filters),
  QMI_IDL_TYPE88(0, 16),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_get_filter_capability_resp_msg_v01, max_coalescing_filters) - QMI_IDL_OFFSET8(dfs_get_filter_capability_resp_msg_v01, max_coalescing_filters_valid)),
  0x14,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_get_filter_capability_resp_msg_v01, max_coalescing_filters),
  QMI_IDL_TYPE88(0, 16)
};
...
static const uint8_t dfs_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, remote_socket_handling_version) - QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, remote_socket_handling_version_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, remote_socket_handling_version),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, report_coalescing_filter_update) - QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, report_coalescing_filter_update_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, report_coalescing_filter_update)
};
...
static const uint8_t dfs_remove_coalescing_filters_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, ep_id),
  QMI_IDL_TYPE88(2, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, mux_id) - QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, mux_id_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, mux_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, filter_handles) - QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, filter_handles_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, filter_handles),
  QMI_DFS_MAX_FILTERS_V01,
  QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, filter_handles) - QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_req_msg_v01, filter_handles_len)
};

static const uint8_t dfs_remove_coalescing_filters_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_remove_coalescing_filters_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t dfs_add_coalescing_filters_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_add_coalescing_filters_req_msg_v01, ep_id),
  QMI_IDL_TYPE88(2, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_add_coalescing_filters_req_msg_v01, filter_rules),
  QMI_DFS_MAX_FILTERS_V01,
  QMI_IDL_OFFSET8(dfs_add_coalescing_filters_req_msg_v01, filter_rules) - QMI_IDL_OFFSET8(dfs_add_coalescing_filters_req_msg_v01, filter_rules_len),
  QMI_IDL_TYPE88(0, 13)
};

static const uint8_t dfs_add_coalescing_filters_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_add_coalescing_filters_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_add_coalescing_filters_resp_msg_v01, filter_handles) - QMI_IDL_OFFSET8(dfs_add_coalescing_filters_resp_msg_v01, filter_handles_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_add_coalescing_filters_resp_msg_v01, filter_handles),
  QMI_DFS_MAX_FILTERS_V01,
  QMI_IDL_OFFSET8(dfs_add_coalescing_filters_resp_msg_v01, filter_handles) - QMI_IDL_OFFSET8(dfs_add_coalescing_filters_resp_msg_v01, filter_handles_len),
  QMI_IDL_TYPE88(0, 14)
};

static const uint8_t dfs_coalescing_filters_update_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_coalescing_filters_update_ind_msg_v01, filter_status) - QMI_IDL_OFFSET8(dfs_coalescing_filters_update_ind_msg_v01, filter_status_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_coalescing_filters_update_ind_msg_v01, filter_status),
  QMI_DFS_MAX_FILTERS_V01,
  QMI_IDL_OFFSET8(dfs_coalescing_filters_update_ind_msg_v01, filter_status) - QMI_IDL_OFFSET8(dfs_coalescing_filters_update_ind_msg_v01, filter_status_len),
  QMI_IDL_TYPE88(0, 14)
};

static const uint8_t dfs_query_coalescing_filters_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_query_coalescing_filters_req_msg_v01, ep_id),
  QMI_IDL_TYPE88(2, 0)
};

static const uint8_t dfs_query_coalescing_filters_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_query_coalescing_filters_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_query_coalescing_filters_resp_msg_v01, filter_rules) - QMI_IDL_OFFSET8(dfs_query_coalescing_filters_resp_msg_v01, filter_rules_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dfs_query_coalescing_filters_resp_msg_v01, filter_rules),
  QMI_DFS_MAX_FILTERS_V01,
  QMI_IDL_OFFSET8(dfs_query_coalescing_filters_resp_msg_v01, filter_rules) - QMI_IDL_OFFSET8(dfs_query_coalescing_filters_resp_msg_v01, filter_rules_len),
  QMI_IDL_TYPE88(0, 15)
};
...
static const qmi_idl_type_table_entry  dfs_type_table_v01[] = {
  ...
  {sizeof(dfs_add_filters_per_mux_info_type_v01), dfs_add_filters_per_mux_info_type_data_v01},
  {sizeof(dfs_filter_status_info_type_v01), dfs_filter_status_info_type_data_v01},
  {sizeof(dfs_filters_per_mux_info_type_v01), dfs_filters_per_mux_info_type_data_v01},
...
static const qmi_idl_message_table_entry dfs_message_table_v01[] = {
  ...
  {sizeof(dfs_remove_coalescing_filters_req_msg_v01), dfs_remove_coalescing_filters_req_msg_data_v01},
  {sizeof(dfs_remove_coalescing_filters_resp_msg_v01), dfs_remove_coalescing_filters_resp_msg_data_v01},
  {sizeof(dfs_add_coalescing_filters_req_msg_v01), dfs_add_coalescing_filters_req_msg_data_v01},
  {sizeof(dfs_add_coalescing_filters_resp_msg_v01), dfs_add_coalescing_filters_resp_msg_data_v01},
  {sizeof(dfs_coalescing_filters_update_ind_msg_v01), dfs_coalescing_filters_update_ind_msg_data_v01},
  {sizeof(dfs_query_coalescing_filters_req_msg_v01), dfs_query_coalescing_filters_req_msg_data_v01},
  {sizeof(dfs_query_coalescing_filters_resp_msg_v01), dfs_query_coalescing_filters_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry dfs_service_command_messages_v01[] = {
  {QMI_DFS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 24), 27},
  ...
  {QMI_DFS_REMOVE_COALESCING_FILTERS_REQ_V01, QMI_IDL_TYPE16(0, 46), 1039},
  {QMI_DFS_ADD_COALESCING_FILTERS_REQ_V01, QMI_IDL_TYPE16(0, 48), 37245},
  {QMI_DFS_QUERY_COALESCING_FILTERS_REQ_V01, QMI_IDL_TYPE16(0, 51), 11}
};
...
static const qmi_idl_service_message_table_entry dfs_service_response_messages_v01[] = {
  ...
  {QMI_DFS_GET_FILTER_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 1), 58},
  ...
  {QMI_DFS_REMOVE_COALESCING_FILTERS_RESP_V01, QMI_IDL_TYPE16(0, 47), 7},
  {QMI_DFS_ADD_COALESCING_FILTERS_RESP_V01, QMI_IDL_TYPE16(0, 49), 3071},
  {QMI_DFS_QUERY_COALESCING_FILTERS_RESP_V01, QMI_IDL_TYPE16(0, 52), 39281}
};
...
static const qmi_idl_service_message_table_entry dfs_service_indication_messages_v01[] = {
  ...
  {QMI_DFS_COALESCING_FILTERS_UPDATE_IND_V01, QMI_IDL_TYPE16(0, 50), 3064}
};
