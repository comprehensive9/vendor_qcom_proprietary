...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/dsd/api/data_system_determination_v01.h#54 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Thu Oct 14 2021 (Spin 0)
...
#define DSD_V01_IDL_MINOR_VERS 0x4D
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DSD_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DSD_V01_MAX_MESSAGE_ID 0x0076
/**
    @}
  */
...
typedef enum {
  ...
  QMI_DSD_WQE_WIFI_BAND_UNSPECIFIED_V01 = 0, /**<  WQE WIFI BAND UNSPECIFIED. This is the default value. */
  QMI_DSD_WQE_WIFI_BAND_2_4_GHZ_V01 = 1, /**<  WQE WIFI BAND 2.4 GHz. */
  QMI_DSD_WQE_WIFI_BAND_5_GHZ_V01 = 2, /**<  WQE WIFI BAND 5 GHz. */
  QMI_DSD_WQE_WIFI_BAND_6_GHZ_V01 = 3, /**<  WQE WIFI BAND 6 GHz. */
 ...
 */
  ...
  /**<   Conveys the RSSI 2.4GHz low threshold parameter to be used for Wifi Quality Estmiation
  */
  ...
  /**<   Conveys the RSSI 2.4GHz high threshold parameter to be used for Wifi Quality Estmiation
  */
  ...
  /**<   Conveys the RSSI 5GHz low threshold parameter to be used for Wifi Quality Estmiation
  */

  /* Optional */
  /*  Wifi RSSI 5GHz High threshold */
  ...
  /**<   Conveys the RSSI 5GHz high threshold parameter to be used for Wifi Quality Estmiation
  */

  /* Optional */
  /*  Wifi RSSI 6GHz Low threshold */
  ...
  /**<   Conveys the RSSI 6GHz low threshold parameter to be used for Wifi Quality Estmiation
  */

  /* Optional */
  /*  Wifi RSSI 6GHz High threshold */
  ...
  /**<   Conveys the RSSI 6GHz high threshold parameter to be used for Wifi Quality Estmiation
  */
 ...
 */
  ...
  /**<   This TLV contains DDS recommendation source. \n
...
typedef struct {
  ...
  /**<   Dynamic DDS swtich setting. Values: \n
      - DSD_DYNAMIC_DDS_SWITCH_OFF (0) --  Disable dynamic dds swtich (default) 
      - DSD_DYNAMIC_DDS_SWTICH_ON (1) --  Enable dynamic dds swtich 
 ...
 */
  ...
  /**<   Modem recommendation of DDS. TLV is only applicable when 
 ...
 */
  ...
  /**<   Modem recommendation of DDS setting. Values: \n
      - DSD_DDS_RECOMMENDATION_THROUGHPUT_BASED (1) --  DDS recommendation based on throughput (Default) 
      - DSD_DDS_RECOMMENDATION_LATENCY_BASED (2) --  DDS recommendation based on latency 
 */
 ...
 */
  ...
  /**<  \n HTTP header SSL version. Values:\n
         @ENUM();
  */
...
/** @addtogroup dsd_qmi_messages
    @{
  */
/** Request Message; Notifies modem the result of AP assisted HTTP session */
typedef struct {
  ...
  /**<  \n AP Assisted HTTP Result Code. Values:\n
...
/** @addtogroup dsd_qmi_messages
    @{
  */
/** Response Message; Notifies modem the result of AP assisted HTTP session */
typedef struct {
...
typedef struct {
  ...
  /**<   SIB2 value for the UI icon. Values:\n
       - 0 -- Timer values timer_scg_to_mcg, timer_idle, and 
              timer_idle_to_connect  honored \n
       - 1 -- Timer values timer_scg_to_mcg, timer_idle, and 
           timer_idle_to_connect ignored       
  */
...
typedef struct {
  ...
  uint8_t sib2_ui_icon_val;
  /**<   SIB2 value for the UI icon. Values:\n
       - 0 -- TLV's timer_scg_to_mcg, timer_idle, and 
           timer_idle_to_connect values are honored \n
       - 1 -- TLV's timer_scg_to_mcg, timer_idle, and 
           timer_idle_to_connect values are ignored 
           and not returned in the message
  */
...
/** @addtogroup dsd_qmi_messages
    @{
  */
/** Indication Message; Indicates preferred APN for the specified APN type */
typedef struct {
