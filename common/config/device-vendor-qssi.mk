...
ifeq ($(filter $(TARGET_PRODUCT), qssi lahaina holi),$(TARGET_PRODUCT))
ENABLE_INTEGER_OVERFLOW := true
ENABLE_BOUND_SANITIZER := true
endif

ifeq ($(filter $(TARGET_PRODUCT), qssi kona lito bengal lahaina holi),$(TARGET_PRODUCT))
...
HY11_HY22_diff += libsensorndkbridge
HY11_HY22_diff += libhwbinder
...
MM_AUDIO += fai__3.0.0_0.0__eai_1.10.pmd
...
#SENSORS
ifneq ($(TARGET_BOARD_PLATFORM),msm8937)
...
PRODUCT_PACKAGES += vendor.qti.memory.pasrmanager@1.1.vendor
