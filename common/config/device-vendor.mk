...
ifeq ($(filter $(TARGET_PRODUCT), msm8996 msm8998 sdm845 msmnile kona),$(TARGET_PRODUCT))
...
PRODUCT_LIST += sdm429w
PRODUCT_LIST += msm8937_32go
PRODUCT_LIST += sdm429w_law
...
PRODUCT_LIST += bengal
PRODUCT_LIST += monaco
PRODUCT_LIST += monaco_go
PRODUCT_LIST += monaco_go_aon
...
ifneq (, $(filter $(PRODUCT_LIST), $(target_base_product)))
  ...
  else ifeq ($(TARGET_PRODUCT),sdm429w_law)
    PREBUILT_BOARD_PLATFORM_DIR := sdm429w_law
  else ifeq ($(target_base_product),sdm429w)
    PREBUILT_BOARD_PLATFORM_DIR := sdm429w
...
ifeq ($(strip $(TARGET_USES_RRO)),true)
#Add Runtime Resource Overlays to build
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/commonsys-intf/resource-overlay/overlay.mk)
endif
...
ADSPRPC += adsprpcd
ifneq ($(filter $(TARGET_BOARD_PLATFORM), msm8953 msm8937 msm8998 monaco),$(TARGET_BOARD_PLATFORM))
...
BT += vendor.qti.hardware.bluetooth_offload@1.0-impl
BT += vendor.qti.hardware.bluetooth_offload@1.0-service-qti
endif
...
MM_AUDIO += MTP_SDM429W_Bluetooth_cal.acdb
MM_AUDIO += MTP_SDM429W_General_cal.acdb
MM_AUDIO += MTP_SDM429W_Global_cal.acdb
MM_AUDIO += MTP_SDM429W_Handset_cal.acdb
MM_AUDIO += MTP_SDM429W_Hdmi_cal.acdb
MM_AUDIO += MTP_SDM429W_Headset_cal.acdb
MM_AUDIO += MTP_SDM429W_Speaker_cal.acdb
MM_AUDIO += MTP_SDM429W_workspaceFile.qwsp
...
MM_AUDIO += HHG_Bluetooth_cal.acdb
MM_AUDIO += HHG_General_cal.acdb
MM_AUDIO += HHG_Global_cal.acdb
MM_AUDIO += HHG_Handset_cal.acdb
MM_AUDIO += HHG_Hdmi_cal.acdb
MM_AUDIO += HHG_Headset_cal.acdb
MM_AUDIO += HHG_Speaker_cal.acdb
MM_AUDIO += HHG_workspaceFile.qwsp
MM_AUDIO += HDK_Bluetooth_cal.acdb
MM_AUDIO += HDK_General_cal.acdb
MM_AUDIO += HDK_Global_cal.acdb
MM_AUDIO += HDK_Handset_cal.acdb
MM_AUDIO += HDK_Hdmi_cal.acdb
MM_AUDIO += HDK_Headset_cal.acdb
MM_AUDIO += HDK_Speaker_cal.acdb
MM_AUDIO += HDK_workspaceFile.qwsp
...
MM_AUDIO += ftm_test_config_sdm429w-wtp-newport-card
MM_AUDIO += ftm_test_config_sdm429w-wtp-snd-card
...
MM_AUDIO += ftm_test_config_lahaina-yupikidp-snd-card
MM_AUDIO += ftm_test_config_lahaina-yupikqrd-snd-card
...
MM_AUDIO += libautohal
MM_AUDIO += IDP_acdb_cal.acdb
MM_AUDIO += IDP_workspaceFileXml.qwsp
...
MM_AUDIO += vendor.qti.hardware.AGMIPC@1.0
MM_AUDIO += vendor.qti.hardware.AGMIPC@1.0-impl
MM_AUDIO += vendor.qti.hardware.AGMIPC@1.0-service
MM_AUDIO += libar-acdb
MM_AUDIO += libar-acdbdata
MM_AUDIO += libar-gpr
ifeq ($(ENABLE_HYP), true)
MM_AUDIO += libar-gsl_fe
else
MM_AUDIO += libar-gsl
endif
MM_AUDIO += liblx-ar_util
MM_AUDIO += liblx-osal
MM_AUDIO += libqts
MM_AUDIO += libar-pal
MM_AUDIO += catf
MM_AUDIO += hw_ep_info.xml
MM_AUDIO += kvh2xml.xml
ifeq ($(ENABLE_HYP), true)
MM_AUDIO += resourcemanager_8155.xml
MM_AUDIO += resourcemanager_6155.xml
MM_AUDIO += resourcemanager_gvmauto_8155.xml
MM_AUDIO += resourcemanager_gvmauto_6155.xml
else
MM_AUDIO += resourcemanager.xml
endif
MM_AUDIO += usecaseKvManager.xml
MM_AUDIO += libhfp_pal
MM_AUDIO += lib_default_plugin_controls
endif
...
MM_CAMERA += libchromatix_s5k3p9sx04_zsl_preview_3a
MM_CAMERA += libchromatix_s5k3p9sx04_zsl_video_3a
MM_CAMERA += libchromatix_s5k3p9sx04_default_preview_3a
MM_CAMERA += libchromatix_s5k3p9sx04_postproc
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_video
MM_CAMERA += libchromatix_s5k3p9sx04_common
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_hfr_90
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_hfr_60
MM_CAMERA += libchromatix_s5k3p9sx04_default_video_3a
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_snapshot
MM_CAMERA += libchromatix_s5k3p9sx04_hfr_120
MM_CAMERA += libchromatix_s5k3p9sx04_preview
MM_CAMERA += libchromatix_s5k3p9sx04_default_video
MM_CAMERA += libchromatix_s5k3p9sx04_hfr_90_3a
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_liveshot
MM_CAMERA += libchromatix_s5k3p9sx04_hfr_60_3a
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_hfr_120
MM_CAMERA += libchromatix_s5k3p9sx04_hfr_90
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_preview
MM_CAMERA += libchromatix_s5k3p9sx04_hfr_60
MM_CAMERA += libchromatix_s5k3p9sx04_snapshot
MM_CAMERA += libchromatix_s5k3p9sx04_default_video_4k
MM_CAMERA += libchromatix_s5k3p9sx04_4k_video_3a
MM_CAMERA += libchromatix_s5k3p9sx04_cpp_video_4k
MM_CAMERA += libchromatix_s5k3p9sx04_4k_preview_3a

MM_CAMERA += libactuator_s5k3p9sx04
MM_CAMERA += libmmcamera_s5k3p9sx04_eeprom
MM_CAMERA += libmmcamera_s5k3p9sx04
MM_CAMERA += s5k3p9sx04_chromatix.xml
MM_CAMERA += libchromatix_s5k3p9sp04_zsl_preview_3a
MM_CAMERA += libchromatix_s5k3p9sp04_zsl_video_3a
MM_CAMERA += libchromatix_s5k3p9sp04_default_preview_3a
MM_CAMERA += libchromatix_s5k3p9sp04_postproc
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_video
MM_CAMERA += libchromatix_s5k3p9sp04_common
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_hfr_90
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_hfr_60
MM_CAMERA += libchromatix_s5k3p9sp04_default_video_3a
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_snapshot
MM_CAMERA += libchromatix_s5k3p9sp04_hfr_120
MM_CAMERA += libchromatix_s5k3p9sp04_preview
MM_CAMERA += libchromatix_s5k3p9sp04_default_video
MM_CAMERA += libchromatix_s5k3p9sp04_hfr_90_3a
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_liveshot
MM_CAMERA += libchromatix_s5k3p9sp04_hfr_60_3a
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_hfr_120
MM_CAMERA += libchromatix_s5k3p9sp04_hfr_90
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_preview
MM_CAMERA += libchromatix_s5k3p9sp04_hfr_60
MM_CAMERA += libchromatix_s5k3p9sp04_snapshot
MM_CAMERA += libchromatix_s5k3p9sp04_default_video_4k
MM_CAMERA += libchromatix_s5k3p9sp04_4k_video_3a
MM_CAMERA += libchromatix_s5k3p9sp04_cpp_video_4k
MM_CAMERA += libchromatix_s5k3p9sp04_4k_preview_3a
MM_CAMERA += libactuator_s5k3p9sp04
MM_CAMERA += libmmcamera_s5k3p9sp04_eeprom
MM_CAMERA += libmmcamera_s5k3p9sp04
MM_CAMERA += s5k3p9sp04_chromatix.xml

MM_CAMERA += libmmcamera_ov5675
MM_CAMERA += ov5675_chromatix.xml
MM_CAMERA += libchromatix_ov5675_common
MM_CAMERA += libchromatix_ov5675_cpp_liveshot
MM_CAMERA += libchromatix_ov5675_cpp_preview
MM_CAMERA += libchromatix_ov5675_cpp_snapshot
MM_CAMERA += libchromatix_ov5675_cpp_video
MM_CAMERA += libchromatix_ov5675_default_preview_3a
MM_CAMERA += libchromatix_ov5675_default_video_3a
MM_CAMERA += libchromatix_ov5675_default_video
MM_CAMERA += libchromatix_ov5675_postproc
MM_CAMERA += libchromatix_ov5675_preview
MM_CAMERA += libchromatix_ov5675_snapshot
MM_CAMERA += libchromatix_ov5675_zsl_preview_3a
MM_CAMERA += libchromatix_ov5675_zsl_video_3a
endif
...
ifeq ($(TARGET_SUPPORTS_WEAR_ANDROID), true)
MM_CAMERA += libmmcamera_gc8034
MM_CAMERA += libmmcamera_gc8c54
MM_CAMERA += libmmcamera_gc8c54_otp_eeprom
endif
...
ifeq ($(TARGET_SUPPORTS_WEAR_ANDROID), true)
MM_CAMERA += libchromatix_gc8034_3a_default_preview
MM_CAMERA += libchromatix_gc8034_3a_default_video
MM_CAMERA += libchromatix_gc8034_3a_hfr_120
MM_CAMERA += libchromatix_gc8034_3a_hfr_60
MM_CAMERA += libchromatix_gc8034_3a_hfr_90
MM_CAMERA += libchromatix_gc8034_common
MM_CAMERA += libchromatix_gc8034_cpp_ds_chromatix
MM_CAMERA += libchromatix_gc8034_cpp_hfr_120
MM_CAMERA += libchromatix_gc8034_cpp_hfr_60
MM_CAMERA += libchromatix_gc8034_cpp_hfr_90
MM_CAMERA += libchromatix_gc8034_cpp_liveshot
MM_CAMERA += libchromatix_gc8034_cpp_preview
MM_CAMERA += libchromatix_gc8034_cpp_snapshot
MM_CAMERA += libchromatix_gc8034_cpp_us_chromatix
MM_CAMERA += libchromatix_gc8034_cpp_video
MM_CAMERA += libchromatix_gc8034_default_video
MM_CAMERA += libchromatix_gc8034_hfr_120
MM_CAMERA += libchromatix_gc8034_hfr_60
MM_CAMERA += libchromatix_gc8034_hfr_90
MM_CAMERA += libchromatix_gc8034_liveshot
MM_CAMERA += libchromatix_gc8034_postproc
MM_CAMERA += libchromatix_gc8034_preview
MM_CAMERA += libchromatix_gc8034_snapshot
MM_CAMERA += libchromatix_gc8034_zsl_preview
MM_CAMERA += libchromatix_gc8034_zsl_video
MM_CAMERA += gc8034_chromatix.xml

MM_CAMERA += libchromatix_gc8c54_3a_default_preview
MM_CAMERA += libchromatix_gc8c54_3a_default_video
MM_CAMERA += libchromatix_gc8c54_3a_hfr_120
MM_CAMERA += libchromatix_gc8c54_3a_hfr_60
MM_CAMERA += libchromatix_gc8c54_3a_hfr_90
MM_CAMERA += libchromatix_gc8c54_common
MM_CAMERA += libchromatix_gc8c54_cpp_ds_chromatix
MM_CAMERA += libchromatix_gc8c54_cpp_hfr_120
MM_CAMERA += libchromatix_gc8c54_cpp_hfr_60
MM_CAMERA += libchromatix_gc8c54_cpp_hfr_90
MM_CAMERA += libchromatix_gc8c54_cpp_liveshot
MM_CAMERA += libchromatix_gc8c54_cpp_preview
MM_CAMERA += libchromatix_gc8c54_cpp_snapshot
MM_CAMERA += libchromatix_gc8c54_cpp_us_chromatix
MM_CAMERA += libchromatix_gc8c54_cpp_video
MM_CAMERA += libchromatix_gc8c54_default_video
MM_CAMERA += libchromatix_gc8c54_hfr_120
MM_CAMERA += libchromatix_gc8c54_hfr_60
MM_CAMERA += libchromatix_gc8c54_hfr_90
MM_CAMERA += libchromatix_gc8c54_liveshot
MM_CAMERA += libchromatix_gc8c54_postproc
MM_CAMERA += libchromatix_gc8c54_preview
MM_CAMERA += libchromatix_gc8c54_snapshot
MM_CAMERA += libchromatix_gc8c54_zsl_preview
MM_CAMERA += libchromatix_gc8c54_zsl_video
MM_CAMERA += gc8c54_chromatix.xml
endif
...
ifneq ($(TARGET_NO_TELEPHONY), true)
ifneq ($(filter $(TARGET_BOARD_PLATFORM), monaco),$(TARGET_BOARD_PLATFORM))
QCRIL += libril-qc-1
...
SECUREMSM += android.hardware.keymaster@4.1-service-qti
...
SECUREMSM += android.hardware.keymaster@4.1-service-qti.rc
endif #ENABLE_KM_4_1
...
SECUREMSM += vendor.qti.secure_element@1.2-service
SECUREMSM += vendor.qti.secure_element@1.2-service.rc
PRODUCT_COPY_FILES += \
...
SENSORS += sensors.msm8937_lily
SENSORS += sensors.sdm429w_law
...
ifneq ($(TARGET_BOARD_AUTO),true)
ifeq ($(TARGET_SUPPORTS_WEAR_ANDROID), true)
SENSORS += init.vendor.sensors.rc
SENSORS += android.hardware.sensors@2.0-service.multihal
...
ifneq ($(TARGET_HAS_LOW_RAM),true)
ifneq ($(TARGET_EXCLUDES_DISPLAY_PP),true)
...
SCR_MODULES += vendor.google_clockwork.sidekickgraphics@1.2
SCR_MODULES += vendor.google_clockwork.sidekickgraphics@1.1
SCR_MODULES += vendor.google_clockwork.sidekickgraphics@1.0
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.2-impl
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.2-service
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.2-service.rc
WEAR_TEST_APP += WfGrayScaleInternalTest
WEAR_TEST_APP += Wf8bitInternalTest
WEAR_TEST_APP += Wf16bitInternalTest
WEAR_TEST_APP += WfFontKerningInternalTest
WEAR_TEST_APP += twm
else ifeq ($(TARGET_SUPPORTS_SIDEKICK_GRAPHICS_V1_1),true)
SCR_MODULES += vendor.google_clockwork.sidekickgraphics@1.1
SCR_MODULES += vendor.google_clockwork.sidekickgraphics@1.0
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.1-impl
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.1-service
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.1-service.rc
WEAR_TEST_APP += twm
else
SCR_MODULES += vendor.google_clockwork.sidekickgraphics@1.0
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.0-impl
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.0-service
SCR_MODULES += vendor.qti.hardware.sidekickgraphics@1.0-service.rc
endif

ifeq ($(TARGET_SUPPORTS_DISPLAY_OFFLOAD),true)
SCR_MODULES += libc++_shared
SCR_MODULES += libTscCompressor
SCR_MODULES += libuioffload
SCR_MODULES += libtscFont
SCR_MODULES += vendor.google_clockwork.displayoffload@1.0
SCR_MODULES += vendor.google_clockwork.displayoffload@1.1
SCR_MODULES += vendor.qti.hardware.displayoffload@1.1-impl
SCR_MODULES += vendor.qti.hardware.displayoffload@1.1-service
SCR_MODULES += vendor.qti.hardware.displayoffload@1.1-service.xml
SCR_MODULES += vendor.qti.hardware.displayoffload@1.1-service.rc
WEAR_TEST_APP += DisplayOffloadTestApp
WEAR_TEST_APP += DisplayStringOffloadTestApp
endif

ifeq ($(TARGET_SUPPORTS_UI_OFFLOAD),true)
SCR_MODULES += libc++_shared
SCR_MODULES += libTscCompressor
SCR_MODULES += libuioffload
SCR_MODULES += libtscFont
SCR_MODULES += vendor.qti.hardware.uioffload@1.0
SCR_MODULES += vendor.qti.hardware.uioffload@1.0-impl
SCR_MODULES += vendor.qti.hardware.uioffload@1.0-service
SCR_MODULES += vendor.qti.hardware.uioffload@1.0-service.xml
SCR_MODULES += vendor.qti.hardware.uioffload@1.0-service.rc
endif

SCR_MODULES += bg_peekpoke
SCR_MODULES += libBGIORegisterReadWrite
SCR_MODULES += slatedaemon
SCR_MODULES += slatedaemon.rc

ifeq ($(TARGET_SUPPORTS_SIDEKICK_METRICS),true)
SCR_MODULES += vendor.qti.hardware.sidekickmetrics@1.0
SCR_MODULES += libsso
SCR_MODULES += metric_sensors_list.txt
SCR_MODULES += vendor.qti.hardware.sidekickmetrics@1.0-service
SCR_MODULES += vendor.qti.hardware.sidekickmetrics@1.0-service.rc
WEAR_TEST_APP += ssotest
WEAR_TEST_APP += AmbiActiveApp
WEAR_TEST_APP += WearMap
SCR_MODULES += SidekickMetricsService
SCR_MODULES += SidekickMetricsSdk-lib
SCR_MODULES += sidekickmetrics.xml
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.sensors.whsdeployed=true
endif

ifeq ($(WEARABLE_SUPPORTS_TFA_SMARTPA),true)
PRODUCT_PACKAGES += tfa98xx.cnt
endif

ifeq ($(TARGET_SUPPORTS_SIDEKICK_UTILITY),true)
SCR_MODULES += vendor.qti.hardware.sidekickutility@1.0
SCR_MODULES += vendor.qti.hardware.sidekickutility@1.1
SCR_MODULES += libSidekickUtility
SCR_MODULES += vendor.qti.hardware.sidekickutility@1.1-service
SCR_MODULES += vendor.qti.hardware.sidekickutility@1.1-service.rc
SCR_MODULES += SidekickUtilityService
SCR_MODULES += SidekickUtilitySdk-lib
SCR_MODULES += sidekickutility.xml
WEAR_TEST_APP += SampleAlarm
endif

ifeq ($(TARGET_SUPPORTS_AON_UTILITY),true)
SCR_MODULES += vendor.qti.hardware.aonutility@1.0
SCR_MODULES += libAONUtility
SCR_MODULES += vendor.qti.hardware.aonutility@1.0-service
SCR_MODULES += vendor.qti.hardware.aonutility@1.0-service.rc
SCR_MODULES += AONUtilityService
SCR_MODULES += AONUtilitySdk-lib
SCR_MODULES += aonutility.xml
WEAR_TEST_APP += SampleAlarm
endif

ifeq ($(TARGET_SUPPORTS_WRIST_ORIENTATION),true)
SCR_MODULES += vendor.google_clockwork.wristorientation@1.0
SCR_MODULES += vendor.qti.hardware.wristorientation@1.0-impl
SCR_MODULES += vendor.qti.hardware.wristorientation@1.0-service
endif

ifeq ($(TARGET_SUPPORTS_BUZZER),true)
SCR_MODULES += vendor.qti.hardware.buzzer@1.0
SCR_MODULES += vendor.qti.hardware.buzzer@1.0-impl
SCR_MODULES += vendor.qti.hardware.buzzer@1.0-service
SCR_MODULES += vendor.qti.hardware.buzzer@1.0-service.rc
endif

#POWER_STATE_MODULES
POWER_STATE_MODULES += vendor.qti.hardware.powerstateservice@1.0
POWER_STATE_MODULES += vendor.qti.hardware.powerstateservice@1.0-service
POWER_STATE_MODULES += vendor.qti.hardware.powerstateservice@1.0-service.rc
POWER_STATE_MODULES += vendor.qti.hardware.powerstateutility@1.0-service
POWER_STATE_MODULES += powerstateutility.rc

ifeq ($(TARGET_SUPPORTS_DS),true)
POWER_STATE_MODULES += powerstatetest-deepsleep
endif
...
OPM_MODULES += OperationMeasurementService
OPM_MODULES += OperationMeasurementClient
OPM_MODULES += OperationMeasurementSdk-lib
OPM_MODULES += operationmeasurement.xml

PSM_MODULES += PSMService
PSM_MODULES += PowerStateManagerSdk-lib
PSM_MODULES += powerstatemanagerservice.xml
WEAR_TEST_APP += PowerStateManagerTest
PSM_TEST_APP += PowerStateManagerLAWTest
...
PRODUCT_PACKAGES += $(PSM_MODULES)
ifeq ($(TARGET_SUPPORTS_WEAR_ANDROID), true)
PRODUCT_PACKAGES += $(PSM_TEST_APP)
endif
endif

ifeq ($(TARGET_SUPPORTS_WEAR_OS), true)
PRODUCT_PACKAGES += $(SCR_MODULES)
PRODUCT_PACKAGES += $(OPM_MODULES)
PRODUCT_PACKAGES_DEBUG += $(WEAR_TEST_APP)
endif
...
WATCH_PACKAGES += watchtheatermode
WATCH_PACKAGES += watchalarm
WATCH_PACKAGES += WatchCamera
ifneq ($(TARGET_USES_AOSP_PACKAGES), true)
...
#Those watch package just for LAW target
ifeq ($(TARGET_SUPPORTS_WEAR_ANDROID), true)
...
ifeq ($(TARGET_SUPPORTS_SIDEKICK_GRAPHICS_V1_2),true)
VNDK_LIBS += vendor.google_clockwork.sidekickgraphics@1.2.vendor
VNDK_LIBS += vendor.google_clockwork.sidekickgraphics@1.1.vendor
VNDK_LIBS += vendor.google_clockwork.sidekickgraphics@1.0.vendor
else ifeq ($(TARGET_SUPPORTS_SIDEKICK_GRAPHICS_V1_1),true)
VNDK_LIBS += vendor.google_clockwork.sidekickgraphics@1.1.vendor
VNDK_LIBS += vendor.google_clockwork.sidekickgraphics@1.0.vendor
else
...
VNDK_LIBS += vendor.qti.hardware.buzzer@1.0.vendor
VNDK_LIBS += vendor.qti.hardware.sidekickmetrics@1.0.vendor

ifeq ($(TARGET_SUPPORTS_SIDEKICK_UTILITY),true)
VNDK_LIBS += vendor.qti.hardware.sidekickutility@1.1.vendor
VNDK_LIBS += vendor.qti.hardware.sidekickutility@1.0.vendor
endif

ifeq ($(TARGET_SUPPORTS_WRIST_ORIENTATION),true)
VNDK_LIBS += vendor.google_clockwork.wristorientation@1.0.vendor
endif

ifeq ($(TARGET_SUPPORTS_AON_UTILITY),true)
VNDK_LIBS += vendor.qti.hardware.aonutility@1.0.vendor
endif

ifeq ($(TARGET_SUPPORTS_DISPLAY_OFFLOAD),true)
VNDK_LIBS   += vendor.google_clockwork.displayoffload@1.0.vendor
VNDK_LIBS   += vendor.google_clockwork.displayoffload@1.1.vendor
endif

ifeq ($(TARGET_SUPPORTS_UI_OFFLOAD),true)
VNDK_LIBS   += vendor.qti.hardware.uioffload@1.0.vendor
endif

ifneq (, $(filter true, $(TARGET_SUPPORTS_DS) $(TARGET_SUPPORTS_S2D)))
VNDK_LIBS += vendor.qti.hardware.powerstateservice@1.0.vendor
endif
...
ifeq ($(TARGET_SUPPORTS_WEAR_ANDROID), true)
PRODUCT_PACKAGES += vendor.qti.hardware.servicetracker@1.2-service
PRODUCT_PACKAGES += vendor.qti.hardware.servicetracker@1.2-impl
endif
...
ifeq ($(filter $(TARGET_PRODUCT), sdm429w_law monaco monaco_go),$(TARGET_PRODUCT))
TELEPHONY_APPS += uimlpalibrary
TELEPHONY_APPS += lpa.xml
TELEPHONY_APPS += uimlpaservice
endif
