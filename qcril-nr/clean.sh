...
SHARED_LIBS=( libqcrilFramework libqcrilnr )
STATIC_LIBS=( qcrilAndroidAudioModule qcrilNrQmiModule qcrilNrVoiceModule qcrilNrSampleModule qcrilNrLpaModule qcrilAmModule qcrilNrImsModule qcrilNrDataModule qcrilNrCellInfoModule qcrilNrUimModule qcrilNrNasModule qcrilNrPbmModule qcrilNrMbnModule qcrilNrOemHookModule)
