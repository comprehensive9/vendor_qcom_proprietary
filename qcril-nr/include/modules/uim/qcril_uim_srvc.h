...
#define QMI_UIM_MAX_EXT_CARD_COUNT                  5
...
#define QMI_UIM_MAX_PERSO_FEATURES                  20
...
typedef enum
{
  ...
  QCRIL_UIM_REQUEST_SET_HLOS_PROV_PREFERENCE,
  QCRIL_UIM_REQUEST_GET_EUICC_INFO2
...
typedef enum
{
  ...
  QMI_UIM_SRVC_SET_HLOS_PROV_PREFERENCE_RSP_MSG,
  QMI_UIM_SRVC_GET_EUICC_INFO2_RSP_MSG
} qmi_uim_rsp_id_type;
...
/* -----------------------------------------------------------------------------
   STRUCTURE:    qmi_uim_get_euicc_info2_req_type

   DESCRIPTION:   Get EUICC Info2 data structure
-------------------------------------------------------------------------------*/
typedef struct
{
  qmi_uim_slot_type       slot;
} qmi_uim_get_euicc_info2_req_type;
...
/* -----------------------------------------------------------------------------
   STRUCTURE:    qmi_uim_hlos_prov_preference_req_type

   DESCRIPTION:   HLOS preference for UIM provisioning
-------------------------------------------------------------------------------*/
typedef struct
{
  uint8_t             hlosProvPreference;
} qmi_uim_hlos_prov_preference_req_type;
...
typedef struct
{
  ...
  qmi_uim_bool_type                             temp_unlock_status[QMI_UIM_MAX_EXT_CARD_COUNT];
...
typedef struct
{
  uint32_t      euicc_info2_len;
  uint8_t     * euicc_info2_ptr;
} qmi_uim_get_euicc_info2_resp_type;
/* -----------------------------------------------------------------------------
...
typedef struct
{
  ...
  union
  {
    ...
    qmi_uim_get_euicc_info2_resp_type       euicc_info2_rsp;
  }                                         rsp_data;
