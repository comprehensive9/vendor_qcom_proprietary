/******************************************************************************
#  Copyright (c) 2008-2009, 2012-2013, 2017, 2019-2020 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
typedef struct
{
    ...
    boolean               pending_req;
    uint32_t              pending_request_timeout_timer_id;
...
typedef struct qcril_qmi_voice_voip_call_info_entry_type
{
    ...
    uint32_t                                call_obj_phase_out_timer_id;
...
typedef struct qmi_ril_voice_ims_command_exec_oversight_type
{
    ...
    uint32_t                                           timeout_control_timer_id;
...
struct qcril_qmi_voice_voip_overview_type
{
    ...
    uint32_t                                    num_1x_wait_timer_id;
    boolean                                     num_1x_wait_timer_wakelock_is_acquired;
    uint32_t                                    auto_answer_timer_id;
    ...
    qcril_qmi_voice_voip_overview_type() :
        ...
        auto_answer_timer_id(QMI_RIL_ZERO) {
    }
};
