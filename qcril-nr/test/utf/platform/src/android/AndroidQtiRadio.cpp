...
private:
    ::android::sp<vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadio> utfQtiRadio;
    bool bFirstCall;
};
...
void AndroidQtiRadio::Register(RIL_RadioFunctions *callbacks) {
    ...
    utfQtiRadio = vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadio::getService("slot1");
