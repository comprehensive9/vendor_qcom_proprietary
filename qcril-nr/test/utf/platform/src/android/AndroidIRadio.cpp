...
void AndroidIRadio::setDataAPIs(sp<IRadioResponseClientImpl> respClient, sp<IRadioIndicationClientImpl> indClient,
...
void AndroidIRadio::Register(RIL_RadioFunctions *callbacks) {
    ...
    utfIRadio = ::android::hardware::radio::V1_5::IRadio::getService("slot1", false);
...
int AndroidIRadio::OnRequest(int request, void *data, size_t datalen,
    ...
    case RIL_REQUEST_GET_CURRENT_CALLS:
        if (utfIRadio != nullptr) {
#if 0
            utfIRadio->getCurrentCalls_1_5(*static_cast<int32_t*>(t));
#else
