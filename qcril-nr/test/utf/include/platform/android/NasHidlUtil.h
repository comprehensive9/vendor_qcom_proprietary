...
template <typename T>
void convertHidlCellIdentityResponsetoRil(const T &cellIdentity, RIL_CellIdentity_v16 &rilCellIdentity) {
...
template<>
void convertHidlCellIdentityResponsetoRil(const V1_5::CellIdentity &cellIdentity, RIL_CellIdentity_v16 &rilCellIdentity);
