...
void util_voice_registration_state_for_lte(Testcase &t, QMIRILTestnode &QMI_node, AndroidTelTestnode &RIL_node, OEMTestnode &OEM_node, int rat, int reg_state, nas_service_status_enum_type_v01 srv_status, nas_true_service_status_enum_type_v01 true_srv_status, nas_service_domain_enum_type_v01 domain, nas_roam_status_enum_type_v01 roam_status, uint8_t voice_support_on_lte, uint8_t reg_reject_info_valid, nas_service_domain_enum_type_v01 reject_srv_domain, uint8_t rej_cause, uint8_t net_id_valid, const char *mcc, const char *mnc, const char* primary_mcc, const char* primary_mnc, uint8_t csg_info_valid, uint32_t cid, uint32_t cid_name_len, uint16_t *cid_name, uint8_t lte_is_eb_supported_valid, nas_tri_state_boolean_type_v01 lte_is_eb_supported, bool is_data_rat_change = true);
