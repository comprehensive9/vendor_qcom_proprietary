...
#define LOG_TAG "vendor.qti.hardware.radio.ims@1.7::ImsRadio"

#undef UNUSED

#include <vendor/qti/hardware/radio/ims/1.7/IImsRadio.h>
...
const char* IImsRadio::descriptor("vendor.qti.hardware.radio.ims@1.7::IImsRadio");
...
// Methods from ::vendor::qti::hardware::radio::ims::V1_6::IImsRadio follow.
//no default implementation for: ::android::hardware::Return<void> sendSipDtmf(int32_t token, const ::android::hardware::hidl_string& requestCode)
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio *>(parent.get()));
}

static std::unordered_map<std::string, ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadio>> mHidlServices;
...
::android::status_t IImsRadio::registerAsService(const std::string &serviceName) {
    ...
    ::vendor::qti::hardware::radio::ims::V1_6::IImsRadio::registerAsService(serviceName);
    return ::android::OK;
}
