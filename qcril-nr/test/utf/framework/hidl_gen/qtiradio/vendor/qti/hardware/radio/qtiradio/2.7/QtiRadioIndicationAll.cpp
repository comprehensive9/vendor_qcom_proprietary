...
*/
#define LOG_TAG "vendor.qti.hardware.radio.qtiradio@2.7::QtiRadioIndication"
...
const char* IQtiRadioIndication::descriptor("vendor.qti.hardware.radio.qtiradio@2.7::IQtiRadioIndication");
...
// Methods from ::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication follow.
// no default implementation for: ::android::hardware::Return<void> IQtiRadioIndication::onNrIconTypeChange(::vendor::qti::hardware::radio::qtiradio::V2_7::NrIconType iconType)
...
// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>& parent, bool /* emitError */) {
    return parent;
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioIndication>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioIndication>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadioIndication>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_7::IQtiRadioIndication*>(parent.get()));
}
