...
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_5_IQTIRADIO_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_5_IQTIRADIO_H
...
struct IQtiRadio : public ::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.radio.qtiradio@2.5::IQtiRadio"
     */
    ...
    /**
     * Provide the NR5G disable mode to the modem that must be used to
     * register the 5G network mode preference.
     *
     * @param serial Serial number of request.
     * @param message NrConfig as defined in types.hal.
     *
     *
     * Response callback is
     * IQtiRadioResponse.setNrConfigResponse()
     */
    virtual ::android::hardware::Return<void> setNrConfig(int32_t serial, const ::vendor::qti::hardware::radio::qtiradio::V2_5::NrConfig config) = 0;

    /**
     * Fetch the NR5G disable mode from the modem
     *
     * @param serial Serial number of request.
     *
     *
     * Response callback is
     * IQtiRadioResponse.onNrConfigResponse()
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>& parent, bool emitError = false);

    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio>& o) {
    ...
    os += ::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_5_IQTIRADIO_H
