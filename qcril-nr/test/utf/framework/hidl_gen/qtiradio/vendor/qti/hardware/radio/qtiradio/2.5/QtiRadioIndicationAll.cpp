...
*/
#define LOG_TAG "vendor.qti.hardware.radio.qtiradio@2.5::QtiRadioIndication"
...
const char* IQtiRadioIndication::descriptor("vendor.qti.hardware.radio.qtiradio@2.5::IQtiRadioIndication");
...
// Methods from ::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication follow.
// no default implementation for: ::android::hardware::Return<void> IQtiRadioIndication::onNrIconTypeChange(::vendor::qti::hardware::radio::qtiradio::V2_5::NrIconType iconType)
...
// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>& parent, bool /* emitError */) {
    return parent;
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioIndication>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioIndication>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadioIndication>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>> IQtiRadioIndication::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_5::IQtiRadioIndication*>(parent.get()));
}
