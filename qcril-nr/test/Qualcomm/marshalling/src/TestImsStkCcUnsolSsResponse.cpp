...
TEST(Marshalling, IMSStkCcUnsolSsResponse_marshall_001) {
  Marshal marshal;
  RIL_IMS_StkCcUnsolSsResponse request{
  ...
  RIL_IMS_StkCcUnsolSsResponse request_r = {};
...
TEST(Marshalling, IMSStkCcUnsolSsResponse_marshall_002) {
  Marshal marshal;
  RIL_IMS_StkCcUnsolSsResponse request{
