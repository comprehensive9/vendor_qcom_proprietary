...
#define QMI_RIL_QMI_RILD_THREAD_NAME                    "rild"
    ...
    */
    ...
    )
    {
...
#ifndef QMI_RIL_UTF
        qti::ril::logger::Logger::setPrefix("RIL[" + std::to_string((int)(instance_id)) + "]");
#endif
        QCRIL_LOG_INFO( "RIL client : %d, running RIL_Init()", instance_id);
        ...
        get_android_ril_module().ril_init(instance_id, env, argc, argv);
