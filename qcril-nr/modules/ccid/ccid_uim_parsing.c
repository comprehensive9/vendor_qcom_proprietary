...
#define CCID_UIM_MSG_BULKOUT_MECHANICAL             0x71
...
)
{
  ...
  switch (bulkout_req_ptr->message_type)
  {
    ...
    case CCID_UIM_MSG_BULKOUT_MECHANICAL:

      /* PC to RDR Mechanical message is not supported, send Command not supported
         in Slot Status Response as per specification */
      bulkin_rsp.message_type = CCID_UIM_MSG_BULKIN_SLOT_STATUS;
      bulkin_rsp.error        = CCID_UIM_SLOT_ERR_CMD_NOT_SUPPORTED;
