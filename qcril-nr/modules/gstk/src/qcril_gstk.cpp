...
typedef struct
{
  uint32_t                  uim_ref_id;   /*!< UIM reference id                 */
  uint32_t                  command_type; /*!< Proactive command type           */
  uint32_t                  length;       /*!< Proactive command length         */
  uint8_t                   *data;        /*!< Proactive command ASCII hex data */
...
typedef struct
{
  ...
  uint32_t                               flags;           /*!< Flags of events having occured          */
...
/*===========================================================================
 *   FUNCTION:  qcrilGstkSendQmiEventConfirmationReq
 *   ======================================================================*/
/*!
 *   @brief
 *     Sends Event confirmation request to QMI.
 *
 *   @return
 *     Void
 *                                                                         */
/*=========================================================================*/
static void qcrilGstkSendQmiEventConfirmationReq
(
  void
)
{
    ...
    QCRIL_LOG_INFO("qcrilGstkSendQmiEventConfirmationReq - slot: %d ", slot);
...
)
{
  ...
  if (send_evt_conf)
  {
    qcrilGstkSendQmiEventConfirmationReq();
  }
