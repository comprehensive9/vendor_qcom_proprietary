...
{
  if (!qcril_qmi_radio_config_meta_data) return NULL;
  size_t i;
  for (i=0; i< qcril_qmi_radio_config_meta_data->size(); i++)
  {
...
{
  if (!qcril_qmi_radio_config_meta_data) return "Unknown msg";
  size_t i;
  for (i=0; i< qcril_qmi_radio_config_meta_data->size(); i++)
  {
    if ( (*qcril_qmi_radio_config_meta_data)[i].config_item == config_item )
...
{
  if (!qcril_qmi_radio_config_meta_data) return QCRIL_QMI_RADIO_CONFIG_ITEM_IS_INVALID;
  size_t i;
  for (i=0; i< qcril_qmi_radio_config_meta_data->size(); i++)
  {
    if ( (*qcril_qmi_radio_config_meta_data)[i].config_item == config_item )
