...
)
{
  ...
  if (mModule != nullptr)
  {
    if(mModule->isReady() && indicationCb_1_1 != nullptr)
    {
...
)
{
  ...
  sp<V1_1::IUimRemoteServiceClientIndication> indCb = getIndicationCallback_1_1();
  Return<void>                                ret   = {};
  ...
  if (indCb != NULL)
  {
    ret = indCb->UimRemoteServiceClientApduInd(data);
  }
  else
  {
...
void UimRemoteClientImpl::uimRemoteClientConnectInd()
{
  ...
  if (indCb != NULL)
  {
    ret = indCb->UimRemoteServiceClientConnectInd();
  }
  else
  {
    sp<V1_0::IUimRemoteServiceClientIndication> indCb1_0 = getIndicationCallback();
...
void UimRemoteClientImpl::uimRemoteClientDisconnectInd()
{
  ...
  if (indCb != NULL)
  {
    ret = indCb->UimRemoteServiceClientDisconnectInd();
  }
  else
  {
    sp<V1_0::IUimRemoteServiceClientIndication> indCb1_0 = getIndicationCallback();
...
)
{
  ...
  if (indCb != NULL)
  {
    ret = indCb->UimRemoteServiceClientPowerUpInd(hasTimeOut,
                                          timeOut,
                                          hasVoltageClass,
...
)
{
  ...
  if (indCb != NULL)
  {
    ret = indCb->UimRemoteServiceClientPowerDownInd(hasMode,
...
void UimRemoteClientImpl::uimRemoteClientResetInd()
{
  ...
  if (indCb != NULL)
  {
    ret = indCb->UimRemoteServiceClientResetInd();
  }
  else
  {
    sp<V1_0::IUimRemoteServiceClientIndication> indCb1_0 = getIndicationCallback();
...
void UimRemoteClientImpl::uimRemoteClientServiceInd(bool status)
{
  ...
  if (indCb != NULL)
  {
    ret = indCb->UimRemoteServiceClientServiceInd(status);
  }
