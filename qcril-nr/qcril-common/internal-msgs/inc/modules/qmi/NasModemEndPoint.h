...
struct PhysChanInfo {
    ...
    bool band_info_list_ext_valid;
    uint32_t band_info_list_ext_len;
    nas_rf_band_info_ext_type_v01 band_info_list_ext[NAS_RF_BAND_INFO_LIST_MAX_V01];
    ...
    bool operator==(const PhysChanInfo &other) {
        ...
        return (
            ...
            memcmp(&band_info_list_ext, &other.band_info_list_ext, band_info_list_ext_len * sizeof(nas_rf_band_info_ext_type_v01)) == 0 &&
