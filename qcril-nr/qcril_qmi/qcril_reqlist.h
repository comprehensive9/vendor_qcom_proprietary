...
{
  uint16_t req_id;                                          /* Reqlist entry ID */
  RIL_Token t;                                              /* Token */
  ...
  uint32_t sub_id;                                          /* Subsystem ID (e.g Call ID, SS Ref, Invoke ID, Supplementary Service Type
                                                               or event ID) */
...
IxErrnoType qcril_reqlist_update_sub_id( qcril_instance_id_e_type instance_id, RIL_Token t, uint32_t sub_id );
...
IxErrnoType qcril_reqlist_query_by_req_id( uint16_t req_id, qcril_instance_id_e_type *instance_id_ptr,
...
IxErrnoType qcril_reqlist_query_by_event_and_sub_id( qcril_instance_id_e_type instance_id, qcril_modem_id_e_type modem_id,
                                                     qcril_evt_e_type pending_event_id, uint32_t sub_id, qcril_reqlist_public_type *info_ptr );
...
IxErrnoType qcril_reqlist_query_by_event_and_sub_id_all_states( qcril_instance_id_e_type instance_id,
                                                                ...
                                                                uint32_t sub_id, qcril_reqlist_public_type *info_ptr );
