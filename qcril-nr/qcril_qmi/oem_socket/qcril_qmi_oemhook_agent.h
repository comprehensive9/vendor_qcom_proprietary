...
typedef struct
{
    int                                       is_oem_hook;
    int                                       hook_req;
    uint32_t                                  hook_req_len;
    qcril_evt_e_type                          hook_req_event;
    int                                       is_qmi_tunneling;
    uint16_t                                  ril_idl_service_id; // applicable only when is_qmi_tunneling is TRUE
    uint16_t                                  ril_idl_message_id; // applicable only when is_qmi_tunneling is TRUE
    int                                       is_qmi_proto;
