...
RilServiceModule_1_5::RilServiceModule_1_5(qcril_instance_id_e_type instance,
    ...
    MessageHandlerTable updateList = {
        ...
        HANDLER(SsrIndicationMessage, RilServiceModule_1_5::handleSsrIndicationMessage),
        ...
        HANDLER(RilUnsolCellBarringMessage, RilServiceModule_1_5::handleCellBarringMessage),
...
void RilServiceModule_1_5::handleCellBarringMessage(
    ...
    if (ri) {
        ...
        mRadioImpl_1_5.sendCellBarring(msg);

        radioServiceRwlockPtr->unlock_shared();
    }
}

void RilServiceModule_1_5::handleSsrIndicationMessage(
        std::shared_ptr<SsrIndicationMessage> msg) {
    QCRIL_LOG_DEBUG("Handling SsrIndicationMessage %s",msg->dump().c_str());
    if (msg->getState()){
...
bool RilServiceModule_1_5::checkNr5gDisCnt(){
...
void RilServiceModule_1_5::checkLteReqCnt(){
...
void RilServiceModule_1_5::checkNr5gReqCnt(){
...
void RilServiceModule_1_5::resetLteCounts(){
    lte_req_count = 0;
    lte_disabled_count = 0;
}

void RilServiceModule_1_5::reset5gnrCounts(){
    nr5g_req_count = 0;
