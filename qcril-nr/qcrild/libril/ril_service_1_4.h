...
class RadioImpl_1_4 :  public RadioImpl_1_3, public V1_4::IRadio {
...
public:
    ...
    virtual void setInitialAttachApnResponse_1_4(RadioResponseInfo responseInfo);

    virtual void setDataProfileResponse_1_4(RadioResponseInfo responseInfo);
    ...
    RIL_RadioAccessNetworks convertHidlAccessNetworkToRilAccessNetwork(V1_4::AccessNetwork ran) {
    ...
    rildata::AccessNetwork_t convertHidlAccessNetworkToDataAccessNetwork(V1_4::AccessNetwork ran);
#endif
    ...
    void getDataCallListResponse_1_4(std::shared_ptr<rildata::DataCallListResult_t> responseDataPtr, int32_t serial, Message::Callback::Status status);
};
