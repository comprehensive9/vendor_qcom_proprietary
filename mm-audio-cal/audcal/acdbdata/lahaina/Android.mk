...
include $(CLEAR_VARS)
LOCAL_MODULE            := fai_2.0.0_0.1_eai_1.00.pmd
LOCAL_MODULE_FILENAME   := fai_2.0.0_0.1_eai_1.00.pmd
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/nn_ns_models/
LOCAL_SRC_FILES         := nn_ns_models/fai_2.0.0_0.1_eai_1.00.pmd
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := fai_2.3.0_0.1_eai_1.00.pmd
LOCAL_MODULE_FILENAME   := fai_2.3.0_0.1_eai_1.00.pmd
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/nn_ns_models/
LOCAL_SRC_FILES         := nn_ns_models/fai_2.3.0_0.1_eai_1.00.pmd
include $(BUILD_PREBUILT)
