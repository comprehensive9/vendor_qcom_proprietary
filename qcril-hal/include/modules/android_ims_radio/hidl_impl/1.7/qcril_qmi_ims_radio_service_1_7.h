 ...
 */
class ImsRadioImpl_1_7 : public ImsRadioImplBase,
                         public V1_7::IImsRadio,
                         public hidl_death_recipient {
 private:
  sp<V1_6::implementation::ImsRadioImpl_1_6> mBaseImsRadioImpl;

  sp<V1_7::IImsRadioResponse> mImsRadioResponseCbV1_7;
  sp<V1_7::IImsRadioIndication> mImsRadioIndicationCbV1_7;

  sp<V1_7::IImsRadioResponse> getResponseCallbackV1_7();
  sp<V1_7::IImsRadioIndication> getIndicationCallbackV1_7();

 public:
  ImsRadioImpl_1_7(qcril_instance_id_e_type instance);
  ~ImsRadioImpl_1_7();
  ...
  ::android::hardware::Return<void> setServiceStatus_1_6(int32_t token,
          const hidl_vec<V1_6::ServiceStatusInfo>& srvStatusInfoList) {
    if (mBaseImsRadioImpl) {
      return mBaseImsRadioImpl->setServiceStatus_1_6(token, srvStatusInfoList);
    }
    return ::android::hardware::Void();
  }
  ...
  ::android::hardware::Return<void> setConfig_1_6(int32_t token,
    ...
    if (mBaseImsRadioImpl) {
      return mBaseImsRadioImpl->setConfig_1_6(token, configInfo);
    }
    return ::android::hardware::Void();
  }
  ...
  ::android::hardware::Return<void> suppServiceStatus_1_6(
    ...
    if (mBaseImsRadioImpl) {
       return mBaseImsRadioImpl->suppServiceStatus_1_6(token, operationType,
             facilityType, cbNumListInfo, password);
    }
    return ::android::hardware::Void();
  }
  ...
  ::android::hardware::Return<void> emergencyDial_1_6( int32_t token,
    ...
    if (mBaseImsRadioImpl) {
      return mBaseImsRadioImpl->emergencyDial_1_6(token, dialRequest, categories,
            urns, route, hasKnownUserIntentEmergency, isTesting);
    }
    return ::android::hardware::Void();
  }
  ...
  ::android::hardware::Return<void> dial_1_6(int32_t token,
           const ::vendor::qti::hardware::radio::ims::V1_6::DialRequest &dialRequest) {
    if (mBaseImsRadioImpl) {
      return mBaseImsRadioImpl->dial_1_6(token, dialRequest);
    }
    return ::android::hardware::Void();
  }

  ::android::hardware::Return<void> sendSipDtmf(int32_t token,
          const ::android::hardware::hidl_string &requestCode);
private:
  // Send response on IImsRadioResponse
  void sendSipDtmfResponse(int32_t token, uint32_t errorCode);
};
}  // namespace implementation
}  // namespace V1_7
}  // namespace ims
