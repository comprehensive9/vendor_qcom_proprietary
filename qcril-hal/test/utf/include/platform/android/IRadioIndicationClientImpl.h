...
class IRadioIndicationClientImpl : public V1_5::IRadioIndication {
public:
    ...
    virtual Return<void> simSmsStorageFull(V1_0::RadioIndicationType type) override {
        return Void();
    }
    ...
    virtual Return<void> cdmaRuimSmsStorageFull(V1_0::RadioIndicationType type) override {
        return Void();
    }
    ...
    virtual Return<void> dataCallListChanged_1_5(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_5::SetupDataCallResult>& dcList) override {
        return Void();
    }
    ...
    virtual Return<void> uiccApplicationsEnablementChanged(::android::hardware::radio::V1_0::RadioIndicationType type, bool enabled) {
        return Void();
    }
    virtual Return<void> registrationFailed(V1_0::RadioIndicationType type, const V1_5::CellIdentity& cellIdentity, const hidl_string& chosenPlmn,
            hidl_bitfield<V1_5::Domain> domain, int32_t causeCode, int32_t additionalCauseCode) {
        return Void();
    }
    virtual Return<void> barringInfoChanged(V1_0::RadioIndicationType type, const V1_5::CellIdentity& cellIdentity, const hidl_vec<V1_5::BarringInfo>& barringInfos) {
        return Void();
    }
    virtual Return<void> cellInfoList_1_5(V1_0::RadioIndicationType type, const hidl_vec<V1_5::CellInfo>& records) {
        return Void();
    }
    virtual Return<void> networkScanResult_1_5(V1_0::RadioIndicationType type, const V1_5::NetworkScanResult& result);
};
