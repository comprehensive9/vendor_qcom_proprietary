...
int convertGetIccCardStatusRespHidltoRilPayload_1_5
(
  const V1_5::CardStatus& cardStatusData,
  RIL_CardStatus_v6&      data
)
{
  return convertGetIccCardStatusRespHidltoRilPayload(cardStatusData.base.base, data);
}
