...
template<> inline constexpr std::array<::vendor::qti::hardware::radio::qtiradio::V2_3::EndcStatus, 3> hidl_enum_values<::vendor::qti::hardware::radio::qtiradio::V2_3::EndcStatus> = {
