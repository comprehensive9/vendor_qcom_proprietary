...
static inline void PrintTo(::vendor::qti::hardware::radio::qtiradio::V2_4::PublicKeyType o, ::std::ostream* os);
...
static inline void PrintTo(const ::vendor::qti::hardware::radio::qtiradio::V2_4::ImsiEncryptionInfo& o, ::std::ostream*);
...
static inline void PrintTo(const ::vendor::qti::hardware::radio::qtiradio::V2_4::ImsiEncryptionInfo& o, ::std::ostream* os) {
    *os << toString(o);
}
...
template<> inline constexpr std::array<::vendor::qti::hardware::radio::qtiradio::V2_4::PublicKeyType, 3> hidl_enum_values<::vendor::qti::hardware::radio::qtiradio::V2_4::PublicKeyType> = {
