...
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_7_IIMSRADIORESPONSE_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_7_IIMSRADIORESPONSE_H
...
struct IImsRadioResponse : public ::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.radio.ims@1.7::IImsRadioResponse"
     */
     ...
     *
     */
    virtual ::android::hardware::Return<void> sendSipDtmfResponse(int32_t token, uint32_t errorCode) = 0;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse>& o) {
    ...
    os += ::vendor::qti::hardware::radio::ims::V1_7::IImsRadioResponse::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_7_IIMSRADIORESPONSE_H
