...
class IImsRadioResponseClient : public V1_7::IImsRadioResponse {
 public:
  ...
  ::android::hardware::Return<void> sendSipDtmfResponse(
      int32_t token, uint32_t errorCode) {
...
class IImsRadioIndicationClient : public V1_7::IImsRadioIndication {
 public:
  ...
  ::android::hardware::Return<void> onCallStateChanged_1_6(
      const ::android::hardware::hidl_vec<::vendor::qti::hardware::radio::ims::V1_6::CallInfo>&
          callList) {
    RIL_UTF_DEBUG(
        "\n QMI_RIL_UTL: onCallStateChanged_1_6: no op: expecting onCallStateChanged_1_7!!!");
    return Void();
  }
  ::android::hardware::Return<void> onCallStateChanged_1_7(
      const ::android::hardware::hidl_vec<::vendor::qti::hardware::radio::ims::V1_7::CallInfo>&
          callList) {
    RIL_UTF_DEBUG("\n QMI_RIL_UTL: onCallStateChanged_1_7");

    ims_CallList* msg_data = (ims_CallList*)qcril_malloc(sizeof(ims_CallList));
    V1_7::utils::convertHidlToProtoCallList(callList, *msg_data);
  ...
  ::android::hardware::Return<void> onSipDtmfReceived(
      const ::android::hardware::hidl_string &configCode) {
...
void reset_i_ims_radio() {
  ...
  ::android::sp<vendor::qti::hardware::radio::ims::V1_7::IImsRadio> utfImsRadio =
    vendor::qti::hardware::radio::ims::V1_7::IImsRadio::getService("imsradio0");
    ...
    switch (msgId) {
      case ims_MsgId_REQUEST_DIAL: {
        ...
        if (i_req->isEmergencyDial) {
          ...
          utfImsRadio->emergencyDial_1_6(token, req, categories, urns, route,
                                         hasKnownUserIntentEmergency, isTesting);
        } else {
          utfImsRadio->dial_1_6(token, req);
        }
