...
*/
  ...
  voice_original_call_type_v02* set_qmi_voice_all_call_status_ind_original_call_type(uint32_t original_call_type_len);
...
*/
void update_default_qmi_uim_provisioning_req();
/*
  QMI_UIM_PROVISIONING_RESP_V01
*/
qmi_uim_provisioning_resp_msg_v01* update_default_qmi_uim_provisioning_resp(qmi_result_type_v01 result, qmi_error_type_v01 error);
