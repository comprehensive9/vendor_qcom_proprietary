...
LOCAL_PROPRIETARY_MODULE   := true
LOCAL_MODULE_TAGS          := optional
LOCAL_HEADER_LIBRARIES     += libril-qc-hal-framework-headers libril-qc-logger-headers libcutils_headers libutils_headers qtimutex-headers vendor_common_inc

LOCAL_SHARED_LIBRARIES += liblog

LOCAL_SHARED_LIBRARIES += libril-qc-logger qtimutex
