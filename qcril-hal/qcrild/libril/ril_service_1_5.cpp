...
#include <interfaces/nas/RilManualProvisioningMessage.h>
...
Return<void> RadioImpl_1_5::setResponseFunctions_nolock(
    ...
    if ((mRadioResponseV1_5 != nullptr) && (mRadioIndicationV1_5 != nullptr)) {
        std::shared_ptr<RilManualProvisioningMessage> manualProvMsg =
            std::make_shared<RilManualProvisioningMessage>();
        if (manualProvMsg) {
            manualProvMsg->broadcast();
        } else {
            QCRIL_LOG_ERROR("Failed to create message RilManualProvisioningMessage.");
        }
    }
...
Return<void> RadioImpl_1_5::setSignalStrengthReportingCriteria_1_5(int32_t serial,
    ...
    if (RadioError::NONE ==
        ...
        fillInSignalStrengthCriteria(args, signalThresholdInfo, accessNetwork);
...
void convertGsmCellIdentityRilToHidl(const RIL_CellIdentityGsm_v12& rilGsmCellIdentity, V1_5::CellIdentityGsm& hidlGsmCellIdentity) {
    hidlGsmCellIdentity.base.base.mcc = hidl_string(
            rilGsmCellIdentity.mcc,
            strnlen(rilGsmCellIdentity.mcc,
                    sizeof(rilGsmCellIdentity.mcc) - 1));

    hidlGsmCellIdentity.base.base.mnc = hidl_string(
            rilGsmCellIdentity.mnc,
            strnlen(rilGsmCellIdentity.mnc,
                    sizeof(rilGsmCellIdentity.mnc) - 1));
...
void convertWcdmaCellIdentityRilToHidl(const RIL_CellIdentityWcdma_v12& rilWcdmaCellIdentity, V1_5::CellIdentityWcdma& hidlWcdmaCellIdentity) {
    hidlWcdmaCellIdentity.base.base.mcc = hidl_string(
            rilWcdmaCellIdentity.mcc,
            strnlen(rilWcdmaCellIdentity.mcc,
                    sizeof(rilWcdmaCellIdentity.mcc) - 1));

    hidlWcdmaCellIdentity.base.base.mnc = hidl_string(
            rilWcdmaCellIdentity.mnc,
            strnlen(rilWcdmaCellIdentity.mnc,
                    sizeof(rilWcdmaCellIdentity.mnc) - 1));
...
void convertTdscdmaCellIdentityRilToHidl(const RIL_CellIdentityTdscdma& rilTdscdmaCellIdentity, V1_5::CellIdentityTdscdma& hidlTdscdmaCellIdentity) {
    hidlTdscdmaCellIdentity.base.base.mcc = hidl_string(
            rilTdscdmaCellIdentity.mcc,
            strnlen(rilTdscdmaCellIdentity.mcc,
                    sizeof(rilTdscdmaCellIdentity.mcc) - 1));

    hidlTdscdmaCellIdentity.base.base.mnc = hidl_string(
            rilTdscdmaCellIdentity.mnc,
            strnlen(rilTdscdmaCellIdentity.mnc,
                    sizeof(rilTdscdmaCellIdentity.mnc) - 1));
...
void convertLteCellIdentityRilToHidl(const RIL_CellIdentityLte_v12& rilLteCellIdentity, V1_5::CellIdentityLte& hidlLteCellIdentity) {
    hidlLteCellIdentity.base.base.mcc = hidl_string(
            rilLteCellIdentity.mcc,
            strnlen(rilLteCellIdentity.mcc,
                    sizeof(rilLteCellIdentity.mcc) - 1));

    hidlLteCellIdentity.base.base.mnc = hidl_string(
            rilLteCellIdentity.mnc,
            strnlen(rilLteCellIdentity.mnc,
                    sizeof(rilLteCellIdentity.mnc) - 1));
...
void convertNrCellIdentityRilToHidl(const RIL_CellIdentityNr &rilNrCellIdentity, V1_5::CellIdentityNr& hidlNrCellIdentity) {
    hidlNrCellIdentity.base.mcc = hidl_string(
            rilNrCellIdentity.mcc,
            strnlen(rilNrCellIdentity.mcc,
                    sizeof(rilNrCellIdentity.mcc) - 1));

    hidlNrCellIdentity.base.mnc = hidl_string(
            rilNrCellIdentity.mnc,
            strnlen(rilNrCellIdentity.mnc,
                    sizeof(rilNrCellIdentity.mnc) - 1));
    ...
    hidl_bitfield<V1_5::IndicationFilter> indicationFilter)
{
    ...
    setIndicationFilter_1_2(serial, int32Filter);
...
Return<void> RadioImpl_1_5::getBarringInfo(int32_t serial) {
    ...
    RADIO_HIDL_SEND_RESPONSE(mSlotId,
        mRadioResponseV1_5,
