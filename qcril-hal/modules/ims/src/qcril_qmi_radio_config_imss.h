...
// Helper enum to convert the auto reject mode settings
typedef enum
{
  QCRIL_QMI_RADIO_CONFIG_IMSS_CALL_MODE_NORMAL = 0,
  QCRIL_QMI_RADIO_CONFIG_IMSS_CALL_MODE_AUTO_REJECT = 1,
  QCRIL_QMI_RADIO_CONFIG_IMSS_CALL_MODE_ALLOW_ALERTING = 2,
}qcril_qmi_radio_config_imss_auto_reject_mode;
