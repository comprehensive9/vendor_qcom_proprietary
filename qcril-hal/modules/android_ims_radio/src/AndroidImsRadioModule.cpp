...
AndroidImsRadioModule::AndroidImsRadioModule() {
  ...
  mMessageHandler = {
      ...
      HANDLER(QcRilUnsolOnSipDtmfMessage,
              AndroidImsRadioModule::handleQcRilUnsolOnSipDtmfMessage),
  };
}
...
void AndroidImsRadioModule::handleQcRilUnsolOnSipDtmfMessage(
...
bool AndroidImsRadioModule::isUssdOverImsSupported() {
...
void AndroidImsRadioModule::initImsRadio(qcril_instance_id_e_type instance_id) {
  if (mImsRadio == nullptr) {
    // Try registering v1.7 service
    if (mImsRadio == nullptr) {
      mImsRadio = new vendor::qti::hardware::radio::ims::V1_7::implementation::ImsRadioImpl_1_7(
          instance_id);
      android::status_t ret = mImsRadio->registerService();
      if (ret != android::OK) {
        mImsRadio = nullptr;
        QCRIL_LOG_INFO("Error registering service %s %d",
         vendor::qti::hardware::radio::ims::V1_7::implementation::ImsRadioImpl_1_7::descriptor,
         instance_id);
      }
    }
    // Try registering v1.6 service
    if (mImsRadio == nullptr) {
      ...
      if (ret != android::OK) {
        mImsRadio = nullptr;
        QCRIL_LOG_INFO("Error registering service %s %d",
         vendor::qti::hardware::radio::ims::V1_6::implementation::ImsRadioImpl_1_6::descriptor,
         instance_id);
      }
    }

    //register next older version
    if (mImsRadio == nullptr) {
      ...
      if (ret != android::OK) {
        mImsRadio = nullptr;
        QCRIL_LOG_INFO("Error registering service %s %d",
         vendor::qti::hardware::radio::ims::V1_5::implementation::ImsRadioImpl_1_5::descriptor,
         instance_id);
      }
    }
    ...
    //register next older version
    if (mImsRadio == nullptr) {
      mImsRadio = new vendor::qti::hardware::radio::ims::V1_4::implementation::ImsRadioImpl_1_4(
          instance_id);
      android::status_t ret = mImsRadio->registerService();
      if (ret != android::OK) {
        mImsRadio = nullptr;
        QCRIL_LOG_INFO("Error registering service %s %d",
         vendor::qti::hardware::radio::ims::V1_4::implementation::ImsRadioImpl_1_4::descriptor,
         instance_id);
      }
    }
    ...
    //register next older version
    if (mImsRadio == nullptr) {
      mImsRadio = new vendor::qti::hardware::radio::ims::V1_0::implementation::ImsRadioImpl(
          instance_id);
      android::status_t ret = mImsRadio->registerService();
      if (ret != android::OK) {
        mImsRadio = nullptr;
        QCRIL_LOG_INFO("Error registering service %s %d",
         vendor::qti::hardware::radio::ims::V1_0::implementation::ImsRadioImpl::descriptor,
         instance_id);
      }
    }
  }
