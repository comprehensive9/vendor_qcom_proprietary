...
typedef union
{
  ...
  qmi_uim_hlos_prov_preference_req_type         hlosProvPreference;
  qmi_uim_get_euicc_info2_req_type              get_euicc_info2;
} req_params;
  ...
  switch(request_type)
  {
   ...
   case QCRIL_UIM_REQUEST_ADD_PROFILE:
    ...
    case QCRIL_UIM_REQUEST_SET_HLOS_PROV_PREFERENCE:
      memcpy(&request_ptr->hlosProvPreference,
             param_data_ptr,
             sizeof(qmi_uim_hlos_prov_preference_req_type));
      break;

     case QCRIL_UIM_REQUEST_GET_EUICC_INFO2:
       memcpy(&request_ptr->get_euicc_info2,
              param_data_ptr,
              sizeof(qmi_uim_get_euicc_info2_req_type));
       break;
