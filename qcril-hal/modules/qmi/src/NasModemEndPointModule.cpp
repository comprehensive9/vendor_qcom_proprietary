        ...
        void * ind_buf, unsigned int ind_buf_len)
{
    ...
    switch (msg_id) {
        ...
        case QMI_NAS_LTE_CPHY_CA_IND_V01: {
            ...
            break;
        case QMI_NAS_LTE_CPHY_CA_AGG_DL_BW_IND_V01:
            QCRIL_LOG_DEBUG("There is no separate tlv to register for this msg as RIL has registered for QMI_NAS_LTE_CPHY_CA_IND_V01, so ignoring");
            break;
        default:
