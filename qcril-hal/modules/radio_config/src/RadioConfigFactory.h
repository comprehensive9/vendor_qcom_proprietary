...
class RadioConfigFactory
{
    ...
    private:
        ...
        RadioConfigImplListType::iterator configIter;
    ...
    public:
        ...
        sp<RadioConfigImpl> getNextRadioConfigImpl() {
            QCRIL_LOG_INFO("getNextRadioConfigImpl");
            sp<RadioConfigImpl> ret;
            if (!radioConfigImplList.empty()) {
                if (configIter != radioConfigImplList.end()) {
                    FactMethod<RadioConfigImpl> m = configIter->factMethod;
                    if (m) {
                        ret = (this->*m)();
                    }
                    configIter++;
        ...
        void initRadioConfigListIndex() {
            configIter = radioConfigImplList.begin();
        }
};
