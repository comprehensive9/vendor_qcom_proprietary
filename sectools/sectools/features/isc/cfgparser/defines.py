...
SECBOOT_3_0_DOUBLE_SIGN_CHIPSETS = (
    ...
    'mannar', 'moselle', 'sc7180', 'fraser', 'qtang2', 'kodiak', 'strait'
)
...
ECDSA_CHIPSETS = (
    ...
    'lahaina', 'bitra', 'agatti', 'chitwan', 'makena', 'olympic', 'cedros', 'mannar', 'fraser', 'kodiak', 'strait'
)
